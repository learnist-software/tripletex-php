...
# **get**
> \Learnist\Tripletex\Model\ResponseWrapperCompany get($id, $fields)
...
$apiInstance = new Learnist\Tripletex\Api\CompanyApi(
...
[**\Learnist\Tripletex\Model\ResponseWrapperCompany**](../Model/ResponseWrapperCompany.md)
...
# **getDivisions**
> \Learnist\Tripletex\Model\ListResponseCompany getDivisions($from, $count, $sorting, $fields)
...
[**\Learnist\Tripletex\Model\ListResponseCompany**](../Model/ListResponseCompany.md)
...
# **getWithLoginAccess**
> \Learnist\Tripletex\Model\ListResponseClient getWithLoginAccess($from, $count, $sorting, $fields)
...
[**\Learnist\Tripletex\Model\ListResponseClient**](../Model/ListResponseClient.md)
...
# **put**
> \Learnist\Tripletex\Model\ResponseWrapperCompany put($body)
...
$body = new \Learnist\Tripletex\Model\Company(); // \Learnist\Tripletex\Model\Company | Partial object describing what should be updated
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Learnist\Tripletex\Model\Company**](../Model/Company.md)| Partial object describing what should be updated | [optional]
