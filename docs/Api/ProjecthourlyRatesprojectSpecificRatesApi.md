# Learnist\Tripletex\ProjecthourlyRatesprojectSpecificRatesApi
...
$apiInstance = new Learnist\Tripletex\Api\ProjecthourlyRatesprojectSpecificRatesApi(
...
# **get**
> \Learnist\Tripletex\Model\ResponseWrapperProjectSpecificRate get($id, $fields)
...
[**\Learnist\Tripletex\Model\ResponseWrapperProjectSpecificRate**](../Model/ResponseWrapperProjectSpecificRate.md)
...
# **post**
> \Learnist\Tripletex\Model\ResponseWrapperProjectSpecificRate post($body)
...
$body = new \Learnist\Tripletex\Model\ProjectSpecificRate(); // \Learnist\Tripletex\Model\ProjectSpecificRate | JSON representing the new object to be created. Should not have ID and version set.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Learnist\Tripletex\Model\ProjectSpecificRate**](../Model/ProjectSpecificRate.md)| JSON representing the new object to be created. Should not have ID and version set. | [optional]
...
# **postList**
> \Learnist\Tripletex\Model\ListResponseProjectSpecificRate postList($body)
...
$body = array(new \Learnist\Tripletex\Model\ProjectSpecificRate()); // \Learnist\Tripletex\Model\ProjectSpecificRate[] | JSON representing a list of new objects to be created. Should not have ID and version set.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Learnist\Tripletex\Model\ProjectSpecificRate[]**](../Model/ProjectSpecificRate.md)| JSON representing a list of new objects to be created. Should not have ID and version set. | [optional]

### Return type

[**\Learnist\Tripletex\Model\ListResponseProjectSpecificRate**](../Model/ListResponseProjectSpecificRate.md)
...
# **put**
> \Learnist\Tripletex\Model\ResponseWrapperProjectSpecificRate put($id, $body)
...
$id = 56; // int | Element ID
$body = new \Learnist\Tripletex\Model\ProjectSpecificRate(); // \Learnist\Tripletex\Model\ProjectSpecificRate | Partial object describing what should be updated
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| Element ID |
 **body** | [**\Learnist\Tripletex\Model\ProjectSpecificRate**](../Model/ProjectSpecificRate.md)| Partial object describing what should be updated | [optional]
...
# **putList**
> \Learnist\Tripletex\Model\ListResponseProjectSpecificRate putList($body)
...
$body = array(new \Learnist\Tripletex\Model\ProjectSpecificRate()); // \Learnist\Tripletex\Model\ProjectSpecificRate[] | JSON representing updates to objects. Should have ID and version set.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Learnist\Tripletex\Model\ProjectSpecificRate[]**](../Model/ProjectSpecificRate.md)| JSON representing updates to objects. Should have ID and version set. | [optional]
...
# **search**
> \Learnist\Tripletex\Model\ListResponseProjectSpecificRate search($id, $project_hourly_rate_id, $employee_id, $activity_id, $from, $count, $sorting, $fields)
