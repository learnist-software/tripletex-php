# Learnist\Tripletex\EmployeeentitlementApi
...
# **client**
> \Learnist\Tripletex\Model\ListResponseEntitlement client($employee_id, $customer_id, $from, $count, $sorting, $fields)
...
$apiInstance = new Learnist\Tripletex\Api\EmployeeentitlementApi(
...
[**\Learnist\Tripletex\Model\ListResponseEntitlement**](../Model/ListResponseEntitlement.md)
...
# **get**
> \Learnist\Tripletex\Model\ResponseWrapperEntitlement get($id, $fields)
...
[**\Learnist\Tripletex\Model\ResponseWrapperEntitlement**](../Model/ResponseWrapperEntitlement.md)
...
# **search**
> \Learnist\Tripletex\Model\ListResponseEntitlement search($employee_id, $from, $count, $sorting, $fields)
