# Learnist\Tripletex\LedgerannualAccountApi
...
# **get**
> \Learnist\Tripletex\Model\ResponseWrapperAnnualAccount get($id, $fields)
...
$apiInstance = new Learnist\Tripletex\Api\LedgerannualAccountApi(
...
[**\Learnist\Tripletex\Model\ResponseWrapperAnnualAccount**](../Model/ResponseWrapperAnnualAccount.md)
...
# **search**
> \Learnist\Tripletex\Model\ListResponseAnnualAccount search($id, $year_from, $year_to, $from, $count, $sorting, $fields)
...
[**\Learnist\Tripletex\Model\ListResponseAnnualAccount**](../Model/ListResponseAnnualAccount.md)
