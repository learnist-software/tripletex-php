...
class Banner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('banner_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['button']) && (mb_strlen($this->container['button']) > 255)) {
            $invalidProperties[] = "invalid value for 'button', the character length must be smaller than or equal to 255.";
        }
    ...
    {
        return $this->container['banner_type'];
    }

    /**
     * Sets banner_type
     *
     * @param string|null $banner_type banner_type
     *
     * @return self
     */
    public function setBannerType($banner_type)
    {
        ...
        if (is_null($banner_type)) {
            throw new \InvalidArgumentException('non-nullable banner_type cannot be null');
        }

        $this->container['banner_type'] = $banner_type;
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling Banner., must be smaller than or equal to 255.');
        }
    ...
    {
        if (!is_null($button) && (mb_strlen($button) > 255)) {
            throw new \InvalidArgumentException('invalid length for $button when calling Banner., must be smaller than or equal to 255.');
        }
    ...
    {
        if (!is_null($tag) && (mb_strlen($tag) > 255)) {
            throw new \InvalidArgumentException('invalid length for $tag when calling Banner., must be smaller than or equal to 255.');
        }
