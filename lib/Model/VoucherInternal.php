 ...
 */
class VoucherInternal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VoucherInternal';
    ...
    protected static array $openAPINullables = [
		...
		'description' => false,
		'voucher_type' => false,
		'reverse_voucher' => false,
		'postings' => false,
		'document' => false,
		'attachment' => false,
		'external_voucher_number' => false,
		'edi_document' => false,
		'supplier_voucher_type' => false,
		'url_details' => false
    ];
    ...
    public const SUPPLIER_VOUCHER_TYPE_SIMPLE = 'TYPE_SUPPLIER_INVOICE_SIMPLE';
    public const SUPPLIER_VOUCHER_TYPE_DETAILED = 'TYPE_SUPPLIER_INVOICE_DETAILED';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['supplier_voucher_type']) && !in_array($this->container['supplier_voucher_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'supplier_voucher_type', must be one of '%s'",
                $this->container['supplier_voucher_type'],
     ...
     * Sets number
     *
     * @param int|null $number System generated number that cannot be changed.
     *
     * @return self
     */
    public function setNumber($number)
    {
        ...
        if (($number < 0)) {
            throw new \InvalidArgumentException('invalid value for $number when calling VoucherInternal., must be bigger than or equal to 0.');
        }
     ...
     * Sets temp_number
     *
     * @param int|null $temp_number Temporary voucher number.
     *
     * @return self
     */
    public function setTempNumber($temp_number)
    {
        if (is_null($temp_number)) {
            throw new \InvalidArgumentException('non-nullable temp_number cannot be null');
        }

        if (($temp_number < 0)) {
            throw new \InvalidArgumentException('invalid value for $temp_number when calling VoucherInternal., must be bigger than or equal to 0.');
        }
     ...
     * Sets year
     *
     * @param int|null $year System generated number that cannot be changed.
     *
     * @return self
     */
    public function setYear($year)
    {
        ...
        if (($year < 0)) {
            throw new \InvalidArgumentException('invalid value for $year when calling VoucherInternal., must be bigger than or equal to 0.');
        }
     ...
     * Gets voucher_type
     *
     * @return \Learnist\Tripletex\Model\VoucherType|null
     */
     ...
     * Sets voucher_type
     *
     * @param \Learnist\Tripletex\Model\VoucherType|null $voucher_type voucher_type
     *
     * @return self
     */
     ...
     *
     * @param \Learnist\Tripletex\Model\Voucher|null $reverse_voucher reverse_voucher
     *
     * @return self
     */
    public function setReverseVoucher($reverse_voucher)
    {
        if (is_null($reverse_voucher)) {
            throw new \InvalidArgumentException('non-nullable reverse_voucher cannot be null');
        }
     ...
     *
     * @param string|null $external_voucher_number External voucher number.
     *
     * @return self
     */
    public function setExternalVoucherNumber($external_voucher_number)
    {
        if (is_null($external_voucher_number)) {
            throw new \InvalidArgumentException('non-nullable external_voucher_number cannot be null');
        }
     ...
     *
     * @param string|null $supplier_voucher_type Supplier voucher type - simple and detailed.
     *
     * @return self
     */
    public function setSupplierVoucherType($supplier_voucher_type)
    {
        if (is_null($supplier_voucher_type)) {
            throw new \InvalidArgumentException('non-nullable supplier_voucher_type cannot be null');
        }
        $allowedValues = $this->getSupplierVoucherTypeAllowableValues();
        if (!in_array($supplier_voucher_type, $allowedValues, true)) {
