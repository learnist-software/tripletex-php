 ...
 */
class PurchaseOrderline implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PurchaseOrderline';
    ...
    protected static $openAPITypes = [
        ...
        'url' => 'string',
        'purchase_order' => '\Learnist\Tripletex\Model\PurchaseOrder',
        'product' => '\Learnist\Tripletex\Model\Product',
        'supplier_product' => '\Learnist\Tripletex\Model\SupplierProduct',
        ...
        'unit_list_price_currency' => 'float',
        'unit_price_inc_vat_currency' => 'float',
    ...
    protected static $openAPIFormats = [
        ...
        'unit_list_price_currency' => null,
        'unit_price_inc_vat_currency' => null,
        'currency' => null,
        'discount' => null,
    ...
    protected static array $openAPINullables = [
		...
		'unit_list_price_currency' => false,
		'unit_price_inc_vat_currency' => false,
		'currency' => false,
		'discount' => false,
    ...
    protected static $attributeMap = [
        ...
        'unit_list_price_currency' => 'unitListPriceCurrency',
        'unit_price_inc_vat_currency' => 'unitPriceIncVatCurrency',
        'currency' => 'currency',
        'discount' => 'discount',
    ...
    protected static $setters = [
        ...
        'unit_list_price_currency' => 'setUnitListPriceCurrency',
        'unit_price_inc_vat_currency' => 'setUnitPriceIncVatCurrency',
    ...
    protected static $getters = [
        ...
        'unit_list_price_currency' => 'getUnitListPriceCurrency',
        'unit_price_inc_vat_currency' => 'getUnitPriceIncVatCurrency',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('unit_list_price_currency', $data ?? [], null);
        $this->setIfExists('unit_price_inc_vat_currency', $data ?? [], null);
    ...
    */
     ...
     * Gets purchase_order
     *
     * @return \Learnist\Tripletex\Model\PurchaseOrder
     */
     ...
     * Sets purchase_order
     *
     * @param \Learnist\Tripletex\Model\PurchaseOrder $purchase_order purchase_order
     *
     * @return self
     */
     ...
     *
     * @param \Learnist\Tripletex\Model\SupplierProduct|null $supplier_product supplier_product
     *
     * @return self
     */
     ...
     *
     * @param float|null $quantity_received Used if the Purchase Order has a Goods received.
     *
     * @return self
     */
     ...
     *
     * @param float|null $unit_price_excluding_vat_currency Unit price of purchase excluding VAT in the order's currency.If it's not specified,it takes the value from purchase price in productDTO
     *
     * @return self
     */
    ...
    /**
     * Gets unit_list_price_currency
     *
     * @return float|null
     */
    public function getUnitListPriceCurrency()
    {
        return $this->container['unit_list_price_currency'];
    }

    /**
     * Sets unit_list_price_currency
     *
     * @param float|null $unit_list_price_currency Unit list price of purchase excluding VAT in the order's currency.If it's not specified,it takes the value from purchase price in productDTO
     *
     * @return self
     */
    public function setUnitListPriceCurrency($unit_list_price_currency)
    {

        if (is_null($unit_list_price_currency)) {
            throw new \InvalidArgumentException('non-nullable unit_list_price_currency cannot be null');
        }

        $this->container['unit_list_price_currency'] = $unit_list_price_currency;

        return $this;
    }

    /**
     * Gets unit_price_inc_vat_currency
     *
     * @return float|null
     */
    public function getUnitPriceIncVatCurrency()
    {
        return $this->container['unit_price_inc_vat_currency'];
    }

    /**
     * Sets unit_price_inc_vat_currency
     *
     * @param float|null $unit_price_inc_vat_currency Unit  price including VAT in the order's currency.If it's not specified,it takes the value from purchase price in productDTO
     *
     * @return self
     */
    public function setUnitPriceIncVatCurrency($unit_price_inc_vat_currency)
    {

        if (is_null($unit_price_inc_vat_currency)) {
            throw new \InvalidArgumentException('non-nullable unit_price_inc_vat_currency cannot be null');
        }

        $this->container['unit_price_inc_vat_currency'] = $unit_price_inc_vat_currency;
