...
/**
 * BalanceSheetRow Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class BalanceSheetRow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BalanceSheetRow';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('posting_count', $data ?? [], null);
    ...
    */
     ...
     * @return int|null
     */
    public function getPostingCount()
    {
        return $this->container['posting_count'];
    }

    /**
     * Sets posting_count
     *
     * @param int|null $posting_count posting_count
     *
     * @return self
     */
    public function setPostingCount($posting_count)
    {

        if (is_null($posting_count)) {
            throw new \InvalidArgumentException('non-nullable posting_count cannot be null');
        }

        $this->container['posting_count'] = $posting_count;
