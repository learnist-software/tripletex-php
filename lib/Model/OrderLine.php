...
'order_group' => 'getOrderGroup'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['unit_price_including_vat_currency'] = isset($data['unit_price_including_vat_currency']) ? $data['unit_price_including_vat_currency'] : null;
        $this->container['is_subscription'] = isset($data['is_subscription']) ? $data['is_subscription'] : null;
        $this->container['subscription_period_start'] = isset($data['subscription_period_start']) ? $data['subscription_period_start'] : null;
        $this->container['subscription_period_end'] = isset($data['subscription_period_end']) ? $data['subscription_period_end'] : null;
        $this->container['order_group'] = isset($data['order_group']) ? $data['order_group'] : null;
    }
     ...
     *
     * @param \Learnist\Tripletex\Model\InventoryLocation $inventory_location inventory_location
     *
     * @return $this
     */
     ...
     * Sets order
     *
     * @param \Learnist\Tripletex\Model\Order $order order
     *
     * @return $this
     */
     ...
     *
     * @param float $unit_price_including_vat_currency Unit price of purchase including VAT in the order's currency
     *
     * @return $this
     */
     ...
     *
     * @param string $subscription_period_start subscription_period_start
     *
     * @return $this
     */
     ...
     *
     * @param string $subscription_period_end subscription_period_end
     *
     * @return $this
     */
     ...
     * Sets order_group
     *
     * @param \Learnist\Tripletex\Model\OrderGroup $order_group order_group
     *
     * @return $this
     */
