...
/**
 * CompanyRepresentativeDTO Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyRepresentativeDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyRepresentativeDTO';
...
'email' => 'getEmail'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['signature_status'] === null) {
            $invalidProperties[] = "'signature_status' can't be null";
        }
