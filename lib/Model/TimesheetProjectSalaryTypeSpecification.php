...
/**
 * TimesheetProjectSalaryTypeSpecification Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class TimesheetProjectSalaryTypeSpecification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TimesheetProjectSalaryTypeSpecification';
    ...
    protected static $openAPITypes = [
        ...
        'salary_type' => '\Learnist\Tripletex\Model\SalaryType',
        'description' => 'string',
        'date' => 'string',
        'count' => 'float',
        'wage_payment' => '\Learnist\Tripletex\Model\Payslip'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('wage_payment', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets salary_type
     *
     * @param \Learnist\Tripletex\Model\SalaryType $salary_type salary_type
     *
     * @return self
     */
     ...
     */
    public function getWagePayment()
    {
        return $this->container['wage_payment'];
    }

    /**
     * Sets wage_payment
     *
     * @param \Learnist\Tripletex\Model\Payslip|null $wage_payment wage_payment
     *
     * @return self
     */
    public function setWagePayment($wage_payment)
    {
        if (is_null($wage_payment)) {
            throw new \InvalidArgumentException('non-nullable wage_payment cannot be null');
        }
        $this->container['wage_payment'] = $wage_payment;
