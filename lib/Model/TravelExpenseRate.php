...
/**
 * TravelExpenseRate Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
'dinner_deduction_rate' => 'getDinnerDeductionRate'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rate_category'] === null) {
            $invalidProperties[] = "'rate_category' can't be null";
        }
    ...
    {
        return $this->container['breakfast_deduction_rate'];
    }
    ...
    {
        return $this->container['lunch_deduction_rate'];
    }
    ...
    {
        return $this->container['dinner_deduction_rate'];
    }
