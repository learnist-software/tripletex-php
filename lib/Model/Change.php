...
class Change implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CHANGE_TYPE_LOCKED = 'LOCKED';
    public const CHANGE_TYPE_REOPENED = 'REOPENED';
    public const CHANGE_TYPE_DO_NOT_SHOW = 'DO_NOT_SHOW';
    ...
    {
        return [
            self::CHANGE_TYPE_CREATE,
            self::CHANGE_TYPE_UPDATE,
            self::CHANGE_TYPE_DELETE,
            self::CHANGE_TYPE_LOCKED,
            self::CHANGE_TYPE_REOPENED,
            self::CHANGE_TYPE_DO_NOT_SHOW,
        ];
    }
    ...
    */
     ...
     * Sets change_type
     *
     * @param string|null $change_type change_type
     *
     * @return self
     */
