...
class Mapping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        if (!is_null($post) && (mb_strlen($post) > 255)) {
    ...
    {
        if (!is_null($sub_post) && (mb_strlen($sub_post) > 255)) {
    ...
    {
        if (!is_null($group_number) && (mb_strlen($group_number) > 255)) {
    ...
    {
        if (!is_null($grouping_enk) && (mb_strlen($grouping_enk) > 255)) {
    ...
    {
        if (!is_null($grouping_as) && (mb_strlen($grouping_as) > 255)) {
    ...
    {
        if (!is_null($grouping_ans) && (mb_strlen($grouping_ans) > 255)) {
