 ...
 */
class ImageValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageValue';
    ...
    public const ID_TOP_LOGO = 'TOP_LOGO';
