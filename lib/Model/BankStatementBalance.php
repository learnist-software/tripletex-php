 ...
 */
class BankStatementBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankStatementBalance';
    ...
    {
        $this->setIfExists('booked_amount', $data ?? [], null);
    ...
    */
     ...
     * Sets booked_amount
     *
     * @param float|null $booked_amount Booked balance on the given date.
     *
     * @return self
     */
    public function setBookedAmount($booked_amount)
    {
        if (is_null($booked_amount)) {
            throw new \InvalidArgumentException('non-nullable booked_amount cannot be null');
        }
     ...
     *
     * @param float|null $available_amount Available balance.
     *
     * @return self
     */
