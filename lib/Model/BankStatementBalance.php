...
/**
 * BankStatementBalance Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankStatementBalance implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BankStatementBalance';
...
'available_date' => 'getAvailableDate'    ];
    ...
    {
        $this->container['booked_amount'] = isset($data['booked_amount']) ? $data['booked_amount'] : null;
        $this->container['booked_date'] = isset($data['booked_date']) ? $data['booked_date'] : null;
    ...
    {
        return $this->container['booked_amount'];
    }

    /**
     * Sets booked_amount
     *
     * @param float $booked_amount Booked balance on the given date.
     *
     * @return $this
     */
    public function setBookedAmount($booked_amount)
    {
        $this->container['booked_amount'] = $booked_amount;
     ...
     *
     * @param float $available_amount Available balance.
     *
     * @return $this
     */
     ...
     * Sets available_date
     *
     * @param string $available_date available_date
     *
     * @return $this
     */
