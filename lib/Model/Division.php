...
class Division implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'municipality_date' => 'setMunicipalityDate',
    ...
    protected static $getters = [
        ...
        'municipality_date' => 'getMunicipalityDate',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('municipality_date', $data ?? [], null);
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Division., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Division., must be bigger than or equal to 1.');
        }
    ...
    public function setOrganizationNumber($organization_number)
    {
        ...
        if ((mb_strlen($organization_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $organization_number when calling Division., must be smaller than or equal to 100.');
        }
    ...
    /**
     * Gets municipality_date
     *
     * @return string|null
     */
    public function getMunicipalityDate()
    {
        return $this->container['municipality_date'];
    }

    /**
     * Sets municipality_date
     *
     * @param string|null $municipality_date municipality_date
     *
     * @return self
     */
    public function setMunicipalityDate($municipality_date)
    {
        if (is_null($municipality_date)) {
            throw new \InvalidArgumentException('non-nullable municipality_date cannot be null');
        }
        $this->container['municipality_date'] = $municipality_date;
