...
class SalaryTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'payslips' => '\Learnist\Tripletex\Model\Payslip[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payslips', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets payslips
     *
     * @param \Learnist\Tripletex\Model\Payslip[] $payslips Link to individual payslip objects.
     *
     * @return self
     */
    ...
    {
        if (is_null($payslips)) {
            throw new \InvalidArgumentException('non-nullable payslips cannot be null');
        }
