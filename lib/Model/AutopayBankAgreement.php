...
class AutopayBankAgreement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        if (!is_null($account_in_bank_id) && (mb_strlen($account_in_bank_id) > 50)) {
    ...
    {
        if (!is_null($ccm_agreement_id) && (mb_strlen($ccm_agreement_id) > 50)) {
    ...
    {
        if (!is_null($organisation_number) && (mb_strlen($organisation_number) > 50)) {
