 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BalanceGroup implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BalanceGroup';
...
'negate' => 'getNegate'    ];
     ...
     * Sets negate
     *
     * @param bool $negate The amount from the balance are not prefixed. This property indicates if the value should be negated or not.
     *
     * @return $this
     */
