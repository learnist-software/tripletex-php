    ...
    */
    ...
    public function setFileName($file_name)
    {
        if ((mb_strlen($file_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling Document., must be smaller than or equal to 255.');
        }
     ...
     * Sets size
     *
     * @param int|null $size The size of the document in bytes.
     *
     * @return self
     */
     ...
     * Sets mime_type
     *
     * @param string|null $mime_type Type of the document
     *
     * @return self
     */
    public function setMimeType($mime_type)
    {
        if (!is_null($mime_type) && (mb_strlen($mime_type) > 100)) {
            throw new \InvalidArgumentException('invalid length for $mime_type when calling Document., must be smaller than or equal to 100.');
        }
