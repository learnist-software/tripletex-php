...
/**
 * ResourceMessages Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class ResourceMessages implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResourceMessages';
    ...
    */
     ...
     * Sets no
     *
     * @param array<string,string>|null $no Map of key value pairs for Norwegian text
     *
     * @return self
     */
     ...
     * Sets en
     *
     * @param array<string,string>|null $en Map of key value pairs for English text
     *
     * @return self
     */
     ...
     * Sets se
     *
     * @param array<string,string>|null $se Map of key value pairs for Swedish text
     *
     * @return self
     */
