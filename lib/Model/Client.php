...
class Client implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('accountant_or_similar', $data ?? [], null);
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Client., must be smaller than or equal to 255.');
        }
    ...
    public function setOrganizationNumber($organization_number)
    {
        ...
        if ((mb_strlen($organization_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $organization_number when calling Client., must be smaller than or equal to 100.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Client., must be smaller than or equal to 254.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((mb_strlen($phone_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling Client., must be smaller than or equal to 100.');
        }
    ...
    public function setPhoneNumberMobile($phone_number_mobile)
    {
        ...
        if ((mb_strlen($phone_number_mobile) > 100)) {
            throw new \InvalidArgumentException('invalid length for $phone_number_mobile when calling Client., must be smaller than or equal to 100.');
        }
    ...
    public function setFaxNumber($fax_number)
    {
        ...
        if ((mb_strlen($fax_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $fax_number when calling Client., must be smaller than or equal to 100.');
        }
     ...
     *
     * @param bool|null $accountant_or_similar accountant_or_similar
     *
     * @return self
     */
    public function setAccountantOrSimilar($accountant_or_similar)
    {
        if (is_null($accountant_or_similar)) {
            throw new \InvalidArgumentException('non-nullable accountant_or_similar cannot be null');
        }
