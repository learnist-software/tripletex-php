 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VoucherInboxArchive implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VoucherInboxArchive';
...
const MODEL_TYPE_CUSTOMER = 'CUSTOMER';
const MODEL_TYPE_SUPPLIER = 'SUPPLIER';
const MODEL_TYPE_PROJECT = 'PROJECT';
const MODEL_TYPE_PRODUCT = 'PRODUCT';
const MODEL_TYPE_INVOICE = 'INVOICE';
const MODEL_TYPE_EMPLOYEE = 'EMPLOYEE';
const MODEL_TYPE_ACCOUNT = 'ACCOUNT';
const MODEL_TYPE_ASSET = 'ASSET';
...
self::MODEL_TYPE_ASSET,        ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['model_type']) && !in_array($this->container['model_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'model_type', must be one of '%s'",
     ...
     * Sets ids
     *
     * @param string $ids List of voucherInboxIds to move to archive
     *
     * @return $this
     */
     ...
     * Sets path_id
     *
     * @param int $path_id Target path in archive
     *
     * @return $this
     */
     ...
     * Sets archive_date
     *
     * @param string $archive_date archive_date
     *
     * @return $this
     */
     ...
     * Sets model_type
     *
     * @param string $model_type Add to specific archive
     *
     * @return $this
     */
