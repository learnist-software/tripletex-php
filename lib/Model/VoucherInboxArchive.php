...
/**
 * VoucherInboxArchive Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class VoucherInboxArchive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VoucherInboxArchive';
    ...
    public const MODEL_TYPE_NONE = 'NONE';
    public const MODEL_TYPE_CUSTOMER = 'CUSTOMER';
    public const MODEL_TYPE_SUPPLIER = 'SUPPLIER';
    public const MODEL_TYPE_PROJECT = 'PROJECT';
    public const MODEL_TYPE_PRODUCT = 'PRODUCT';
    public const MODEL_TYPE_INVOICE = 'INVOICE';
    public const MODEL_TYPE_EMPLOYEE = 'EMPLOYEE';
    public const MODEL_TYPE_ACCOUNT = 'ACCOUNT';
    public const MODEL_TYPE_ASSET = 'ASSET';
    ...
    {
        return [
            self::MODEL_TYPE_NONE,
            self::MODEL_TYPE_CUSTOMER,
            self::MODEL_TYPE_SUPPLIER,
            self::MODEL_TYPE_PROJECT,
            self::MODEL_TYPE_PRODUCT,
            self::MODEL_TYPE_INVOICE,
            self::MODEL_TYPE_EMPLOYEE,
            self::MODEL_TYPE_ACCOUNT,
            self::MODEL_TYPE_ASSET,
        ];
    }
    ...
    */
     ...
     * Sets ids
     *
     * @param string|null $ids List of voucherInboxIds to move to archive
     *
     * @return self
     */
     ...
     * Sets path_id
     *
     * @param int|null $path_id Target path in archive
     *
     * @return self
     */
     ...
     * Sets archive_date
     *
     * @param string|null $archive_date archive_date
     *
     * @return self
     */
     ...
     * Sets model_type
     *
     * @param string|null $model_type Add to specific archive
     *
     * @return self
     */
