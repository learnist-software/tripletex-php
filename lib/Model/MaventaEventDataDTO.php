 ...
 */
class MaventaEventDataDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaventaEventDataDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('recipient_bid', $data ?? [], null);
        $this->setIfExists('network', $data ?? [], null);
        $this->setIfExists('id', $data ?? [], null);
        $this->setIfExists('profiles', $data ?? [], null);
        $this->setIfExists('error_message', $data ?? [], null);
        $this->setIfExists('recipient_eia', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($recipient_bid)) {
            throw new \InvalidArgumentException('non-nullable recipient_bid cannot be null');
        }
     ...
     * @return string|null
     */
    public function getRecipientEia()
    {
        return $this->container['recipient_eia'];
    }

    /**
     * Sets recipient_eia
     *
     * @param string|null $recipient_eia recipient_eia
     *
     * @return self
     */
    public function setRecipientEia($recipient_eia)
    {
        if (is_null($recipient_eia)) {
            throw new \InvalidArgumentException('non-nullable recipient_eia cannot be null');
        }
        $this->container['recipient_eia'] = $recipient_eia;
