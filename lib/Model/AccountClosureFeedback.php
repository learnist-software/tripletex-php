...
/**
 * AccountClosureFeedback Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class AccountClosureFeedback implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountClosureFeedback';
    ...
    */
    ...
    public function setReason($reason)
    {
        ...
        if ((mb_strlen($reason) > 255)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling AccountClosureFeedback., must be smaller than or equal to 255.');
        }
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling AccountClosureFeedback., must be smaller than or equal to 1024.');
        }
