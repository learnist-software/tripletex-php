...
/**
 * PrepareTaxcardsArgsInternal Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class PrepareTaxcardsArgsInternal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrepareTaxcardsArgsInternal';
    ...
    protected static $openAPIFormats = [
        'employee_ids' => null,
        'contact_employee_id' => 'int32',
        'contact_email' => null,
        'taxcard_year' => 'int32',
        'mobile_phone' => null,
        'mobile_phone_country_id' => 'int32',
    ...
    protected static $attributeMap = [
        ...
        'taxcard_year' => 'taxcardYear',
        'mobile_phone' => 'mobilePhone',
        'mobile_phone_country_id' => 'mobilePhoneCountryId',
    ...
    protected static $setters = [
        ...
        'taxcard_year' => 'setTaxcardYear',
        'mobile_phone' => 'setMobilePhone',
        'mobile_phone_country_id' => 'setMobilePhoneCountryId',
    ...
    protected static $getters = [
        ...
        'taxcard_year' => 'getTaxcardYear',
        'mobile_phone' => 'getMobilePhone',
        'mobile_phone_country_id' => 'getMobilePhoneCountryId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('taxcard_year', $data ?? [], null);
        $this->setIfExists('mobile_phone', $data ?? [], null);
        $this->setIfExists('mobile_phone_country_id', $data ?? [], null);
    ...
    */
     ...
     * @return int|null
     */
    public function getTaxcardYear()
    {
        return $this->container['taxcard_year'];
    }

    /**
     * Sets taxcard_year
     *
     * @param int|null $taxcard_year taxcard_year
     *
     * @return self
     */
    public function setTaxcardYear($taxcard_year)
    {
        if (is_null($taxcard_year)) {
            throw new \InvalidArgumentException('non-nullable taxcard_year cannot be null');
        }
        $this->container['taxcard_year'] = $taxcard_year;
    ...
    /**
     * Gets mobile_phone_country_id
     *
     * @return int|null
     */
    public function getMobilePhoneCountryId()
    {
        return $this->container['mobile_phone_country_id'];
    }

    /**
     * Sets mobile_phone_country_id
     *
     * @param int|null $mobile_phone_country_id mobile_phone_country_id
     *
     * @return self
     */
    public function setMobilePhoneCountryId($mobile_phone_country_id)
    {
        if (is_null($mobile_phone_country_id)) {
            throw new \InvalidArgumentException('non-nullable mobile_phone_country_id cannot be null');
        }
        $this->container['mobile_phone_country_id'] = $mobile_phone_country_id;
