 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PrepareTaxcardsArgsInternal implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PrepareTaxcardsArgsInternal';
...
'notification_type' => 'getNotificationType'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['contact_employee_id'] = isset($data['contact_employee_id']) ? $data['contact_employee_id'] : null;
        $this->container['contact_email'] = isset($data['contact_email']) ? $data['contact_email'] : null;
        $this->container['taxcard_year'] = isset($data['taxcard_year']) ? $data['taxcard_year'] : null;
        $this->container['mobile_phone'] = isset($data['mobile_phone']) ? $data['mobile_phone'] : null;
        $this->container['mobile_phone_country_id'] = isset($data['mobile_phone_country_id']) ? $data['mobile_phone_country_id'] : null;
     ...
     *
     * @param int $contact_employee_id contact_employee_id
     *
     * @return $this
     */
     ...
     * Sets taxcard_year
     *
     * @param int $taxcard_year taxcard_year
     *
     * @return $this
     */
     ...
     *
     * @param int $mobile_phone_country_id mobile_phone_country_id
     *
     * @return $this
     */
