 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderGroup implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrderGroup';
...
'sort_index' => 'getSortIndex'    ];
     ...
     * Sets sort_index
     *
     * @param int $sort_index Minimum 1. Defines the presentation order of the orderGroups. Does not need to be, and is often not continuous.
     *
     * @return $this
     */
