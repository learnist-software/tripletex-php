...
class PurchaseOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        if (!is_null($receiver_email) && (mb_strlen($receiver_email) > 100)) {
    ...
    {
        if (!is_null($packing_note_message) && (mb_strlen($packing_note_message) > 50)) {
    ...
    {
        if (!is_null($transporter_message) && (mb_strlen($transporter_message) > 255)) {
