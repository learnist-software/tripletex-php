 ...
 */
class SalarySummaryDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalarySummaryDTO';
    ...
    protected static $openAPITypes = [
        ...
        'salary_payment_sum' => 'object',
        'currency' => 'string',
        'salary_percentage' => 'object',
        'employers_payment_percentage' => 'object',
    ...
    protected static array $openAPINullables = [
        'number_of_active_employees' => false,
		'salary_payment_sum' => false,
		'currency' => false,
		'salary_percentage' => false,
		'employers_payment_percentage' => false,
		'taxes_percentage' => false,
		'salary_period_month_first_day' => false,
		'salary_period_month_last_day' => false,
		'valid_alt_inn_config' => false
    ];
    ...
    {
        $this->setIfExists('number_of_active_employees', $data ?? [], null);
        $this->setIfExists('salary_payment_sum', $data ?? [], null);
        $this->setIfExists('currency', $data ?? [], null);
        $this->setIfExists('salary_percentage', $data ?? [], null);
        $this->setIfExists('employers_payment_percentage', $data ?? [], null);
        $this->setIfExists('taxes_percentage', $data ?? [], null);
        $this->setIfExists('salary_period_month_first_day', $data ?? [], null);
        $this->setIfExists('salary_period_month_last_day', $data ?? [], null);
        $this->setIfExists('valid_alt_inn_config', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int|null $number_of_active_employees number_of_active_employees
     *
     * @return self
     */
    public function setNumberOfActiveEmployees($number_of_active_employees)
    {
        if (is_null($number_of_active_employees)) {
            throw new \InvalidArgumentException('non-nullable number_of_active_employees cannot be null');
        }
     ...
     *
     * @param object|null $salary_payment_sum salary_payment_sum
     *
     * @return self
     */
    public function setSalaryPaymentSum($salary_payment_sum)
    {
        if (is_null($salary_payment_sum)) {
            throw new \InvalidArgumentException('non-nullable salary_payment_sum cannot be null');
        }
     ...
     *
     * @param object|null $salary_percentage salary_percentage
     *
     * @return self
     */
    public function setSalaryPercentage($salary_percentage)
    {
        if (is_null($salary_percentage)) {
            throw new \InvalidArgumentException('non-nullable salary_percentage cannot be null');
        }
     ...
     *
     * @param object|null $employers_payment_percentage employers_payment_percentage
     *
     * @return self
     */
    public function setEmployersPaymentPercentage($employers_payment_percentage)
    {
        if (is_null($employers_payment_percentage)) {
            throw new \InvalidArgumentException('non-nullable employers_payment_percentage cannot be null');
        }
     ...
     *
     * @param object|null $taxes_percentage taxes_percentage
     *
     * @return self
     */
    public function setTaxesPercentage($taxes_percentage)
    {
        if (is_null($taxes_percentage)) {
            throw new \InvalidArgumentException('non-nullable taxes_percentage cannot be null');
        }
     ...
     *
     * @param \DateTime|null $salary_period_month_first_day salary_period_month_first_day
     *
     * @return self
     */
    public function setSalaryPeriodMonthFirstDay($salary_period_month_first_day)
    {
        if (is_null($salary_period_month_first_day)) {
            throw new \InvalidArgumentException('non-nullable salary_period_month_first_day cannot be null');
        }
     ...
     *
     * @param \DateTime|null $salary_period_month_last_day salary_period_month_last_day
     *
     * @return self
     */
    public function setSalaryPeriodMonthLastDay($salary_period_month_last_day)
    {
        if (is_null($salary_period_month_last_day)) {
            throw new \InvalidArgumentException('non-nullable salary_period_month_last_day cannot be null');
        }
     ...
     *
     * @param bool|null $valid_alt_inn_config valid_alt_inn_config
     *
     * @return self
     */
    public function setValidAltInnConfig($valid_alt_inn_config)
    {
        if (is_null($valid_alt_inn_config)) {
            throw new \InvalidArgumentException('non-nullable valid_alt_inn_config cannot be null');
        }
