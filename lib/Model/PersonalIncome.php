 ...
 */
class PersonalIncome implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonalIncome';
    ...
    public const POST_TYPE_INTEREST_ON_ENTERPRISE_DEBT = 'INTEREST_ON_ENTERPRISE_DEBT';
    public const POST_TYPE_CAPITAL_INCOME = 'CAPITAL_INCOME';
    public const POST_TYPE_CAPITAL_EXPENSES = 'CAPITAL_EXPENSES';
    public const POST_TYPE_REDUCTION_AMOUNT_FOR_RENTED_PROPERTY = 'REDUCTION_AMOUNT_FOR_RENTED_PROPERTY';
    public const POST_TYPE_GAINS_FROM_REALISATION_AGRICULTURE_OR_FORESTRY = 'GAINS_FROM_REALISATION_AGRICULTURE_OR_FORESTRY';
    public const POST_TYPE_NUMBER_OF_MONTHS_WITH_OPERATIONS = 'NUMBER_OF_MONTHS_WITH_OPERATIONS';
    public const POST_TYPE_RISK_FREE_INTEREST_RATE = 'RISK_FREE_INTEREST_RATE';
    public const POST_TYPE_ENTERPRISE_DEBT_OB = 'ENTERPRISE_DEBT_OB';
    public const POST_TYPE_ENTERPRISE_DEBT_CB = 'ENTERPRISE_DEBT_CB';
    public const POST_TYPE_PROFIT_SHARE_SPOUSE = 'PROFIT_SHARE_SPOUSE';
    public const POST_TYPE_NEGATIVE_PERSONAL_INCOME_PREVIOUS_YEAR = 'NEGATIVE_PERSONAL_INCOME_PREVIOUS_YEAR';
    public const POST_TYPE_COORDINATION_ENK = 'COORDINATION_ENK';
    public const POST_TYPE_COORDINATION_ANS_DA = 'COORDINATION_ANS_DA';
    public const POST_TYPE_COORDINATION_LOTT = 'COORDINATION_LOTT';
    public const POST_TYPE_NEGATIVE_PERSONAL_INCOME_CARRIED_FORWARD_NEXT_YEAR = 'NEGATIVE_PERSONAL_INCOME_CARRIED_FORWARD_NEXT_YEAR';
    public const POST_TYPE_BUSINESS_TYPE_DESCRIPTION = 'BUSINESS_TYPE_DESCRIPTION';
    public const POST_TYPE_DISTRIBUTE_INCOME = 'DISTRIBUTE_INCOME';
    public const POST_TYPE_NEGATIVE_PERSONAL_INCOME_PREVIOUS_YEAR_SPOUSE = 'NEGATIVE_PERSONAL_INCOME_PREVIOUS_YEAR_SPOUSE';
    public const POST_TYPE_COORDINATION_ENK_SPOUSE = 'COORDINATION_ENK_SPOUSE';
    public const POST_TYPE_COORDINATION_ANS_DA_SPOUSE = 'COORDINATION_ANS_DA_SPOUSE';
    public const POST_TYPE_COORDINATION_LOTT_SPOUSE = 'COORDINATION_LOTT_SPOUSE';
    public const POST_TYPE_NEGATIVE_PERSONAL_INCOME_CARRIED_FORWARD_NEXT_YEAR_SPOUSE = 'NEGATIVE_PERSONAL_INCOME_CARRIED_FORWARD_NEXT_YEAR_SPOUSE';
