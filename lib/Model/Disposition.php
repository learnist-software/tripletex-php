 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Disposition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Disposition';
...
'free_equity' => 'getFreeEquity'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['group_contribution_given'] = isset($data['group_contribution_given']) ? $data['group_contribution_given'] : null;
        ...
        $this->container['sum_annual_result'] = isset($data['sum_annual_result']) ? $data['sum_annual_result'] : null;
        $this->container['free_equity_opening_balance'] = isset($data['free_equity_opening_balance']) ? $data['free_equity_opening_balance'] : null;
        $this->container['free_equity_closing_balance'] = isset($data['free_equity_closing_balance']) ? $data['free_equity_closing_balance'] : null;
        $this->container['calculated_free_equity_closing_balance'] = isset($data['calculated_free_equity_closing_balance']) ? $data['calculated_free_equity_closing_balance'] : null;
        $this->container['free_equity_diff'] = isset($data['free_equity_diff']) ? $data['free_equity_diff'] : null;
        $this->container['uncovered_loss_opening_balance'] = isset($data['uncovered_loss_opening_balance']) ? $data['uncovered_loss_opening_balance'] : null;
        $this->container['uncovered_loss_closing_balance'] = isset($data['uncovered_loss_closing_balance']) ? $data['uncovered_loss_closing_balance'] : null;
        $this->container['calculated_uncovered_loss_closing_balance'] = isset($data['calculated_uncovered_loss_closing_balance']) ? $data['calculated_uncovered_loss_closing_balance'] : null;
        $this->container['uncovered_loss_diff'] = isset($data['uncovered_loss_diff']) ? $data['uncovered_loss_diff'] : null;
        $this->container['remaining_uncovered_loss'] = isset($data['remaining_uncovered_loss']) ? $data['remaining_uncovered_loss'] : null;
        $this->container['free_equity'] = isset($data['free_equity']) ? $data['free_equity'] : null;
    }
     ...
     *
     * @param float $group_contribution_given group_contribution_given
     *
     * @return $this
     */
     ...
     *
     * @param float $sum_annual_result sum_annual_result
     *
     * @return $this
     */
     ...
     *
     * @param float $free_equity_opening_balance free_equity_opening_balance
     *
     * @return $this
     */
     ...
     *
     * @param float $free_equity_closing_balance free_equity_closing_balance
     *
     * @return $this
     */
     ...
     *
     * @param float $calculated_free_equity_closing_balance calculated_free_equity_closing_balance
     *
     * @return $this
     */
     ...
     *
     * @param float $free_equity_diff free_equity_diff
     *
     * @return $this
     */
     ...
     *
     * @param float $uncovered_loss_opening_balance uncovered_loss_opening_balance
     *
     * @return $this
     */
     ...
     *
     * @param float $uncovered_loss_closing_balance uncovered_loss_closing_balance
     *
     * @return $this
     */
     ...
     *
     * @param float $calculated_uncovered_loss_closing_balance calculated_uncovered_loss_closing_balance
     *
     * @return $this
     */
     ...
     *
     * @param float $uncovered_loss_diff uncovered_loss_diff
     *
     * @return $this
     */
     ...
     *
     * @param float $remaining_uncovered_loss remaining_uncovered_loss
     *
     * @return $this
     */
     ...
     * Sets free_equity
     *
     * @param float $free_equity free_equity
     *
     * @return $this
     */
