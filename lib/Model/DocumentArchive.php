...
/**
 * DocumentArchive Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class DocumentArchive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentArchive';
    ...
    */
    ...
    public function setFileName($file_name)
    {
        if ((mb_strlen($file_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling DocumentArchive., must be smaller than or equal to 255.');
        }
     ...
     * Sets size
     *
     * @param int|null $size The size of the document in readable format.
     *
     * @return self
     */
    public function setSize($size)
    {
        ...
        if (!is_null($size) && ($size < 0)) {
            throw new \InvalidArgumentException('invalid value for $size when calling DocumentArchive., must be bigger than or equal to 0.');
        }
     ...
     * Sets mime_type
     *
     * @param string $mime_type Type of the document
     *
     * @return self
     */
    public function setMimeType($mime_type)
    {
        if ((mb_strlen($mime_type) > 100)) {
            throw new \InvalidArgumentException('invalid length for $mime_type when calling DocumentArchive., must be smaller than or equal to 100.');
        }
