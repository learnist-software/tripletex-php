...
class BankStatement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param float|null $opening_balance_currency Opening balance on the account.
     *
     * @return self
     */
     ...
     *
     * @param float|null $closing_balance_currency Closing balance on the account.
     *
     * @return self
     */
     ...
     * Sets file_name
     *
     * @param string|null $file_name Bank statement file name.
     *
     * @return self
     */
     ...
     * Sets transactions
     *
     * @param \Learnist\Tripletex\Model\BankTransaction[]|null $transactions Bank transactions tied to the bank statement
     *
     * @return self
     */
