...
class SalaryTaxcardInternal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        if (!is_null($additional_info) && (mb_strlen($additional_info) > 250)) {
    ...
    {
        if (!is_null($arbeidstaker_identifikator) && (mb_strlen($arbeidstaker_identifikator) > 20)) {
    ...
    public function setYearOfIncome($year_of_income)
    {
        ...
        if (!is_null($year_of_income) && ($year_of_income < 0)) {
    ...
    public function setSkattekortIdentifikator($skattekort_identifikator)
    {
        ...
        if (!is_null($skattekort_identifikator) && ($skattekort_identifikator < 0)) {
    ...
    public function setDeductionPeriod($deduction_period)
    {
        ...
        if (!is_null($deduction_period) && ($deduction_period < 0)) {
    ...
    public function setPayrollTaxMunicipalityId($payroll_tax_municipality_id)
    {
        ...
        if (!is_null($payroll_tax_municipality_id) && ($payroll_tax_municipality_id < 0)) {
