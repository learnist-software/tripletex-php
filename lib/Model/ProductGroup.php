...
class ProductGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'display_name' => 'string',
        'parent_group' => '\Learnist\Tripletex\Model\ProductGroup',
        'is_deletable' => 'bool'
    ];
    ...
    */
     ...
     * Sets display_name
     *
     * @param string|null $display_name Product group displayName
     *
     * @return self
     */
     ...
     * Sets parent_group
     *
     * @param \Learnist\Tripletex\Model\ProductGroup|null $parent_group parent_group
     *
     * @return self
     */
