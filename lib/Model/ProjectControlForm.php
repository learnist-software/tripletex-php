...
/**
 * ProjectControlForm Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class ProjectControlForm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectControlForm';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('control_form', $data ?? [], null);
    }
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ProjectControlForm., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ProjectControlForm., must be bigger than or equal to 1.');
        }
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) < 1)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling ProjectControlForm., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['control_form'];
    }

    /**
     * Sets control_form
     *
     * @param string|null $control_form control_form
     *
     * @return self
     */
    public function setControlForm($control_form)
    {
        if (is_null($control_form)) {
            throw new \InvalidArgumentException('non-nullable control_form cannot be null');
        }
        $this->container['control_form'] = $control_form;
