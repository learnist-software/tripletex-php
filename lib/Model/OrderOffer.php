    ...
    */
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $number when calling OrderOffer., must be smaller than or equal to 100.');
        }
     ...
     * Sets offer_date
     *
     * @param string|null $offer_date offer_date
     *
     * @return self
     */
