 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupInvestment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GroupInvestment';
...
self::NOTE_GROUP_TYPE_ACTUAL_VALUE_FINACIAL_INSTRUMENTS_GROUP,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['revenue_recognized_as_income'] = isset($data['revenue_recognized_as_income']) ? $data['revenue_recognized_as_income'] : null;
        $this->container['other_changes'] = isset($data['other_changes']) ? $data['other_changes'] : null;
     ...
     * Sets investment
     *
     * @param float $investment investment
     *
     * @return $this
     */
     ...
     *
     * @param float $revenue_recognized_as_income revenue_recognized_as_income
     *
     * @return $this
     */
     ...
     * Sets other_changes
     *
     * @param float $other_changes other_changes
     *
     * @return $this
     */
