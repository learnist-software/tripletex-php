...
class Stock implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'changes_in_period' => 'changesInPeriod',
    ...
    protected static $setters = [
        ...
        'changes_in_period' => 'setChangesInPeriod',
    ...
    protected static $getters = [
        ...
        'changes_in_period' => 'getChangesInPeriod',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('changes_in_period', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['inventory']) && (mb_strlen($this->container['inventory']) > 255)) {
            $invalidProperties[] = "invalid value for 'inventory', the character length must be smaller than or equal to 255.";
        }
    ...
    {
        if (!is_null($inventory) && (mb_strlen($inventory) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inventory when calling Stock., must be smaller than or equal to 255.');
        }
    ...
    /**
     * Gets changes_in_period
     *
     * @return float|null
     */
    public function getChangesInPeriod()
    {
        return $this->container['changes_in_period'];
    }

    /**
     * Sets changes_in_period
     *
     * @param float|null $changes_in_period changes_in_period
     *
     * @return self
     */
    public function setChangesInPeriod($changes_in_period)
    {

        if (is_null($changes_in_period)) {
            throw new \InvalidArgumentException('non-nullable changes_in_period cannot be null');
        }

        $this->container['changes_in_period'] = $changes_in_period;
