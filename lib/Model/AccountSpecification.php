...
/**
 * AccountSpecification Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class AccountSpecification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountSpecification';
    ...
    protected static $openAPITypes = [
        ...
        'accounts' => '\Learnist\Tripletex\Model\Account[]'
    ];
    ...
    */
    ...
    public function setType($type)
    {
        ...
        if (($type < 0)) {
            throw new \InvalidArgumentException('invalid value for $type when calling AccountSpecification., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param float|null $total_amount_vat total_amount_vat
     *
     * @return self
     */
     ...
     * Sets accounts
     *
     * @param \Learnist\Tripletex\Model\Account[]|null $accounts accounts
     *
     * @return self
     */
