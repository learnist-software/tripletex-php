 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SnowplowGlobalCompany implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SnowplowGlobalCompany';
...
'package' => 'getPackage'    ];
    ...
    const CUSTOMER_TYPE_MAMUT = 'Mamut';
const CUSTOMER_TYPE_AGRO = 'Agro';
const CUSTOMER_TYPE_PAYING = 'Paying';
const CUSTOMER_TYPE_FREE = 'Free';
const CUSTOMER_TYPE_TEST = 'Test';
...
self::CUSTOMER_TYPE_TEST,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_paying'] = isset($data['is_paying']) ? $data['is_paying'] : null;
     ...
     * Sets is_paying
     *
     * @param bool $is_paying is_paying
     *
     * @return $this
     */
     ...
     * Sets pilot_features
     *
     * @param string[] $pilot_features pilot_features
     *
     * @return $this
     */
     ...
     *
     * @param int $organization_number organization_number
     *
     * @return $this
     */
