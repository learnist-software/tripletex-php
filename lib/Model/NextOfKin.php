 ...
 */
class NextOfKin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NextOfKin';
    ...
    public const TYPE_OF_RELATIONSHIP_SPOUSE = 'SPOUSE';
    public const TYPE_OF_RELATIONSHIP_PARTNER = 'PARTNER';
    public const TYPE_OF_RELATIONSHIP_PARENT = 'PARENT';
    public const TYPE_OF_RELATIONSHIP_CHILD = 'CHILD';
    public const TYPE_OF_RELATIONSHIP_SIBLING = 'SIBLING';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('type_of_relationship', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['type_of_relationship']) && !in_array($this->container['type_of_relationship'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'type_of_relationship', must be one of '%s'",
                $this->container['type_of_relationship'],
     ...
     *
     * @param string|null $type_of_relationship Define the employee's next of kin relationtype.<br>SPOUSE<br>PARTNER<br>PARENT<br>CHILD<br>SIBLING
     *
     * @return self
     */
    public function setTypeOfRelationship($type_of_relationship)
    {
        if (is_null($type_of_relationship)) {
            throw new \InvalidArgumentException('non-nullable type_of_relationship cannot be null');
        }
        $allowedValues = $this->getTypeOfRelationshipAllowableValues();
        if (!in_array($type_of_relationship, $allowedValues, true)) {
