 ...
 */
class FinacialInstrumentAsset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinacialInstrumentAsset';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('value_adjustment', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets real_value
     *
     * @param float|null $real_value real_value
     *
     * @return self
     */
     ...
     *
     * @param float|null $value_adjustment value_adjustment
     *
     * @return self
     */
    public function setValueAdjustment($value_adjustment)
    {
        ...
        if (is_null($value_adjustment)) {
            throw new \InvalidArgumentException('non-nullable value_adjustment cannot be null');
        }
