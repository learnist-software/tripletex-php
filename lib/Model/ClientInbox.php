 ...
 */
class ClientInbox implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientInbox';
    ...
    */
     ...
     * Sets inbox_count
     *
     * @param int|null $inbox_count inbox_count
     *
     * @return self
     */
