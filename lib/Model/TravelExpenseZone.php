 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TravelExpenseZone implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TravelExpenseZone';
...
'continent' => 'getContinent'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['government_name'] = isset($data['government_name']) ? $data['government_name'] : null;
     ...
     * Sets country_code
     *
     * @param string $country_code The ISO 3166-1 Alpha2 code of the country (2 letters). https://en.wikipedia.org/wiki/ISO_3166-1
     *
     * @return $this
     */
     ...
     *
     * @param string $government_name The Government name
     *
     * @return $this
     */
