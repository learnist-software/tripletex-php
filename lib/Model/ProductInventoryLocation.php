 ...
 */
class ProductInventoryLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductInventoryLocation';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_main_location', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $is_main_location is_main_location
     *
     * @return self
     */
    public function setIsMainLocation($is_main_location)
    {
        ...
        if (is_null($is_main_location)) {
            throw new \InvalidArgumentException('non-nullable is_main_location cannot be null');
        }
