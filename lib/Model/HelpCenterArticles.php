 ...
 */
class HelpCenterArticles implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HelpCenterArticles';
    ...
    protected static array $openAPINullables = [
        'main_article' => false,
		'relevant_articles' => false,
		'videos' => false,
		'faqs' => false,
		'salesforce_support_requests_url' => false,
		'help_center_url' => false,
		'keyboard_shortcuts_article_url' => false
    ];
    ...
    {
        $this->setIfExists('main_article', $data ?? [], null);
        $this->setIfExists('relevant_articles', $data ?? [], null);
        $this->setIfExists('videos', $data ?? [], null);
        $this->setIfExists('faqs', $data ?? [], null);
        $this->setIfExists('salesforce_support_requests_url', $data ?? [], null);
        $this->setIfExists('help_center_url', $data ?? [], null);
        $this->setIfExists('keyboard_shortcuts_article_url', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets main_article
     *
     * @return \Learnist\Tripletex\Model\Article|null
     */
     ...
     * Sets main_article
     *
     * @param \Learnist\Tripletex\Model\Article|null $main_article main_article
     *
     * @return self
     */
    public function setMainArticle($main_article)
    {
        if (is_null($main_article)) {
            throw new \InvalidArgumentException('non-nullable main_article cannot be null');
        }
     ...
     *
     * @param \Learnist\Tripletex\Model\Article[]|null $relevant_articles relevant_articles
     *
     * @return self
     */
    public function setRelevantArticles($relevant_articles)
    {
        if (is_null($relevant_articles)) {
            throw new \InvalidArgumentException('non-nullable relevant_articles cannot be null');
        }
     ...
     * Gets videos
     *
     * @return \Learnist\Tripletex\Model\Video[]|null
     */
     ...
     * Sets videos
     *
     * @param \Learnist\Tripletex\Model\Video[]|null $videos videos
     *
     * @return self
     */
     ...
     * Sets faqs
     *
     * @param \Learnist\Tripletex\Model\Article[]|null $faqs faqs
     *
     * @return self
     */
    ...
    {
        if (is_null($faqs)) {
            throw new \InvalidArgumentException('non-nullable faqs cannot be null');
        }
     ...
     *
     * @param string|null $salesforce_support_requests_url salesforce_support_requests_url
     *
     * @return self
     */
    public function setSalesforceSupportRequestsUrl($salesforce_support_requests_url)
    {
        if (is_null($salesforce_support_requests_url)) {
            throw new \InvalidArgumentException('non-nullable salesforce_support_requests_url cannot be null');
        }
     ...
     *
     * @param string|null $help_center_url help_center_url
     *
     * @return self
     */
    public function setHelpCenterUrl($help_center_url)
    {
        if (is_null($help_center_url)) {
            throw new \InvalidArgumentException('non-nullable help_center_url cannot be null');
        }
     ...
     *
     * @param string|null $keyboard_shortcuts_article_url keyboard_shortcuts_article_url
     *
     * @return self
     */
    public function setKeyboardShortcutsArticleUrl($keyboard_shortcuts_article_url)
    {
        if (is_null($keyboard_shortcuts_article_url)) {
            throw new \InvalidArgumentException('non-nullable keyboard_shortcuts_article_url cannot be null');
        }
