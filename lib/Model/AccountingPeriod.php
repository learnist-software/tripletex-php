 ...
 */
class AccountingPeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountingPeriod';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['number']) && ($this->container['number'] > 11)) {
            $invalidProperties[] = "invalid value for 'number', must be smaller than or equal to 11.";
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AccountingPeriod., must be smaller than or equal to 255.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if (!is_null($number) && ($number > 11)) {
            throw new \InvalidArgumentException('invalid value for $number when calling AccountingPeriod., must be smaller than or equal to 11.');
        }
        if (!is_null($number) && ($number < 0)) {
            throw new \InvalidArgumentException('invalid value for $number when calling AccountingPeriod., must be bigger than or equal to 0.');
        }
