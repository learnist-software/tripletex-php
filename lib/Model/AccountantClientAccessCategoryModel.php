 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountantClientAccessCategoryModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountantClientAccessCategoryModel';
...
const CATEGORY_HOUR_LIST = 'HOUR_LIST';
const CATEGORY_TRAVEL_REPORT = 'TRAVEL_REPORT';
const CATEGORY_VOUCHER = 'VOUCHER';
const CATEGORY_YEAR_END_REPORT = 'YEAR_END_REPORT';
const ACCESS_LEVEL_NONE = 'NONE';
const ACCESS_LEVEL_SOME = 'SOME';
...
self::ACCESS_LEVEL_ALL,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['has_received_aggregated_access'] = isset($data['has_received_aggregated_access']) ? $data['has_received_aggregated_access'] : null;
     ...
     *
     * @param bool $has_received_aggregated_access has_received_aggregated_access
     *
     * @return $this
     */
     ...
     * Gets roles
     *
     * @return \Learnist\Tripletex\Model\AccountantClientAccessRole[]
     */
     ...
     * Sets roles
     *
     * @param \Learnist\Tripletex\Model\AccountantClientAccessRole[] $roles roles
     *
     * @return $this
     */
