...
/**
 * CompanyBankAccountPresentation Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class CompanyBankAccountPresentation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CompanyBankAccountPresentation';
    ...
    public const PROVIDER_AUTOPAY = 'AUTOPAY';
    ...
    */
     ...
     * Sets bban
     *
     * @param string|null $bban Bban-number
     *
     * @return self
     */
     ...
     * Sets bic
     *
     * @param string|null $bic BIC/SWIFT for this bankaccount
     *
     * @return self
     */
