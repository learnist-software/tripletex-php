...
/**
 * ProjectAccess Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
const ACCESS_CONTROL_FORMS_WRITE = 'WRITE';
     ...
     * @return string[]
     */
    public function getAccessOrderLinesAllowableValues()
    {
        return [
...
self::ACCESS_ORDER_LINES_WRITE,        ];
     ...
     * @return string[]
     */
    public function getAccessHoursAllowableValues()
    {
        return [
...
self::ACCESS_HOURS_WRITE,        ];
     ...
     * @return string[]
     */
    public function getAccessAttachmentsAllowableValues()
    {
        return [
...
self::ACCESS_ATTACHMENTS_WRITE,        ];
     ...
     * @return string[]
     */
    public function getAccessControlFormsAllowableValues()
    {
        return [
...
self::ACCESS_CONTROL_FORMS_WRITE,        ];
    ...
    {
        return $this->container['access_order_lines'];
    }
    ...
    public function setAccessOrderLines($access_order_lines)
    {
        ...
        $this->container['access_order_lines'] = $access_order_lines;
    ...
    {
        return $this->container['access_hours'];
    }
    ...
    public function setAccessHours($access_hours)
    {
        ...
        $this->container['access_hours'] = $access_hours;
    ...
    {
        return $this->container['access_attachments'];
    }
    ...
    public function setAccessAttachments($access_attachments)
    {
        ...
        $this->container['access_attachments'] = $access_attachments;
    ...
    {
        return $this->container['access_control_forms'];
    }
    ...
    public function setAccessControlForms($access_control_forms)
    {
        ...
        $this->container['access_control_forms'] = $access_control_forms;
