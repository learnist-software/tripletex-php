...
/**
 * AccommodationAllowance Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class AccommodationAllowance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccommodationAllowance';
    ...
    */
    ...
    public function setLocation($location)
    {
        if ((mb_strlen($location) > 255)) {
            throw new \InvalidArgumentException('invalid length for $location when calling AccommodationAllowance., must be smaller than or equal to 255.');
        }
