 ...
 */
class SalaryType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalaryType';
    ...
    */
    ...
    public function setNumber($number)
    {
        if (!is_null($number) && (mb_strlen($number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $number when calling SalaryType., must be smaller than or equal to 10.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SalaryType., must be smaller than or equal to 255.');
        }
