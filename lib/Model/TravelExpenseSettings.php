...
'mileage_not_compensated' => 'getMileageNotCompensated'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['use_rates'] = isset($data['use_rates']) ? $data['use_rates'] : null;
        $this->container['approval_required'] = isset($data['approval_required']) ? $data['approval_required'] : null;
        $this->container['tax_free_per_diem_rates'] = isset($data['tax_free_per_diem_rates']) ? $data['tax_free_per_diem_rates'] : null;
        $this->container['tax_free_mileage_rates'] = isset($data['tax_free_mileage_rates']) ? $data['tax_free_mileage_rates'] : null;
        $this->container['per_diem_not_compensated'] = isset($data['per_diem_not_compensated']) ? $data['per_diem_not_compensated'] : null;
        $this->container['accommodation_not_compensated'] = isset($data['accommodation_not_compensated']) ? $data['accommodation_not_compensated'] : null;
        $this->container['mileage_not_compensated'] = isset($data['mileage_not_compensated']) ? $data['mileage_not_compensated'] : null;
    }
