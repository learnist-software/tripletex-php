...
/**
 * NoteTextLibrary Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class NoteTextLibrary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoteTextLibrary';
    ...
    protected static $setters = [
        ...
        'note_post_name' => 'setNotePostName',
        'posts' => 'setPosts'
    ];
    ...
    protected static $getters = [
        ...
        'note_post_name' => 'getNotePostName',
        'posts' => 'getPosts'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('note_post_name', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getNotePostName()
    {
        return $this->container['note_post_name'];
    }

    /**
     * Sets note_post_name
     *
     * @param string|null $note_post_name note_post_name
     *
     * @return self
     */
    public function setNotePostName($note_post_name)
    {

        if (is_null($note_post_name)) {
            throw new \InvalidArgumentException('non-nullable note_post_name cannot be null');
        }

        $this->container['note_post_name'] = $note_post_name;
