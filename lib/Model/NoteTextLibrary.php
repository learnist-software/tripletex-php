 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NoteTextLibrary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NoteTextLibrary';
...
self::NOTE_POST_TYPE_FREE_NOTE_FREE_TEXT,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['note_post_name'] = isset($data['note_post_name']) ? $data['note_post_name'] : null;
     ...
     * Sets note_post_name
     *
     * @param string $note_post_name note_post_name
     *
     * @return $this
     */
