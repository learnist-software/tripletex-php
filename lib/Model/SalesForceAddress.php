...
/**
 * SalesForceAddress Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class SalesForceAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesForceAddress';
    ...
    protected static $openAPITypes = [
        ...
        'postal_code' => 'string',
        'city' => 'string',
        'country' => '\Learnist\Tripletex\Model\SalesForceCountry'
    ];
    ...
    */
    ...
    public function setAddressLine1($address_line1)
    {
        if (!is_null($address_line1) && (mb_strlen($address_line1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling SalesForceAddress., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressLine2($address_line2)
    {
        if (!is_null($address_line2) && (mb_strlen($address_line2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling SalesForceAddress., must be smaller than or equal to 255.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 100)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling SalesForceAddress., must be smaller than or equal to 100.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $city when calling SalesForceAddress., must be smaller than or equal to 100.');
        }
     ...
     * Gets country
     *
     * @return \Learnist\Tripletex\Model\SalesForceCountry|null
     */
     ...
     * Sets country
     *
     * @param \Learnist\Tripletex\Model\SalesForceCountry|null $country country
     *
     * @return self
     */
