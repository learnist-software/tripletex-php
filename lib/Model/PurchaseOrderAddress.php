...
/**
 * PurchaseOrderAddress Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class PurchaseOrderAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PurchaseOrderAddress';
    ...
    protected static $openAPITypes = [
        ...
        'unit_number' => 'string',
        'name' => 'string',
        'customer_vendor' => '\Learnist\Tripletex\Model\Customer'
    ];
    ...
    */
    ...
    {
        if (!is_null($address_line1) && (mb_strlen($address_line1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling PurchaseOrderAddress., must be smaller than or equal to 255.');
        }
        if (!is_null($address_line1) && (mb_strlen($address_line1) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling PurchaseOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setAddressLine2($address_line2)
    {
        if (!is_null($address_line2) && (mb_strlen($address_line2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling PurchaseOrderAddress., must be smaller than or equal to 255.');
        }
        if (!is_null($address_line2) && (mb_strlen($address_line2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling PurchaseOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 100)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling PurchaseOrderAddress., must be smaller than or equal to 100.');
        }
        if (!is_null($postal_code) && (mb_strlen($postal_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling PurchaseOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PurchaseOrderAddress., must be smaller than or equal to 100.');
        }
        if (!is_null($city) && (mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PurchaseOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setKnr($knr)
    {
        ...
        if (!is_null($knr) && ($knr < 0)) {
            throw new \InvalidArgumentException('invalid value for $knr when calling PurchaseOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setGnr($gnr)
    {
        ...
        if (!is_null($gnr) && ($gnr < 0)) {
            throw new \InvalidArgumentException('invalid value for $gnr when calling PurchaseOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setBnr($bnr)
    {
        ...
        if (!is_null($bnr) && ($bnr < 0)) {
            throw new \InvalidArgumentException('invalid value for $bnr when calling PurchaseOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setFnr($fnr)
    {
        ...
        if (!is_null($fnr) && ($fnr < 0)) {
            throw new \InvalidArgumentException('invalid value for $fnr when calling PurchaseOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setSnr($snr)
    {
        ...
        if (!is_null($snr) && ($snr < 0)) {
            throw new \InvalidArgumentException('invalid value for $snr when calling PurchaseOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setUnitNumber($unit_number)
    {
        if (!is_null($unit_number) && (mb_strlen($unit_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $unit_number when calling PurchaseOrderAddress., must be smaller than or equal to 255.');
        }
        if (!is_null($unit_number) && (mb_strlen($unit_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $unit_number when calling PurchaseOrderAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PurchaseOrderAddress., must be smaller than or equal to 100.');
        }
     ...
     *
     * @param \Learnist\Tripletex\Model\Customer|null $customer_vendor customer_vendor
     *
     * @return self
     */
