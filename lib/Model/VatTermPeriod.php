...
/**
 * VatTermPeriod Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class VatTermPeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VatTermPeriod';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('default_term', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets default_term
     *
     * @param bool|null $default_term Default term
     *
     * @return self
     */
    public function setDefaultTerm($default_term)
    {
        ...
        if (is_null($default_term)) {
            throw new \InvalidArgumentException('non-nullable default_term cannot be null');
        }
