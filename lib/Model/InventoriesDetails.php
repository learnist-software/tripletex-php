...
const OPENING_BALANCE_POST_TYPE_FUEL_COST = 'FUEL_COST';
const OPENING_BALANCE_POST_TYPE_MAINTENANCE_COST = 'MAINTENANCE_COST';
const OPENING_BALANCE_POST_TYPE_COST_OF_INSURANCE_AND_TAX = 'COST_OF_INSURANCE_AND_TAX';
...
const OPENING_BALANCE_POST_TYPE_MUST_BE_CONFIRMED_BY_AUDITOR = 'MUST_BE_CONFIRMED_BY_AUDITOR';
...
const OPENING_BALANCE_POST_TYPE_IS_TAXABLE = 'IS_TAXABLE';
const OPENING_BALANCE_POST_TYPE_REQUIRE_AUDITORS_SIGNATURE = 'REQUIRE_AUDITORS_SIGNATURE';
const OPENING_BALANCE_POST_TYPE_VALIDATION_ONLY_ON_SUBMIT = 'VALIDATION_ONLY_ON_SUBMIT';
...
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_ACCOMMODATION_AND_RESTAURANT = 'YEAR_END_DOCUMENTATION_ACCOMMODATION_AND_RESTAURANT';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_PROFIT_AND_LOSS_ACCOUNT = 'YEAR_END_DOCUMENTATION_PROFIT_AND_LOSS_ACCOUNT';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_COMMERCIAL_VEHICLE = 'YEAR_END_DOCUMENTATION_COMMERCIAL_VEHICLE';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_TANGIBLE_FIXED_ASSETS = 'YEAR_END_DOCUMENTATION_TANGIBLE_FIXED_ASSETS';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_INVENTORIES = 'YEAR_END_DOCUMENTATION_INVENTORIES';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_ACCOUNTS_RECEIVABLE_FROM_CUSTOMERS = 'YEAR_END_DOCUMENTATION_ACCOUNTS_RECEIVABLE_FROM_CUSTOMERS';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_PROFIT_LOSS = 'YEAR_END_DOCUMENTATION_PROFIT_LOSS';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_BALANCE = 'YEAR_END_DOCUMENTATION_BALANCE';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_PERSONAL_INCOME = 'YEAR_END_DOCUMENTATION_PERSONAL_INCOME';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_PERMANENT_DIFFERENCES = 'YEAR_END_DOCUMENTATION_PERMANENT_DIFFERENCES';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_TEMPORARY_DIFFERENCES = 'YEAR_END_DOCUMENTATION_TEMPORARY_DIFFERENCES';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_TAX_RELATED_RESULT = 'YEAR_END_DOCUMENTATION_TAX_RELATED_RESULT';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_GROUP_CONTRIBUTIONS = 'YEAR_END_DOCUMENTATION_GROUP_CONTRIBUTIONS';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_EQUITY_RECONCILIATION = 'YEAR_END_DOCUMENTATION_EQUITY_RECONCILIATION';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_TAX_RETURN = 'YEAR_END_DOCUMENTATION_TAX_RETURN';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_DIVIDEND = 'YEAR_END_DOCUMENTATION_DIVIDEND';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_DISPOSITIONS = 'YEAR_END_DOCUMENTATION_DISPOSITIONS';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_PROPERTIES = 'YEAR_END_DOCUMENTATION_PROPERTIES';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_SECURITIES = 'YEAR_END_DOCUMENTATION_SECURITIES';
const OPENING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_TAX_CALCULATION = 'YEAR_END_DOCUMENTATION_TAX_CALCULATION';
...
const OPENING_BALANCE_POST_TYPE_APPLICATION_OF_LOSS_CARRY_FORWARDS = 'APPLICATION_OF_LOSS_CARRY_FORWARDS';
const OPENING_BALANCE_POST_TYPE_ACCUMULATED_LOSS_FROM_PREVIOUS_YEARS = 'ACCUMULATED_LOSS_FROM_PREVIOUS_YEARS';
const OPENING_BALANCE_POST_TYPE_CORRECTIONS_AND_OTHER_CAPITAL = 'CORRECTIONS_AND_OTHER_CAPITAL';
const OPENING_BALANCE_POST_TYPE_CORRECTIONS_AND_OTHER_DEBT = 'CORRECTIONS_AND_OTHER_DEBT';
const OPENING_BALANCE_POST_TYPE_IS_PART_OF_GROUP_COMPANY = 'IS_PART_OF_GROUP_COMPANY';
const OPENING_BALANCE_POST_TYPE_IS_LISTED_ON_THE_STOCK_EXCHANGE = 'IS_LISTED_ON_THE_STOCK_EXCHANGE';
const OPENING_BALANCE_POST_TYPE_IS_REORGANIZED_ACROSS_BORDERS = 'IS_REORGANIZED_ACROSS_BORDERS';
const OPENING_BALANCE_POST_TYPE_HAS_RECEIVED_OR_TRANSFERED_ASSETS = 'HAS_RECEIVED_OR_TRANSFERED_ASSETS';
const OPENING_BALANCE_POST_TYPE_HEAD_OF_GROUP_NAME = 'HEAD_OF_GROUP_NAME';
const OPENING_BALANCE_POST_TYPE_HEAD_OF_GROUP_COUNTRY_CODE = 'HEAD_OF_GROUP_COUNTRY_CODE';
const OPENING_BALANCE_POST_TYPE_HEAD_OF_GROUP_LAST_YEAR_NAME = 'HEAD_OF_GROUP_LAST_YEAR_NAME';
const OPENING_BALANCE_POST_TYPE_HEAD_OF_GROUP_LAST_YEAR_COUNTRY_CODE = 'HEAD_OF_GROUP_LAST_YEAR_COUNTRY_CODE';
const OPENING_BALANCE_POST_TYPE_FOREIGN_OWNERSHIP_COMPANY_NAME = 'FOREIGN_OWNERSHIP_COMPANY_NAME';
const OPENING_BALANCE_POST_TYPE_FOREIGN_OWNERSHIP_COMPANY_COUNTRY_CODE = 'FOREIGN_OWNERSHIP_COMPANY_COUNTRY_CODE';
const OPENING_BALANCE_POST_TYPE_OWNS_MIN_50_PERCENT_OF_FOREIGN_COMPANY = 'OWNS_MIN_50_PERCENT_OF_FOREIGN_COMPANY';
const OPENING_BALANCE_POST_TYPE_HAS_PERMANENT_ESTABLISHMENT_ABROAD = 'HAS_PERMANENT_ESTABLISHMENT_ABROAD';
const OPENING_BALANCE_POST_TYPE_COUNTRY_FOR_COUNTRY_REPORTABLE_ENTERPRISE_NAME = 'COUNTRY_FOR_COUNTRY_REPORTABLE_ENTERPRISE_NAME';
const OPENING_BALANCE_POST_TYPE_COUNTRY_FOR_COUNTRY_REPORTABLE_ENTERPRISE_COUNTRY_CODE = 'COUNTRY_FOR_COUNTRY_REPORTABLE_ENTERPRISE_COUNTRY_CODE';
const OPENING_BALANCE_POST_TYPE_HAS_PERFORMANCE_BETWEEN_SHAREHOLDERS_AND_OTHER = 'HAS_PERFORMANCE_BETWEEN_SHAREHOLDERS_AND_OTHER';
const OPENING_BALANCE_POST_TYPE_HAS_OUTSTANDING_PAYMENT_CLAIMS_RELATED_TO_ILLEGAL_STATE_AID = 'HAS_OUTSTANDING_PAYMENT_CLAIMS_RELATED_TO_ILLEGAL_STATE_AID';
const OPENING_BALANCE_POST_TYPE_IS_SMALL_OR_MEDIUM_SIZED_BUSINESS = 'IS_SMALL_OR_MEDIUM_SIZED_BUSINESS';
const OPENING_BALANCE_POST_TYPE_HAD_FINANCIAL_DIFFICULTIES_LAST_YEAR = 'HAD_FINANCIAL_DIFFICULTIES_LAST_YEAR';
const OPENING_BALANCE_POST_TYPE_IS_GROUP_COMPANY = 'IS_GROUP_COMPANY';
const OPENING_BALANCE_POST_TYPE_HAS_RECEIVED_OTHER_PUBLIC_SUPPORT = 'HAS_RECEIVED_OTHER_PUBLIC_SUPPORT';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_TONNAGE_TAX_REGIME = 'AID_SCHEME_TONNAGE_TAX_REGIME';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_RULES_FOR_ELECTRIC_DELIVERY_TRUCKS = 'AID_SCHEME_RULES_FOR_ELECTRIC_DELIVERY_TRUCKS';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_FOR_LONGTERM_INVESTMENTS = 'AID_SCHEME_FOR_LONGTERM_INVESTMENTS';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_EMPLOYMENT_RELATED_OPTIONS_START_UP = 'AID_SCHEME_EMPLOYMENT_RELATED_OPTIONS_START_UP';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_TAX_FUN = 'AID_SCHEME_TAX_FUN';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_FAVOURABLE_DEPRECIATION_RULES = 'AID_SCHEME_FAVOURABLE_DEPRECIATION_RULES';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_REGIONALLY_DIFFERENTIATED_INSURANCE_CONTRIBUTIONS = 'AID_SCHEME_REGIONALLY_DIFFERENTIATED_INSURANCE_CONTRIBUTIONS';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_FAVOURABLE_DETERMINED_LIST_PRICES_ELECTRIC_VEHICLES = 'AID_SCHEME_FAVOURABLE_DETERMINED_LIST_PRICES_ELECTRIC_VEHICLES';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_VAT_EXEMPTION_TURNOVER_ELECTRIC_CARS = 'AID_SCHEME_VAT_EXEMPTION_TURNOVER_ELECTRIC_CARS';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_VAT_EXEMPTION_LEASING_ELECTRIC_CARS = 'AID_SCHEME_VAT_EXEMPTION_LEASING_ELECTRIC_CARS';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_VAT_EXEMPTION_TURNOVER_BATTERIES = 'AID_SCHEME_VAT_EXEMPTION_TURNOVER_BATTERIES';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_VAT_EXEMPTION_TURNOVER_ELECTRIC_NEWS = 'AID_SCHEME_VAT_EXEMPTION_TURNOVER_ELECTRIC_NEWS';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_ELECTRICITY_TAX_INDUSTRIAL_SECTOR = 'AID_SCHEME_REDUCED_ELECTRICITY_TAX_INDUSTRIAL_SECTOR';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_ELECTRICITY_TAX_DISTRICT_HEATING = 'AID_SCHEME_REDUCED_ELECTRICITY_TAX_DISTRICT_HEATING';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_ELECTRICITY_TAX_TARGET_ZONE = 'AID_SCHEME_REDUCED_ELECTRICITY_TAX_TARGET_ZONE';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_ELECTRICITY_TAX_DATA_CENTRES = 'AID_SCHEME_REDUCED_ELECTRICITY_TAX_DATA_CENTRES';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_ELECTRICITY_TAX_COMMERCIAL_VESSELS = 'AID_SCHEME_REDUCED_ELECTRICITY_TAX_COMMERCIAL_VESSELS';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_ELECTRICITY_TAX_ENERGY_PRODUCTS = 'AID_SCHEME_REDUCED_ELECTRICITY_TAX_ENERGY_PRODUCTS';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_BASIC_TAX_MINERAL_OIL_WOOD_INDUSTRY = 'AID_SCHEME_REDUCED_BASIC_TAX_MINERAL_OIL_WOOD_INDUSTRY';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_BASIC_TAX_MINERAL_OIL_PIGMENT_INDUSTRY = 'AID_SCHEME_REDUCED_BASIC_TAX_MINERAL_OIL_PIGMENT_INDUSTRY';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_EXEMPTION_CO2_TAX_MINERAL_OIL = 'AID_SCHEME_EXEMPTION_CO2_TAX_MINERAL_OIL';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_EXEMPTION_CO2_TAX_GAS = 'AID_SCHEME_EXEMPTION_CO2_TAX_GAS';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_EXEMPTION_NOX_DUTY = 'AID_SCHEME_EXEMPTION_NOX_DUTY';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_EXEMPTION_TRANSFER_FEE = 'AID_SCHEME_EXEMPTION_TRANSFER_FEE';
const OPENING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_ROAD_TRAFFIC_INSURANCE_TAX = 'AID_SCHEME_REDUCED_ROAD_TRAFFIC_INSURANCE_TAX';
const OPENING_BALANCE_POST_TYPE_OTHER_CORRECTIONS = 'OTHER_CORRECTIONS';
const OPENING_BALANCE_POST_TYPE_YEARLY_DIVIDEND = 'YEARLY_DIVIDEND';
...
const CLOSING_BALANCE_POST_TYPE_FUEL_COST = 'FUEL_COST';
const CLOSING_BALANCE_POST_TYPE_MAINTENANCE_COST = 'MAINTENANCE_COST';
const CLOSING_BALANCE_POST_TYPE_COST_OF_INSURANCE_AND_TAX = 'COST_OF_INSURANCE_AND_TAX';
...
const CLOSING_BALANCE_POST_TYPE_MUST_BE_CONFIRMED_BY_AUDITOR = 'MUST_BE_CONFIRMED_BY_AUDITOR';
...
const CLOSING_BALANCE_POST_TYPE_IS_TAXABLE = 'IS_TAXABLE';
const CLOSING_BALANCE_POST_TYPE_REQUIRE_AUDITORS_SIGNATURE = 'REQUIRE_AUDITORS_SIGNATURE';
const CLOSING_BALANCE_POST_TYPE_VALIDATION_ONLY_ON_SUBMIT = 'VALIDATION_ONLY_ON_SUBMIT';
...
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_ACCOMMODATION_AND_RESTAURANT = 'YEAR_END_DOCUMENTATION_ACCOMMODATION_AND_RESTAURANT';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_PROFIT_AND_LOSS_ACCOUNT = 'YEAR_END_DOCUMENTATION_PROFIT_AND_LOSS_ACCOUNT';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_COMMERCIAL_VEHICLE = 'YEAR_END_DOCUMENTATION_COMMERCIAL_VEHICLE';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_TANGIBLE_FIXED_ASSETS = 'YEAR_END_DOCUMENTATION_TANGIBLE_FIXED_ASSETS';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_INVENTORIES = 'YEAR_END_DOCUMENTATION_INVENTORIES';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_ACCOUNTS_RECEIVABLE_FROM_CUSTOMERS = 'YEAR_END_DOCUMENTATION_ACCOUNTS_RECEIVABLE_FROM_CUSTOMERS';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_PROFIT_LOSS = 'YEAR_END_DOCUMENTATION_PROFIT_LOSS';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_BALANCE = 'YEAR_END_DOCUMENTATION_BALANCE';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_PERSONAL_INCOME = 'YEAR_END_DOCUMENTATION_PERSONAL_INCOME';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_PERMANENT_DIFFERENCES = 'YEAR_END_DOCUMENTATION_PERMANENT_DIFFERENCES';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_TEMPORARY_DIFFERENCES = 'YEAR_END_DOCUMENTATION_TEMPORARY_DIFFERENCES';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_TAX_RELATED_RESULT = 'YEAR_END_DOCUMENTATION_TAX_RELATED_RESULT';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_GROUP_CONTRIBUTIONS = 'YEAR_END_DOCUMENTATION_GROUP_CONTRIBUTIONS';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_EQUITY_RECONCILIATION = 'YEAR_END_DOCUMENTATION_EQUITY_RECONCILIATION';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_TAX_RETURN = 'YEAR_END_DOCUMENTATION_TAX_RETURN';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_DIVIDEND = 'YEAR_END_DOCUMENTATION_DIVIDEND';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_DISPOSITIONS = 'YEAR_END_DOCUMENTATION_DISPOSITIONS';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_PROPERTIES = 'YEAR_END_DOCUMENTATION_PROPERTIES';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_SECURITIES = 'YEAR_END_DOCUMENTATION_SECURITIES';
const CLOSING_BALANCE_POST_TYPE_YEAR_END_DOCUMENTATION_TAX_CALCULATION = 'YEAR_END_DOCUMENTATION_TAX_CALCULATION';
...
const CLOSING_BALANCE_POST_TYPE_APPLICATION_OF_LOSS_CARRY_FORWARDS = 'APPLICATION_OF_LOSS_CARRY_FORWARDS';
const CLOSING_BALANCE_POST_TYPE_ACCUMULATED_LOSS_FROM_PREVIOUS_YEARS = 'ACCUMULATED_LOSS_FROM_PREVIOUS_YEARS';
const CLOSING_BALANCE_POST_TYPE_CORRECTIONS_AND_OTHER_CAPITAL = 'CORRECTIONS_AND_OTHER_CAPITAL';
const CLOSING_BALANCE_POST_TYPE_CORRECTIONS_AND_OTHER_DEBT = 'CORRECTIONS_AND_OTHER_DEBT';
const CLOSING_BALANCE_POST_TYPE_IS_PART_OF_GROUP_COMPANY = 'IS_PART_OF_GROUP_COMPANY';
const CLOSING_BALANCE_POST_TYPE_IS_LISTED_ON_THE_STOCK_EXCHANGE = 'IS_LISTED_ON_THE_STOCK_EXCHANGE';
const CLOSING_BALANCE_POST_TYPE_IS_REORGANIZED_ACROSS_BORDERS = 'IS_REORGANIZED_ACROSS_BORDERS';
const CLOSING_BALANCE_POST_TYPE_HAS_RECEIVED_OR_TRANSFERED_ASSETS = 'HAS_RECEIVED_OR_TRANSFERED_ASSETS';
const CLOSING_BALANCE_POST_TYPE_HEAD_OF_GROUP_NAME = 'HEAD_OF_GROUP_NAME';
const CLOSING_BALANCE_POST_TYPE_HEAD_OF_GROUP_COUNTRY_CODE = 'HEAD_OF_GROUP_COUNTRY_CODE';
const CLOSING_BALANCE_POST_TYPE_HEAD_OF_GROUP_LAST_YEAR_NAME = 'HEAD_OF_GROUP_LAST_YEAR_NAME';
const CLOSING_BALANCE_POST_TYPE_HEAD_OF_GROUP_LAST_YEAR_COUNTRY_CODE = 'HEAD_OF_GROUP_LAST_YEAR_COUNTRY_CODE';
const CLOSING_BALANCE_POST_TYPE_FOREIGN_OWNERSHIP_COMPANY_NAME = 'FOREIGN_OWNERSHIP_COMPANY_NAME';
const CLOSING_BALANCE_POST_TYPE_FOREIGN_OWNERSHIP_COMPANY_COUNTRY_CODE = 'FOREIGN_OWNERSHIP_COMPANY_COUNTRY_CODE';
const CLOSING_BALANCE_POST_TYPE_OWNS_MIN_50_PERCENT_OF_FOREIGN_COMPANY = 'OWNS_MIN_50_PERCENT_OF_FOREIGN_COMPANY';
const CLOSING_BALANCE_POST_TYPE_HAS_PERMANENT_ESTABLISHMENT_ABROAD = 'HAS_PERMANENT_ESTABLISHMENT_ABROAD';
const CLOSING_BALANCE_POST_TYPE_COUNTRY_FOR_COUNTRY_REPORTABLE_ENTERPRISE_NAME = 'COUNTRY_FOR_COUNTRY_REPORTABLE_ENTERPRISE_NAME';
const CLOSING_BALANCE_POST_TYPE_COUNTRY_FOR_COUNTRY_REPORTABLE_ENTERPRISE_COUNTRY_CODE = 'COUNTRY_FOR_COUNTRY_REPORTABLE_ENTERPRISE_COUNTRY_CODE';
const CLOSING_BALANCE_POST_TYPE_HAS_PERFORMANCE_BETWEEN_SHAREHOLDERS_AND_OTHER = 'HAS_PERFORMANCE_BETWEEN_SHAREHOLDERS_AND_OTHER';
const CLOSING_BALANCE_POST_TYPE_HAS_OUTSTANDING_PAYMENT_CLAIMS_RELATED_TO_ILLEGAL_STATE_AID = 'HAS_OUTSTANDING_PAYMENT_CLAIMS_RELATED_TO_ILLEGAL_STATE_AID';
const CLOSING_BALANCE_POST_TYPE_IS_SMALL_OR_MEDIUM_SIZED_BUSINESS = 'IS_SMALL_OR_MEDIUM_SIZED_BUSINESS';
const CLOSING_BALANCE_POST_TYPE_HAD_FINANCIAL_DIFFICULTIES_LAST_YEAR = 'HAD_FINANCIAL_DIFFICULTIES_LAST_YEAR';
const CLOSING_BALANCE_POST_TYPE_IS_GROUP_COMPANY = 'IS_GROUP_COMPANY';
const CLOSING_BALANCE_POST_TYPE_HAS_RECEIVED_OTHER_PUBLIC_SUPPORT = 'HAS_RECEIVED_OTHER_PUBLIC_SUPPORT';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_TONNAGE_TAX_REGIME = 'AID_SCHEME_TONNAGE_TAX_REGIME';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_RULES_FOR_ELECTRIC_DELIVERY_TRUCKS = 'AID_SCHEME_RULES_FOR_ELECTRIC_DELIVERY_TRUCKS';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_FOR_LONGTERM_INVESTMENTS = 'AID_SCHEME_FOR_LONGTERM_INVESTMENTS';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_EMPLOYMENT_RELATED_OPTIONS_START_UP = 'AID_SCHEME_EMPLOYMENT_RELATED_OPTIONS_START_UP';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_TAX_FUN = 'AID_SCHEME_TAX_FUN';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_FAVOURABLE_DEPRECIATION_RULES = 'AID_SCHEME_FAVOURABLE_DEPRECIATION_RULES';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_REGIONALLY_DIFFERENTIATED_INSURANCE_CONTRIBUTIONS = 'AID_SCHEME_REGIONALLY_DIFFERENTIATED_INSURANCE_CONTRIBUTIONS';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_FAVOURABLE_DETERMINED_LIST_PRICES_ELECTRIC_VEHICLES = 'AID_SCHEME_FAVOURABLE_DETERMINED_LIST_PRICES_ELECTRIC_VEHICLES';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_VAT_EXEMPTION_TURNOVER_ELECTRIC_CARS = 'AID_SCHEME_VAT_EXEMPTION_TURNOVER_ELECTRIC_CARS';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_VAT_EXEMPTION_LEASING_ELECTRIC_CARS = 'AID_SCHEME_VAT_EXEMPTION_LEASING_ELECTRIC_CARS';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_VAT_EXEMPTION_TURNOVER_BATTERIES = 'AID_SCHEME_VAT_EXEMPTION_TURNOVER_BATTERIES';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_VAT_EXEMPTION_TURNOVER_ELECTRIC_NEWS = 'AID_SCHEME_VAT_EXEMPTION_TURNOVER_ELECTRIC_NEWS';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_ELECTRICITY_TAX_INDUSTRIAL_SECTOR = 'AID_SCHEME_REDUCED_ELECTRICITY_TAX_INDUSTRIAL_SECTOR';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_ELECTRICITY_TAX_DISTRICT_HEATING = 'AID_SCHEME_REDUCED_ELECTRICITY_TAX_DISTRICT_HEATING';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_ELECTRICITY_TAX_TARGET_ZONE = 'AID_SCHEME_REDUCED_ELECTRICITY_TAX_TARGET_ZONE';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_ELECTRICITY_TAX_DATA_CENTRES = 'AID_SCHEME_REDUCED_ELECTRICITY_TAX_DATA_CENTRES';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_ELECTRICITY_TAX_COMMERCIAL_VESSELS = 'AID_SCHEME_REDUCED_ELECTRICITY_TAX_COMMERCIAL_VESSELS';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_ELECTRICITY_TAX_ENERGY_PRODUCTS = 'AID_SCHEME_REDUCED_ELECTRICITY_TAX_ENERGY_PRODUCTS';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_BASIC_TAX_MINERAL_OIL_WOOD_INDUSTRY = 'AID_SCHEME_REDUCED_BASIC_TAX_MINERAL_OIL_WOOD_INDUSTRY';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_BASIC_TAX_MINERAL_OIL_PIGMENT_INDUSTRY = 'AID_SCHEME_REDUCED_BASIC_TAX_MINERAL_OIL_PIGMENT_INDUSTRY';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_EXEMPTION_CO2_TAX_MINERAL_OIL = 'AID_SCHEME_EXEMPTION_CO2_TAX_MINERAL_OIL';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_EXEMPTION_CO2_TAX_GAS = 'AID_SCHEME_EXEMPTION_CO2_TAX_GAS';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_EXEMPTION_NOX_DUTY = 'AID_SCHEME_EXEMPTION_NOX_DUTY';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_EXEMPTION_TRANSFER_FEE = 'AID_SCHEME_EXEMPTION_TRANSFER_FEE';
const CLOSING_BALANCE_POST_TYPE_AID_SCHEME_REDUCED_ROAD_TRAFFIC_INSURANCE_TAX = 'AID_SCHEME_REDUCED_ROAD_TRAFFIC_INSURANCE_TAX';
const CLOSING_BALANCE_POST_TYPE_OTHER_CORRECTIONS = 'OTHER_CORRECTIONS';
const CLOSING_BALANCE_POST_TYPE_YEARLY_DIVIDEND = 'YEARLY_DIVIDEND';
