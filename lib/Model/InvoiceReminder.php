...
class InvoiceReminder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'interests_currency' => 'float',
        'reminder_date' => '\DateTime',
        'term_of_payment' => '\DateTime',
        'messages' => '\Learnist\Tripletex\Model\InvoiceMessage[]'
    ];
    ...
    protected static $openAPIFormats = [
        'reminder_type' => 'int32',
        'debt_collector_name' => null,
        'total_charge_currency' => 'double',
        'interests_currency' => 'double',
        'reminder_date' => 'date',
    ...
    protected static array $openAPINullables = [
        'reminder_type' => false,
		'debt_collector_name' => false,
		'total_charge_currency' => false,
		'interests_currency' => false,
		'reminder_date' => false,
    ...
    protected static $attributeMap = [
        ...
        'debt_collector_name' => 'debtCollectorName',
        'total_charge_currency' => 'totalChargeCurrency',
        'interests_currency' => 'interestsCurrency',
    ...
    protected static $setters = [
        ...
        'debt_collector_name' => 'setDebtCollectorName',
        'total_charge_currency' => 'setTotalChargeCurrency',
        'interests_currency' => 'setInterestsCurrency',
    ...
    protected static $getters = [
        ...
        'debt_collector_name' => 'getDebtCollectorName',
        'total_charge_currency' => 'getTotalChargeCurrency',
        'interests_currency' => 'getInterestsCurrency',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('debt_collector_name', $data ?? [], null);
        $this->setIfExists('total_charge_currency', $data ?? [], null);
        $this->setIfExists('interests_currency', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets debt_collector_name
     *
     * @return string|null
     */
    public function getDebtCollectorName()
    {
        return $this->container['debt_collector_name'];
    }

    /**
     * Sets debt_collector_name
     *
     * @param string|null $debt_collector_name debt_collector_name
     *
     * @return self
     */
    public function setDebtCollectorName($debt_collector_name)
    {

        if (is_null($debt_collector_name)) {
            throw new \InvalidArgumentException('non-nullable debt_collector_name cannot be null');
        }

        $this->container['debt_collector_name'] = $debt_collector_name;
     ...
     *
     * @param float|null $total_charge_currency total_charge_currency
     *
     * @return self
     */
    ...
    /**
     * Gets interests_currency
     *
     * @return float|null
     */
    public function getInterestsCurrency()
    {
        return $this->container['interests_currency'];
    }

    /**
     * Sets interests_currency
     *
     * @param float|null $interests_currency interests_currency
     *
     * @return self
     */
    public function setInterestsCurrency($interests_currency)
    {

        if (is_null($interests_currency)) {
            throw new \InvalidArgumentException('non-nullable interests_currency cannot be null');
        }

        $this->container['interests_currency'] = $interests_currency;
     ...
     * Sets reminder_date
     *
     * @param \DateTime|null $reminder_date reminder_date
     *
     * @return self
     */
     ...
     * Gets messages
     *
     * @return \Learnist\Tripletex\Model\InvoiceMessage[]|null
     */
     ...
     * Sets messages
     *
     * @param \Learnist\Tripletex\Model\InvoiceMessage[]|null $messages messages
     *
     * @return self
     */
