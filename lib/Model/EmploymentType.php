 ...
 */
class EmploymentType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmploymentType';
    ...
    */
     ...
     *
     * @param string $employment_type Defines the employment type option.
     *
     * @return self
     */
    ...
    public function setNameNo($name_no)
    {
        if (!is_null($name_no) && (mb_strlen($name_no) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name_no when calling EmploymentType., must be smaller than or equal to 100.');
        }
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 100)) {
            throw new \InvalidArgumentException('invalid length for $code when calling EmploymentType., must be smaller than or equal to 100.');
        }
