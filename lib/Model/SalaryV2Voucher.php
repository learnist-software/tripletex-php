...
/**
 * SalaryV2Voucher Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class SalaryV2Voucher implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalaryV2Voucher';
    ...
    protected static $openAPITypes = [
        ...
        'date' => 'string',
        'number' => 'int',
        'reverse_voucher' => '\Learnist\Tripletex\Model\SalaryV2Voucher',
    ...
    protected static $setters = [
        ...
        'number_as_string' => 'setNumberAsString',
        'url_details' => 'setUrlDetails',
        'deletable' => 'setDeletable',
        'reversible' => 'setReversible',
    ...
    protected static $getters = [
        ...
        'number_as_string' => 'getNumberAsString',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('number_as_string', $data ?? [], null);
        $this->setIfExists('url_details', $data ?? [], null);
        $this->setIfExists('deletable', $data ?? [], null);
        $this->setIfExists('reversible', $data ?? [], null);
    ...
    */
    ...
    public function setNumber($number)
    {
        ...
        if (!is_null($number) && ($number < 0)) {
            throw new \InvalidArgumentException('invalid value for $number when calling SalaryV2Voucher., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param \Learnist\Tripletex\Model\SalaryV2Voucher|null $reverse_voucher reverse_voucher
     *
     * @return self
     */
    ...
    /**
     * Gets number_as_string
     *
     * @return string|null
     */
    public function getNumberAsString()
    {
        return $this->container['number_as_string'];
    }

    /**
     * Sets number_as_string
     *
     * @param string|null $number_as_string number_as_string
     *
     * @return self
     */
    public function setNumberAsString($number_as_string)
    {

        if (is_null($number_as_string)) {
            throw new \InvalidArgumentException('non-nullable number_as_string cannot be null');
        }

        $this->container['number_as_string'] = $number_as_string;
    ...
    {
        return $this->container['reversible'];
    }

    /**
     * Sets reversible
     *
     * @param bool|null $reversible reversible
     *
     * @return self
     */
    public function setReversible($reversible)
    {

        if (is_null($reversible)) {
            throw new \InvalidArgumentException('non-nullable reversible cannot be null');
        }

        $this->container['reversible'] = $reversible;
     ...
     * Sets attachment_id
     *
     * @param int|null $attachment_id attachment_id
     *
     * @return self
     */
