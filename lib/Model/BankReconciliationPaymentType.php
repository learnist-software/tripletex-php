...
/**
 * BankReconciliationPaymentType Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class BankReconciliationPaymentType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankReconciliationPaymentType';
    ...
    protected static $openAPITypes = [
        ...
        'url' => 'string',
        'description' => 'string',
        'debit_account' => '\Learnist\Tripletex\Model\Account',
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling BankReconciliationPaymentType., must be smaller than or equal to 255.');
        }
     ...
     * Sets debit_account
     *
     * @param \Learnist\Tripletex\Model\Account|null $debit_account debit_account
     *
     * @return self
     */
     ...
     * Sets credit_account
     *
     * @param \Learnist\Tripletex\Model\Account|null $credit_account credit_account
     *
     * @return self
     */
