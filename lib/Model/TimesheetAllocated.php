...
/**
 * TimesheetAllocated Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class TimesheetAllocated implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TimesheetAllocated';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['manager_comment']) && (mb_strlen($this->container['manager_comment']) > 255)) {
            $invalidProperties[] = "invalid value for 'manager_comment', the character length must be smaller than or equal to 255.";
        }
     ...
     *
     * @param string|null $manager_comment manager_comment
     *
     * @return self
     */
    public function setManagerComment($manager_comment)
    {
        if (!is_null($manager_comment) && (mb_strlen($manager_comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $manager_comment when calling TimesheetAllocated., must be smaller than or equal to 255.');
        }


        if (is_null($manager_comment)) {
            throw new \InvalidArgumentException('non-nullable manager_comment cannot be null');
        }
