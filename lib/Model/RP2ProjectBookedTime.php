...
/**
 * RP2ProjectBookedTime Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class RP2ProjectBookedTime implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RP2ProjectBookedTime';
    ...
    */
    ...
    public function setPeriodId($period_id)
    {
        ...
        if (!is_null($period_id) && ($period_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $period_id when calling RP2ProjectBookedTime., must be bigger than or equal to 1.');
        }
