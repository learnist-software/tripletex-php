...
/**
 * ProjectPeriodInvoicingReserve Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class ProjectPeriodInvoicingReserve implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectPeriodInvoicingReserve';
    ...
    protected static $openAPITypes = [
        ...
        'period_order_lines_income_currency' => 'float',
    ...
    protected static $openAPIFormats = [
        ...
        'period_order_lines_income_currency' => null,
    ...
    protected static array $openAPINullables = [
		...
		'period_order_lines_income_currency' => false,
    ...
    protected static $attributeMap = [
        ...
        'period_order_lines_income_currency' => 'periodOrderLinesIncomeCurrency',
    ...
    protected static $setters = [
        ...
        'period_order_lines_income_currency' => 'setPeriodOrderLinesIncomeCurrency',
    ...
    protected static $getters = [
        ...
        'period_order_lines_income_currency' => 'getPeriodOrderLinesIncomeCurrency',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('period_order_lines_income_currency', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets period_order_lines_income_currency
     *
     * @return float|null
     */
    public function getPeriodOrderLinesIncomeCurrency()
    {
        return $this->container['period_order_lines_income_currency'];
    }

    /**
     * Sets period_order_lines_income_currency
     *
     * @param float|null $period_order_lines_income_currency period_order_lines_income_currency
     *
     * @return self
     */
    public function setPeriodOrderLinesIncomeCurrency($period_order_lines_income_currency)
    {

        if (is_null($period_order_lines_income_currency)) {
            throw new \InvalidArgumentException('non-nullable period_order_lines_income_currency cannot be null');
        }

        $this->container['period_order_lines_income_currency'] = $period_order_lines_income_currency;
