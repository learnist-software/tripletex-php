...
/**
 * RP2EmployeeBookedTime Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class RP2EmployeeBookedTime implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RP2EmployeeBookedTime';
    ...
    */
    ...
    public function setPeriodId($period_id)
    {
        ...
        if (!is_null($period_id) && ($period_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $period_id when calling RP2EmployeeBookedTime., must be bigger than or equal to 1.');
        }
