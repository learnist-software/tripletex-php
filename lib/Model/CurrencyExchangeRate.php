 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CurrencyExchangeRate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CurrencyExchangeRate';
...
'url' => 'string',
'target_currency' => '\Learnist\Tripletex\Model\Currency',
'source_currency' => '\Learnist\Tripletex\Model\Currency',
'rate' => 'float',
'source' => 'string',
'date' => 'string'    ];
...
'date' => 'getDate'    ];
    ...
    const SOURCE_NORGES_BANK = 'NORGES_BANK';
const SOURCE_HALLONEN = 'HALLONEN';
    ...
    {
        return [
            self::SOURCE_NORGES_BANK,
self::SOURCE_HALLONEN,        ];
    }
     ...
     *
     * @param \Learnist\Tripletex\Model\Currency $target_currency target_currency
     *
     * @return $this
     */
     ...
     *
     * @param \Learnist\Tripletex\Model\Currency $source_currency source_currency
     *
     * @return $this
     */
     ...
     * Sets source
     *
     * @param string $source Source of exchange rates, i.e Norges Bank
     *
     * @return $this
     */
