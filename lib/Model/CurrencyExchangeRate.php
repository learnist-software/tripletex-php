...
class CurrencyExchangeRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const SOURCE_HALLONEN = 'HALLONEN';
    ...
    */
    ...
    public function setRate($rate)
    {
        ...
        if (!is_null($rate) && ($rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $rate when calling CurrencyExchangeRate., must be bigger than or equal to 0.');
        }
     ...
     * Sets source
     *
     * @param string|null $source Source of exchange rates, i.e Norges Bank
     *
     * @return self
     */
