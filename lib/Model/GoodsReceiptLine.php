 ...
 */
class GoodsReceiptLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GoodsReceiptLine';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('quantity_rest', $data ?? [], null);
    ...
    */
     ...
     * Sets quantity_rest
     *
     * @param float|null $quantity_rest quantity_rest
     *
     * @return self
     */
    public function setQuantityRest($quantity_rest)
    {
        ...
        if (is_null($quantity_rest)) {
            throw new \InvalidArgumentException('non-nullable quantity_rest cannot be null');
        }
