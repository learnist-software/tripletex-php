...
/**
 * CommentCreation Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class CommentCreation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommentCreation';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['comment_text'] === null) {
            $invalidProperties[] = "'comment_text' can't be null";
        }
     ...
     * Sets comment_text
     *
     * @param string $comment_text The text of the comment to be created
     *
     * @return self
     */
