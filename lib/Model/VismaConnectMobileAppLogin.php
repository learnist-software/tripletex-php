...
/**
 * VismaConnectMobileAppLogin Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class VismaConnectMobileAppLogin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VismaConnectMobileAppLogin';
    ...
    */
     ...
     * Sets id_token
     *
     * @param string $id_token Id token from Visma Connect
     *
     * @return self
     */
     ...
     * Sets access_token
     *
     * @param string $access_token Access token from Visma Connect
     *
     * @return self
     */
     ...
     *
     * @param string $expiration_date Expiration date for the combined token
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param int|null $employee_id Optional employee ID. Default employee is used when null
     *
     * @return self
     */
