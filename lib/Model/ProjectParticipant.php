...
/**
 * ProjectParticipant Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class ProjectParticipant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectParticipant';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('admin_access', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets admin_access
     *
     * @param bool|null $admin_access admin_access
     *
     * @return self
     */
    public function setAdminAccess($admin_access)
    {
        if (is_null($admin_access)) {
            throw new \InvalidArgumentException('non-nullable admin_access cannot be null');
        }
