 ...
 */
class CompanyAutoCompleteDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CompanyAutoCompleteDTO';
    ...
    */
     ...
     * Sets company_type
     *
     * @param int|null $company_type company_type
     *
     * @return self
     */
