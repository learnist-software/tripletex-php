 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VoucherMessage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VoucherMessage';
...
'send_time' => 'getSendTime'    ];
     ...
     * Sets voucher_id
     *
     * @param int $voucher_id The voucher to connect the message to, only set on create
     *
     * @return $this
     */
     ...
     * Sets sender
     *
     * @param \Learnist\Tripletex\Model\Employee $sender sender
     *
     * @return $this
     */
     ...
     * Sets send_time
     *
     * @param string $send_time The timestamp of the message
     *
     * @return $this
     */
