 ...
 */
class AprilaCashCreditApplicationResponseDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AprilaCashCreditApplicationResponseDTO';
    ...
    protected static $openAPITypes = [
        'sign_up_url' => 'string',
        'max_credit_limit_amount' => 'object',
    ...
    protected static array $openAPINullables = [
        'sign_up_url' => false,
		'max_credit_limit_amount' => false,
		'max_credit_limit_currency' => false,
		'annual_interest_rate' => false,
		'monthly_interest_rate' => false,
		'monthly_fee_amount' => false,
		'monthly_fee_currency' => false
    ];
    ...
    {
        $this->setIfExists('sign_up_url', $data ?? [], null);
        $this->setIfExists('max_credit_limit_amount', $data ?? [], null);
        $this->setIfExists('max_credit_limit_currency', $data ?? [], null);
        $this->setIfExists('annual_interest_rate', $data ?? [], null);
        $this->setIfExists('monthly_interest_rate', $data ?? [], null);
        $this->setIfExists('monthly_fee_amount', $data ?? [], null);
        $this->setIfExists('monthly_fee_currency', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets sign_up_url
     *
     * @param string|null $sign_up_url sign_up_url
     *
     * @return self
     */
    public function setSignUpUrl($sign_up_url)
    {
        ...
        if (is_null($sign_up_url)) {
            throw new \InvalidArgumentException('non-nullable sign_up_url cannot be null');
        }
     ...
     *
     * @param object|null $max_credit_limit_amount max_credit_limit_amount
     *
     * @return self
     */
    public function setMaxCreditLimitAmount($max_credit_limit_amount)
    {
        ...
        if (is_null($max_credit_limit_amount)) {
            throw new \InvalidArgumentException('non-nullable max_credit_limit_amount cannot be null');
        }
     ...
     *
     * @param string|null $max_credit_limit_currency max_credit_limit_currency
     *
     * @return self
     */
    public function setMaxCreditLimitCurrency($max_credit_limit_currency)
    {
        ...
        if (is_null($max_credit_limit_currency)) {
            throw new \InvalidArgumentException('non-nullable max_credit_limit_currency cannot be null');
        }
     ...
     *
     * @param object|null $annual_interest_rate annual_interest_rate
     *
     * @return self
     */
     ...
     *
     * @param object|null $monthly_interest_rate monthly_interest_rate
     *
     * @return self
     */
    public function setMonthlyInterestRate($monthly_interest_rate)
    {
        ...
        if (is_null($monthly_interest_rate)) {
            throw new \InvalidArgumentException('non-nullable monthly_interest_rate cannot be null');
        }
     ...
     *
     * @param object|null $monthly_fee_amount monthly_fee_amount
     *
     * @return self
     */
    public function setMonthlyFeeAmount($monthly_fee_amount)
    {
        ...
        if (is_null($monthly_fee_amount)) {
            throw new \InvalidArgumentException('non-nullable monthly_fee_amount cannot be null');
        }
     ...
     *
     * @param string|null $monthly_fee_currency monthly_fee_currency
     *
     * @return self
     */
    public function setMonthlyFeeCurrency($monthly_fee_currency)
    {
        ...
        if (is_null($monthly_fee_currency)) {
            throw new \InvalidArgumentException('non-nullable monthly_fee_currency cannot be null');
        }
