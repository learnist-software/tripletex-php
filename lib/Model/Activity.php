...
class Activity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'is_project_activity' => 'setIsProjectActivity',
    ...
    protected static $getters = [
        ...
        'is_project_activity' => 'getIsProjectActivity',
    ...
    public const ACTIVITY_TYPE_GENERAL_ACTIVITY = 'GENERAL_ACTIVITY';
    public const ACTIVITY_TYPE_PROJECT_GENERAL_ACTIVITY = 'PROJECT_GENERAL_ACTIVITY';
    public const ACTIVITY_TYPE_PROJECT_SPECIFIC_ACTIVITY = 'PROJECT_SPECIFIC_ACTIVITY';
    ...
    {
        return [
            self::ACTIVITY_TYPE_GENERAL_ACTIVITY,
            self::ACTIVITY_TYPE_PROJECT_GENERAL_ACTIVITY,
            self::ACTIVITY_TYPE_PROJECT_SPECIFIC_ACTIVITY,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_project_activity', $data ?? [], null);
        $this->setIfExists('is_general', $data ?? [], null);
        $this->setIfExists('is_task', $data ?? [], null);
        $this->setIfExists('is_disabled', $data ?? [], null);
        $this->setIfExists('is_chargeable', $data ?? [], null);
        $this->setIfExists('rate', $data ?? [], null);
        $this->setIfExists('cost_percentage', $data ?? [], null);
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Activity., must be smaller than or equal to 255.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $number when calling Activity., must be smaller than or equal to 100.');
        }
     ...
     * Sets activity_type
     *
     * @param string|null $activity_type PROJECT_SPECIFIC_ACTIVITY are made via project/projectactivity, as they must be part of a project.
     *
     * @return self
     */
    ...
    /**
     * Gets is_project_activity
     *
     * @return bool|null
     */
    public function getIsProjectActivity()
    {
        return $this->container['is_project_activity'];
    }

    /**
     * Sets is_project_activity
     *
     * @param bool|null $is_project_activity Manipulate these with ActivityType
     *
     * @return self
     */
    public function setIsProjectActivity($is_project_activity)
    {
        if (is_null($is_project_activity)) {
            throw new \InvalidArgumentException('non-nullable is_project_activity cannot be null');
        }
        $this->container['is_project_activity'] = $is_project_activity;
     ...
     * Sets is_general
     *
     * @param bool|null $is_general Manipulate these with ActivityType
     *
     * @return self
     */
    ...
    {
        return $this->container['is_task'];
    }

    /**
     * Sets is_task
     *
     * @param bool|null $is_task Manipulate these with ActivityType
     *
     * @return self
     */
    public function setIsTask($is_task)
    {
        if (is_null($is_task)) {
            throw new \InvalidArgumentException('non-nullable is_task cannot be null');
        }
        $this->container['is_task'] = $is_task;
     ...
     *
     * @param float|null $cost_percentage cost_percentage
     *
     * @return self
     */
    public function setCostPercentage($cost_percentage)
    {
        if (is_null($cost_percentage)) {
            throw new \InvalidArgumentException('non-nullable cost_percentage cannot be null');
        }
