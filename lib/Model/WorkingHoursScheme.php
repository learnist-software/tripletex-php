...
/**
 * WorkingHoursScheme Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class WorkingHoursScheme implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorkingHoursScheme';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['working_hours_scheme'] === null) {
            $invalidProperties[] = "'working_hours_scheme' can't be null";
        }
     ...
     *
     * @param string $working_hours_scheme Defines the working hours scheme option.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getWorkingHoursSchemeAllowableValues();
        if (!in_array($working_hours_scheme, $allowedValues, true)) {
    ...
    public function setNameNo($name_no)
    {
        if (!is_null($name_no) && (mb_strlen($name_no) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name_no when calling WorkingHoursScheme., must be smaller than or equal to 100.');
        }
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 100)) {
            throw new \InvalidArgumentException('invalid length for $code when calling WorkingHoursScheme., must be smaller than or equal to 100.');
        }
