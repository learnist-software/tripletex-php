...
/**
 * BankAgreementCreationDTO Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class BankAgreementCreationDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankAgreementCreationDTO';
    ...
    protected static $openAPITypes = [
        ...
        'electronic_creation' => 'bool',
        'approve_in_online_banking' => 'bool',
        'bank_accounts' => '\Learnist\Tripletex\Model\Account[]'
    ];
    ...
    protected static $setters = [
        ...
        'electronic_creation' => 'setElectronicCreation',
    ...
    protected static $getters = [
        ...
        'electronic_creation' => 'getElectronicCreation',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('electronic_creation', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $account_in_bank_id Customer number in bank
     *
     * @return self
     */
     ...
     *
     * @param string|null $ccm_agreement_id Customer Id from Bank
     *
     * @return self
     */
     ...
     * Sets division
     *
     * @param string|null $division Division (DNB only)
     *
     * @return self
     */
     ...
     *
     * @param string|null $organization_number Organization number
     *
     * @return self
     */
    ...
    /**
     * Gets electronic_creation
     *
     * @return bool|null
     */
    public function getElectronicCreation()
    {
        return $this->container['electronic_creation'];
    }

    /**
     * Sets electronic_creation
     *
     * @param bool|null $electronic_creation Electronic agreement creation initiated.
     *
     * @return self
     */
    public function setElectronicCreation($electronic_creation)
    {

        if (is_null($electronic_creation)) {
            throw new \InvalidArgumentException('non-nullable electronic_creation cannot be null');
        }

        $this->container['electronic_creation'] = $electronic_creation;
     ...
     *
     * @param bool|null $approve_in_online_banking Accounting approve payments
     *
     * @return self
     */
     ...
     * Sets bank_accounts
     *
     * @param \Learnist\Tripletex\Model\Account[] $bank_accounts JSON representing a list of new objects to be created. Should not have ID and version set.
     *
     * @return self
     */
