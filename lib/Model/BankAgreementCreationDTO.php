 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankAgreementCreationDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BankAgreementCreationDTO';
...
'bank_accounts' => 'getBankAccounts'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['electronic_creation'] = isset($data['electronic_creation']) ? $data['electronic_creation'] : null;
     ...
     *
     * @param string $account_in_bank_id Customer number in bank
     *
     * @return $this
     */
     ...
     *
     * @param string $ccm_agreement_id Customer Id from Bank
     *
     * @return $this
     */
     ...
     * Sets division
     *
     * @param string $division Division (DNB only)
     *
     * @return $this
     */
     ...
     *
     * @param string $organization_number Organization number
     *
     * @return $this
     */
     ...
     *
     * @param bool $electronic_creation Electronic agreement creation initiated.
     *
     * @return $this
     */
     ...
     *
     * @param bool $approve_in_online_banking Accounting approve payments
     *
     * @return $this
     */
