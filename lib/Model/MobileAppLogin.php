...
/**
 * MobileAppLogin Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class MobileAppLogin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MobileAppLogin';
    ...
    */
     ...
     * Sets mfa_code
     *
     * @param int|null $mfa_code Optional mfa auth code
     *
     * @return self
     */
