...
class Order implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        if (!is_null($receiver_email) && (mb_strlen($receiver_email) > 254)) {
    ...
    public function setSubscriptionDuration($subscription_duration)
    {
        ...
        if (!is_null($subscription_duration) && ($subscription_duration < 0)) {
    ...
    public function setSubscriptionPeriodsOnInvoice($subscription_periods_on_invoice)
    {
        ...
        if (!is_null($subscription_periods_on_invoice) && ($subscription_periods_on_invoice < 0)) {
    ...
    public function setSubscriptionInvoicingTime($subscription_invoicing_time)
    {
        ...
        if (!is_null($subscription_invoicing_time) && ($subscription_invoicing_time < 0)) {
    ...
    {
        if (!is_null($invoice_sms_notification_number) && (mb_strlen($invoice_sms_notification_number) > 100)) {
