...
class TimesheetEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'time_clocks' => '\Learnist\Tripletex\Model\TimeClock[]',
        'comment' => 'string',
        'locked' => 'bool',
        'chargeable' => 'bool',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('time_clocks', $data ?? [], null);
    ...
    */
     ...
     * Sets time_clocks
     *
     * @param \Learnist\Tripletex\Model\TimeClock[]|null $time_clocks Link to stop watches on this hour.
     *
     * @return self
     */
    public function setTimeClocks($time_clocks)
    {
        ...
        if (is_null($time_clocks)) {
            throw new \InvalidArgumentException('non-nullable time_clocks cannot be null');
        }
     ...
     * Sets locked
     *
     * @param bool|null $locked Indicates if the hour can be changed.
     *
     * @return self
     */
