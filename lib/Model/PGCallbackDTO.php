...
/**
 * PGCallbackDTO Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class PGCallbackDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PGCallbackDTO';
    ...
    protected static array $openAPINullables = [
        'odpcustomer_id' => false,
		'odpcompany_id' => false,
		'pg_request_id' => false,
		'tenant_id' => false,
		'odp_customer_id' => false,
		'odp_company_id' => false,
		'auto_pay_key' => false,
		'auto_pay_key_last_generated_date' => false,
		'status' => false,
		'error_message' => false
    ];
    ...
    {
        $this->setIfExists('odpcustomer_id', $data ?? [], null);
        $this->setIfExists('odpcompany_id', $data ?? [], null);
        $this->setIfExists('pg_request_id', $data ?? [], null);
        $this->setIfExists('tenant_id', $data ?? [], null);
        $this->setIfExists('odp_customer_id', $data ?? [], null);
        $this->setIfExists('odp_company_id', $data ?? [], null);
        $this->setIfExists('auto_pay_key', $data ?? [], null);
        $this->setIfExists('auto_pay_key_last_generated_date', $data ?? [], null);
    ...
    */
     ...
     * Sets odpcustomer_id
     *
     * @param int|null $odpcustomer_id odpcustomer_id
     *
     * @return self
     */
    public function setOdpcustomerId($odpcustomer_id)
    {
        ...
        if (is_null($odpcustomer_id)) {
            throw new \InvalidArgumentException('non-nullable odpcustomer_id cannot be null');
        }
     ...
     * Sets odpcompany_id
     *
     * @param int|null $odpcompany_id odpcompany_id
     *
     * @return self
     */
    public function setOdpcompanyId($odpcompany_id)
    {
        ...
        if (is_null($odpcompany_id)) {
            throw new \InvalidArgumentException('non-nullable odpcompany_id cannot be null');
        }
    ...
    public function setPgRequestId($pg_request_id)
    {
        ...
        if (is_null($pg_request_id)) {
            throw new \InvalidArgumentException('non-nullable pg_request_id cannot be null');
        }
    ...
    public function setOdpCustomerId($odp_customer_id)
    {
        ...
        if (is_null($odp_customer_id)) {
            throw new \InvalidArgumentException('non-nullable odp_customer_id cannot be null');
        }
    ...
    public function setOdpCompanyId($odp_company_id)
    {
        ...
        if (is_null($odp_company_id)) {
            throw new \InvalidArgumentException('non-nullable odp_company_id cannot be null');
        }
    ...
    public function setAutoPayKey($auto_pay_key)
    {
        ...
        if (is_null($auto_pay_key)) {
            throw new \InvalidArgumentException('non-nullable auto_pay_key cannot be null');
        }
    ...
    public function setAutoPayKeyLastGeneratedDate($auto_pay_key_last_generated_date)
    {
        ...
        if (is_null($auto_pay_key_last_generated_date)) {
            throw new \InvalidArgumentException('non-nullable auto_pay_key_last_generated_date cannot be null');
        }
