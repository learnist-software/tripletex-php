...
class Payslip implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'url' => 'string',
        'transaction' => '\Learnist\Tripletex\Model\SalaryTransaction',
        'employee' => '\Learnist\Tripletex\Model\Employee',
        'date' => 'string',
        'year' => 'int',
        'month' => 'int',
        'specifications' => '\Learnist\Tripletex\Model\SalarySpecification[]',
    ...
    */
     ...
     * Sets transaction
     *
     * @param \Learnist\Tripletex\Model\SalaryTransaction|null $transaction transaction
     *
     * @return self
     */
     ...
     * Sets specifications
     *
     * @param \Learnist\Tripletex\Model\SalarySpecification[]|null $specifications Link to salary specifications.
     *
     * @return self
     */
    ...
    public function setNumber($number)
    {
        ...
        if (!is_null($number) && ($number < 0)) {
            throw new \InvalidArgumentException('invalid value for $number when calling Payslip., must be bigger than or equal to 0.');
        }
