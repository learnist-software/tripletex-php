...
class Payslip implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Payslip';
...
'number' => 'getNumber'    ];
     ...
     * Sets transaction
     *
     * @param \Learnist\Tripletex\Model\SalaryTransaction $transaction transaction
     *
     * @return $this
     */
     ...
     * Sets specifications
     *
     * @param \Learnist\Tripletex\Model\SalarySpecification[] $specifications Link to salary specifications.
     *
     * @return $this
     */
