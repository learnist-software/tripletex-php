...
/**
 * ResourcePlanBudget Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class ResourcePlanBudget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResourcePlanBudget';
    ...
    protected static $openAPITypes = [
        ...
        'period_end' => 'string',
        'period_type' => 'string',
        'activity_entries' => '\Learnist\Tripletex\Model\ResourcePlanActivity[]'
    ];
    ...
    protected static $setters = [
        ...
        'activity_entries' => 'setActivityEntries'
    ];
    ...
    protected static $getters = [
        ...
        'activity_entries' => 'getActivityEntries'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity_entries', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets activity_entries
     *
     * @return \Learnist\Tripletex\Model\ResourcePlanActivity[]|null
     */
    public function getActivityEntries()
    {
        return $this->container['activity_entries'];
    }

    /**
     * Sets activity_entries
     *
     * @param \Learnist\Tripletex\Model\ResourcePlanActivity[]|null $activity_entries List of ActivityResourcePlanDTO
     *
     * @return self
     */
    public function setActivityEntries($activity_entries)
    {
        if (is_null($activity_entries)) {
            throw new \InvalidArgumentException('non-nullable activity_entries cannot be null');
        }
        $this->container['activity_entries'] = $activity_entries;
