...
/**
 * ResponseWrapperAddonStatusType Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class ResponseWrapperAddonStatusType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseWrapperAddonStatusType';
    ...
    public const VALUE_IN_DEVELOPMENT = 'IN_DEVELOPMENT';
    public const VALUE_PENDING = 'PENDING';
    public const VALUE_REJECTED = 'REJECTED';
    public const VALUE_APPROVED = 'APPROVED';
