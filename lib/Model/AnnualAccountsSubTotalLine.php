...
/**
 * AnnualAccountsSubTotalLine Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class AnnualAccountsSubTotalLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AnnualAccountsSubTotalLine';
    ...
    {
        $this->setIfExists('orid', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['orid'];
    }

    /**
     * Sets orid
     *
     * @param string|null $orid orid
     *
     * @return self
     */
    public function setOrid($orid)
    {

        if (is_null($orid)) {
            throw new \InvalidArgumentException('non-nullable orid cannot be null');
        }

        $this->container['orid'] = $orid;
