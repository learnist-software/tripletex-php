 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AnnualAccountsSubTotalLine implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AnnualAccountsSubTotalLine';
...
'notes' => 'getNotes'    ];
    ...
    {
        $this->container['orid'] = isset($data['orid']) ? $data['orid'] : null;
