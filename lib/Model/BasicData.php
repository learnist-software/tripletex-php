 ...
 */
class BasicData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BasicData';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['business_activity_description']) && (mb_strlen($this->container['business_activity_description']) > 255)) {
            $invalidProperties[] = "invalid value for 'business_activity_description', the character length must be smaller than or equal to 255.";
        }
    ...
    public function setNationalIdentityNumber($national_identity_number)
    {
        ...
        if ((mb_strlen($national_identity_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $national_identity_number when calling BasicData., must be smaller than or equal to 100.');
        }
    ...
    public function setBusinessActivityDescription($business_activity_description)
    {
        ...
        if ((mb_strlen($business_activity_description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $business_activity_description when calling BasicData., must be smaller than or equal to 255.');
        }
