 ...
 */
class MonthlyStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MonthlyStatus';
    ...
    protected static $openAPITypes = [
        ...
        'timesheet_entries' => '\Learnist\Tripletex\Model\TimesheetEntry[]',
        ...
        'hour_summary' => '\Learnist\Tripletex\Model\HourSummary',
        'flex_summary' => '\Learnist\Tripletex\Model\FlexSummary',
        'vacation_summary' => '\Learnist\Tripletex\Model\VacationSummary'
    ];
    ...
    protected static array $openAPINullables = [
		...
		'approved_by' => false,
		'approved' => false,
		'approved_until_date' => false,
		'month_year' => false,
		'hours_payout' => false,
		'vacation_payout' => false,
		'hour_summary' => false,
		'flex_summary' => false,
		'vacation_summary' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('timesheet_entries', $data ?? [], null);
        ...
        $this->setIfExists('approved_until_date', $data ?? [], null);
        $this->setIfExists('month_year', $data ?? [], null);
        $this->setIfExists('hours_payout', $data ?? [], null);
        $this->setIfExists('vacation_payout', $data ?? [], null);
        $this->setIfExists('hour_summary', $data ?? [], null);
        $this->setIfExists('flex_summary', $data ?? [], null);
        $this->setIfExists('vacation_summary', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \Learnist\Tripletex\Model\TimesheetEntry[]|null
     */
     ...
     *
     * @param \Learnist\Tripletex\Model\TimesheetEntry[]|null $timesheet_entries timesheet_entries
     *
     * @return self
     */
    public function setTimesheetEntries($timesheet_entries)
    {
        if (is_null($timesheet_entries)) {
            throw new \InvalidArgumentException('non-nullable timesheet_entries cannot be null');
        }
     ...
     *
     * @param string|null $approved_until_date approved_until_date
     *
     * @return self
     */
    public function setApprovedUntilDate($approved_until_date)
    {
        if (is_null($approved_until_date)) {
            throw new \InvalidArgumentException('non-nullable approved_until_date cannot be null');
        }
     ...
     * Sets month_year
     *
     * @param string|null $month_year month_year
     *
     * @return self
     */
    public function setMonthYear($month_year)
    {
        if (is_null($month_year)) {
            throw new \InvalidArgumentException('non-nullable month_year cannot be null');
        }
     ...
     * Sets hours_payout
     *
     * @param float|null $hours_payout hours_payout
     *
     * @return self
     */
    public function setHoursPayout($hours_payout)
    {
        if (is_null($hours_payout)) {
            throw new \InvalidArgumentException('non-nullable hours_payout cannot be null');
        }
     ...
     *
     * @param float|null $vacation_payout vacation_payout
     *
     * @return self
     */
    public function setVacationPayout($vacation_payout)
    {
        if (is_null($vacation_payout)) {
            throw new \InvalidArgumentException('non-nullable vacation_payout cannot be null');
        }
     ...
     * Gets hour_summary
     *
     * @return \Learnist\Tripletex\Model\HourSummary|null
     */
     ...
     * Sets hour_summary
     *
     * @param \Learnist\Tripletex\Model\HourSummary|null $hour_summary hour_summary
     *
     * @return self
     */
     ...
     * Gets flex_summary
     *
     * @return \Learnist\Tripletex\Model\FlexSummary|null
     */
     ...
     * Sets flex_summary
     *
     * @param \Learnist\Tripletex\Model\FlexSummary|null $flex_summary flex_summary
     *
     * @return self
     */
    public function setFlexSummary($flex_summary)
    {
        if (is_null($flex_summary)) {
            throw new \InvalidArgumentException('non-nullable flex_summary cannot be null');
        }
     ...
     *
     * @return \Learnist\Tripletex\Model\VacationSummary|null
     */
     ...
     *
     * @param \Learnist\Tripletex\Model\VacationSummary|null $vacation_summary vacation_summary
     *
     * @return self
     */
    public function setVacationSummary($vacation_summary)
    {
        if (is_null($vacation_summary)) {
            throw new \InvalidArgumentException('non-nullable vacation_summary cannot be null');
        }
