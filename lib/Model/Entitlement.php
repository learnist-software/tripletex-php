 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Entitlement implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Entitlement';
...
'customer' => 'getCustomer'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['entitlement_id'] = isset($data['entitlement_id']) ? $data['entitlement_id'] : null;
     ...
     * Sets name
     *
     * @param string $name Descriptive name for the privilege. Might change between releases.
     *
     * @return $this
     */
     ...
     * Sets entitlement_id
     *
     * @param int $entitlement_id Unique id for the type of privilege.
     *
     * @return $this
     */
