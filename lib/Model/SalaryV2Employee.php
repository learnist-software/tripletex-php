...
/**
 * SalaryV2Employee Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class SalaryV2Employee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalaryV2Employee';
    ...
    protected static $setters = [
        ...
        'name_and_number' => 'setNameAndNumber'
    ];
    ...
    protected static $getters = [
        ...
        'name_and_number' => 'getNameAndNumber'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('name_and_number', $data ?? [], null);
    }
    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling SalaryV2Employee., must be smaller than or equal to 100.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling SalaryV2Employee., must be smaller than or equal to 100.');
        }
    ...
    public function setEmployeeNumber($employee_number)
    {
        ...
        if ((mb_strlen($employee_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $employee_number when calling SalaryV2Employee., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($employee_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $employee_number when calling SalaryV2Employee., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets name_and_number
     *
     * @return string|null
     */
    public function getNameAndNumber()
    {
        return $this->container['name_and_number'];
    }

    /**
     * Sets name_and_number
     *
     * @param string|null $name_and_number name_and_number
     *
     * @return self
     */
    public function setNameAndNumber($name_and_number)
    {
        if (is_null($name_and_number)) {
            throw new \InvalidArgumentException('non-nullable name_and_number cannot be null');
        }
        $this->container['name_and_number'] = $name_and_number;
