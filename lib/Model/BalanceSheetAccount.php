 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BalanceSheetAccount implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BalanceSheetAccount';
...
'end_date' => 'getEndDate'    ];
     ...
     * Sets start_date
     *
     * @param string $start_date The start date for this period - inclusive.
     *
     * @return $this
     */
     ...
     * Sets end_date
     *
     * @param string $end_date The end date for this period - exclusive.
     *
     * @return $this
     */
