...
class LedgerAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'sum_amount' => false,
		'currency' => false,
		'sum_amount_currency' => false,
		'opening_balance' => false,
		'opening_balance_currency' => false,
		'closing_balance' => false,
		'closing_balance_currency' => false,
		'postings' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sum_amount_currency', $data ?? [], null);
        $this->setIfExists('opening_balance', $data ?? [], null);
        $this->setIfExists('opening_balance_currency', $data ?? [], null);
        $this->setIfExists('closing_balance', $data ?? [], null);
        $this->setIfExists('closing_balance_currency', $data ?? [], null);
    ...
    */
     ...
     *
     * @param float|null $sum_amount_currency sum_amount_currency
     *
     * @return self
     */
    public function setSumAmountCurrency($sum_amount_currency)
    {
        ...
        if (is_null($sum_amount_currency)) {
            throw new \InvalidArgumentException('non-nullable sum_amount_currency cannot be null');
        }
     ...
     *
     * @param float|null $opening_balance_currency opening_balance_currency
     *
     * @return self
     */
    public function setOpeningBalanceCurrency($opening_balance_currency)
    {
        ...
        if (is_null($opening_balance_currency)) {
            throw new \InvalidArgumentException('non-nullable opening_balance_currency cannot be null');
        }
     ...
     *
     * @param float|null $closing_balance_currency closing_balance_currency
     *
     * @return self
     */
    public function setClosingBalanceCurrency($closing_balance_currency)
    {
        ...
        if (is_null($closing_balance_currency)) {
            throw new \InvalidArgumentException('non-nullable closing_balance_currency cannot be null');
        }
     ...
     * Sets postings
     *
     * @param \Learnist\Tripletex\Model\Posting[]|null $postings Link to postings on this account.
     *
     * @return self
     */
