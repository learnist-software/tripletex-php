 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VatReturnsComment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VatReturnsComment';
...
'delivered_sign' => 'getDeliveredSign'    ];
    ...
    const VAT_SPECIFICATION_TYPE__DEFAULT = 'DEFAULT';
const VAT_SPECIFICATION_TYPE_LOSS_OF_CLAIM = 'LOSS_OF_CLAIM';
const VAT_SPECIFICATION_TYPE_WITHDRAWAL = 'WITHDRAWAL';
const VAT_SPECIFICATION_TYPE_ADJUSTMENT = 'ADJUSTMENT';
const VAT_SPECIFICATION_TYPE_REVERSAL = 'REVERSAL';
const VAT_SPECIFICATION_TYPE_COMPENSATION = 'COMPENSATION';
const EXPECTED_SIGN_ZERO = 'ZERO';
const EXPECTED_SIGN_POSITIVE = 'POSITIVE';
const EXPECTED_SIGN_NEGATIVE = 'NEGATIVE';
const DELIVERED_SIGN_ZERO = 'ZERO';
const DELIVERED_SIGN_POSITIVE = 'POSITIVE';
const DELIVERED_SIGN_NEGATIVE = 'NEGATIVE';
...
self::DELIVERED_SIGN_NEGATIVE,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['vat_specification_type'] = isset($data['vat_specification_type']) ? $data['vat_specification_type'] : null;
        $this->container['expected_sign'] = isset($data['expected_sign']) ? $data['expected_sign'] : null;
        $this->container['delivered_sign'] = isset($data['delivered_sign']) ? $data['delivered_sign'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['vat_specification_type']) && !in_array($this->container['vat_specification_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'vat_specification_type', must be one of '%s'",
        ...
        if (!is_null($this->container['delivered_sign']) && !in_array($this->container['delivered_sign'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'delivered_sign', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets technical_name
     *
     * @param string $technical_name Technical name of the comment
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Detailed description of the comment
     *
     * @return $this
     */
     ...
     *
     * @param string $vat_specification_type Detailed description of the comment
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getVatSpecificationTypeAllowableValues();
        if (!is_null($vat_specification_type) && !in_array($vat_specification_type, $allowedValues, true)) {
     ...
     * Sets expected_sign
     *
     * @param string $expected_sign The sign expected on the structured comment
     *
     * @return $this
     */
     ...
     * Sets delivered_sign
     *
     * @param string $delivered_sign The sign delivered on the structured comment
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getDeliveredSignAllowableValues();
        if (!is_null($delivered_sign) && !in_array($delivered_sign, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'delivered_sign', must be one of '%s'",
                    implode("', '", $allowedValues)
