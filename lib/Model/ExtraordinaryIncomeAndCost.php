...
/**
 * ExtraordinaryIncomeAndCost Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class ExtraordinaryIncomeAndCost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtraordinaryIncomeAndCost';
    ...
    */
     ...
     * Sets description
     *
     * @param float|null $description description
     *
     * @return self
     */
