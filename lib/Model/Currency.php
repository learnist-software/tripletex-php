...
class Currency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['factor']) && ($this->container['factor'] > 100)) {
            $invalidProperties[] = "invalid value for 'factor', must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['factor']) && ($this->container['factor'] < 1)) {
            $invalidProperties[] = "invalid value for 'factor', must be bigger than or equal to 1.";
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 100)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Currency., must be smaller than or equal to 100.');
        }
    ...
    public function setFactor($factor)
    {
        ...
        if (!is_null($factor) && ($factor > 100)) {
            throw new \InvalidArgumentException('invalid value for $factor when calling Currency., must be smaller than or equal to 100.');
        }
        if (!is_null($factor) && ($factor < 1)) {
            throw new \InvalidArgumentException('invalid value for $factor when calling Currency., must be bigger than or equal to 1.');
        }


        if (is_null($factor)) {
            throw new \InvalidArgumentException('non-nullable factor cannot be null');
        }
