...
'outstanding_amount' => 'getOutstandingAmount'    ];
     ...
     * Sets order_lines
     *
     * @param \Learnist\Tripletex\Model\OrderLine[] $order_lines order_lines
     *
     * @return $this
     */
     ...
     * Sets payments
     *
     * @param \Learnist\Tripletex\Model\Posting[] $payments payments
     *
     * @return $this
     */
     ...
     *
     * @param \Learnist\Tripletex\Model\VoucherApprovalListElement[] $approval_list_elements approval_list_elements
     *
     * @return $this
     */
     ...
     *
     * @param float $outstanding_amount The amount outstanding on the invoice, in the invoice currency.
     *
     * @return $this
     */
