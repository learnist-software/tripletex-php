...
class ApiError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'validation_messages' => '\Learnist\Tripletex\Model\ApiValidationMessage[]',
        'request_id' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('developer_message', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $developer_message developer_message
     *
     * @return self
     */
    public function setDeveloperMessage($developer_message)
    {
        if (is_null($developer_message)) {
            throw new \InvalidArgumentException('non-nullable developer_message cannot be null');
        }
     ...
     *
     * @param \Learnist\Tripletex\Model\ApiValidationMessage[]|null $validation_messages validation_messages
     *
     * @return self
     */
