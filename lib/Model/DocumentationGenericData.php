...
/**
 * DocumentationGenericData Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentationGenericData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DocumentationGenericData';
...
const GENERIC_DATA_SUB_TYPE_NONE = 'NONE';
const GENERIC_DATA_SUB_TYPE_NOT_LICENSED = 'NOT_LICENSED';
const GENERIC_DATA_SUB_TYPE_FREIGHT_TRANSPORT = 'FREIGHT_TRANSPORT';
const GENERIC_DATA_SUB_TYPE_TAXI = 'TAXI';
const GENERIC_DATA_SUB_TYPE_PRODUCT_TYPE_INVENTORY = 'PRODUCT_TYPE_INVENTORY';
const GENERIC_DATA_SUB_TYPE_CASH_REGISTER_SYSTEM = 'CASH_REGISTER_SYSTEM';
const GENERIC_DATA_SUB_TYPE_PRIVATE_WITHDRAWAL_OF_GOODS = 'PRIVATE_WITHDRAWAL_OF_GOODS';
const GENERIC_DATA_SUB_TYPE_ENTERTAINMENT = 'ENTERTAINMENT';
...
self::POST_TYPE_YEARLY_DIVIDEND,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['generic_data_sub_type'] = isset($data['generic_data_sub_type']) ? $data['generic_data_sub_type'] : null;
        ...
        $this->container['uploader_name'] = isset($data['uploader_name']) ? $data['uploader_name'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['generic_data_sub_type']) && !in_array($this->container['generic_data_sub_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'generic_data_sub_type', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param string $generic_data_sub_type generic_data_sub_type
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getGenericDataSubTypeAllowableValues();
        if (!is_null($generic_data_sub_type) && !in_array($generic_data_sub_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'generic_data_sub_type', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @param int $generic_data_sub_type_group_id generic_data_sub_type_group_id
     *
     * @return $this
     */
    ...
    {
        return $this->container['uploader_name'];
    }

    /**
     * Sets uploader_name
     *
     * @param string $uploader_name uploader_name
     *
     * @return $this
     */
    public function setUploaderName($uploader_name)
    {
        $this->container['uploader_name'] = $uploader_name;
