 ...
 */
class DocumentationGenericData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentationGenericData';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('uploader_name', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets uploader_name
     *
     * @param string|null $uploader_name uploader_name
     *
     * @return self
     */
    public function setUploaderName($uploader_name)
    {
        ...
        if (is_null($uploader_name)) {
            throw new \InvalidArgumentException('non-nullable uploader_name cannot be null');
        }
