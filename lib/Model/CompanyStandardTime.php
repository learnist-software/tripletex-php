...
/**
 * CompanyStandardTime Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class CompanyStandardTime implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CompanyStandardTime';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hours_per_day'] === null) {
            $invalidProperties[] = "'hours_per_day' can't be null";
        }
     ...
     * Sets hours_per_day
     *
     * @param float $hours_per_day hours_per_day
     *
     * @return self
     */
