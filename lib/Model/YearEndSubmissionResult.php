 ...
 */
class YearEndSubmissionResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'YearEndSubmissionResult';
    ...
    protected static $openAPITypes = [
        ...
        'validation_result' => '\Learnist\Tripletex\Model\YearEndValidationResult'
    ];
    ...
    public const FAILURE_STEP_DOWNLOADING_COMPLEMENTARY_DATA = 'DOWNLOADING_COMPLEMENTARY_DATA';
    public const FAILURE_STEP_PREVALIDATING = 'PREVALIDATING';
    public const FAILURE_STEP_EXCHANGING_ACCESS_TOKEN = 'EXCHANGING_ACCESS_TOKEN';
    public const FAILURE_STEP_CREATING_ALTINN_INSTANCE = 'CREATING_ALTINN_INSTANCE';
    public const FAILURE_STEP_UPLOADING_MAIN_CONTENT_TO_ALTINN_INSTANCE = 'UPLOADING_MAIN_CONTENT_TO_ALTINN_INSTANCE';
    public const FAILURE_STEP_CLOSING_ALTINN_INSTANCE = 'CLOSING_ALTINN_INSTANCE';
    public const FAILURE_STEP_APPROVING_ALTINN_INSTANCE_FOR_TRANSFER = 'APPROVING_ALTINN_INSTANCE_FOR_TRANSFER';
    public const FAILURE_STEP_NONE = 'NONE';
    public const FAILURE_CATEGORY_UNKNOWN = 'UNKNOWN';
    public const FAILURE_CATEGORY_INTERNAL_VALIDATION_FAILED = 'INTERNAL_VALIDATION_FAILED';
    public const FAILURE_CATEGORY_EXTERNAL_SERVICE_UNREACHABLE = 'EXTERNAL_SERVICE_UNREACHABLE';
    public const FAILURE_CATEGORY_EXTERNAL_SERVICE_API_ERROR = 'EXTERNAL_SERVICE_API_ERROR';
    public const FAILURE_CATEGORY_UNEXPECTED_RESPONSE_CONTENT = 'UNEXPECTED_RESPONSE_CONTENT';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('failure_category', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['failure_category']) && !in_array($this->container['failure_category'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'failure_category', must be one of '%s'",
                $this->container['failure_category'],
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param string|null $failure_category failure_category
     *
     * @return self
     */
    public function setFailureCategory($failure_category)
    {
        if (is_null($failure_category)) {
            throw new \InvalidArgumentException('non-nullable failure_category cannot be null');
        }
        $allowedValues = $this->getFailureCategoryAllowableValues();
        if (!in_array($failure_category, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'failure_category', must be one of '%s'",
                    $failure_category,
    ...
    public function setFailureMessage($failure_message)
    {
        ...
        if ((mb_strlen($failure_message) > 255)) {
     ...
     *
     * @return \Learnist\Tripletex\Model\YearEndValidationResult|null
     */
     ...
     *
     * @param \Learnist\Tripletex\Model\YearEndValidationResult|null $validation_result validation_result
     *
     * @return self
     */
