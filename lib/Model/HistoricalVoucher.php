...
/**
 * HistoricalVoucher Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class HistoricalVoucher implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoricalVoucher';
    ...
    protected static $openAPITypes = [
        ...
        'postings' => '\Learnist\Tripletex\Model\HistoricalPosting[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['external_voucher_number'] === null) {
            $invalidProperties[] = "'external_voucher_number' can't be null";
        }
     ...
     * Sets date
     *
     * @param string $date The voucher date.
     *
     * @return self
     */
     ...
     *
     * @param string $external_voucher_number External voucher number. This is the voucher number in the historical system.
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param int|null $number The voucher number generated by Tripletex. System generated number that cannot be changed.
     *
     * @return self
     */
    public function setNumber($number)
    {
        ...
        if (!is_null($number) && ($number < 0)) {
            throw new \InvalidArgumentException('invalid value for $number when calling HistoricalVoucher., must be bigger than or equal to 0.');
        }
     ...
     * Sets year
     *
     * @param int|null $year Voucher year. System generated number that cannot be changed.
     *
     * @return self
     */
    public function setYear($year)
    {
        ...
        if (!is_null($year) && ($year < 0)) {
            throw new \InvalidArgumentException('invalid value for $year when calling HistoricalVoucher., must be bigger than or equal to 0.');
        }
     ...
     * Sets description
     *
     * @param string $description The voucher description.
     *
     * @return self
     */
     ...
     * Gets postings
     *
     * @return \Learnist\Tripletex\Model\HistoricalPosting[]
     */
     ...
     * Sets postings
     *
     * @param \Learnist\Tripletex\Model\HistoricalPosting[] $postings The list of postings of the voucher. In postings, these fields must be provided: date, account, currency, amount, amountBasis, amountVat, amountCurrency, amountBasisCurrency.
     *
     * @return self
     */
