 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AutomationSettingsDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AutomationSettingsDTO';
...
'test_account' => 'getTestAccount'    ];
    ...
    {
        $this->container['can_access_auto_pay'] = isset($data['can_access_auto_pay']) ? $data['can_access_auto_pay'] : null;
        $this->container['can_access_fabric_ai'] = isset($data['can_access_fabric_ai']) ? $data['can_access_fabric_ai'] : null;
        $this->container['can_access_fabric_ai_training'] = isset($data['can_access_fabric_ai_training']) ? $data['can_access_fabric_ai_training'] : null;
        $this->container['can_add_auto_pay_payments'] = isset($data['can_add_auto_pay_payments']) ? $data['can_add_auto_pay_payments'] : null;
        $this->container['has_bookkeeping_before_attestation_setting'] = isset($data['has_bookkeeping_before_attestation_setting']) ? $data['has_bookkeeping_before_attestation_setting'] : null;
        $this->container['has_voucher_approval_module'] = isset($data['has_voucher_approval_module']) ? $data['has_voucher_approval_module'] : null;
        $this->container['has_fabric_ai_max_amount_pilot_flag'] = isset($data['has_fabric_ai_max_amount_pilot_flag']) ? $data['has_fabric_ai_max_amount_pilot_flag'] : null;
        $this->container['test_account'] = isset($data['test_account']) ? $data['test_account'] : null;
    }
     ...
     *
     * @param bool $can_access_auto_pay can_access_auto_pay
     *
     * @return $this
     */
     ...
     *
     * @param bool $can_access_fabric_ai can_access_fabric_ai
     *
     * @return $this
     */
     ...
     *
     * @param bool $can_access_fabric_ai_training can_access_fabric_ai_training
     *
     * @return $this
     */
     ...
     *
     * @param bool $can_add_auto_pay_payments can_add_auto_pay_payments
     *
     * @return $this
     */
     ...
     *
     * @param bool $has_bookkeeping_before_attestation_setting has_bookkeeping_before_attestation_setting
     *
     * @return $this
     */
     ...
     *
     * @param bool $has_voucher_approval_module has_voucher_approval_module
     *
     * @return $this
     */
     ...
     *
     * @param bool $has_fabric_ai_max_amount_pilot_flag has_fabric_ai_max_amount_pilot_flag
     *
     * @return $this
     */
     ...
     * Sets test_account
     *
     * @param bool $test_account test_account
     *
     * @return $this
     */
