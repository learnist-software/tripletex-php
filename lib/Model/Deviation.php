 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Deviation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Deviation';
...
'deviation' => 'getDeviation'    ];
    ...
    const CAUSE_DEFECT = 'CAUSE_DEFECT';
const CAUSE_TOO_FEW = 'CAUSE_TOO_FEW';
const CAUSE_TOO_MANY = 'CAUSE_TOO_MANY';
const CAUSE_REPLACEMENT = 'CAUSE_REPLACEMENT';
const ACTION_IGNORE = 'ACTION_IGNORE';
const ACTION_GENERATE_RESTORDER = 'ACTION_GENERATE_RESTORDER';
const ACTION__RETURN = 'ACTION_RETURN';
const ACTION_RETURN_GENERATE_RESTORDER = 'ACTION_RETURN_GENERATE_RESTORDER';
...
self::ACTION_RETURN_GENERATE_RESTORDER,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['purchase_order_line'] = isset($data['purchase_order_line']) ? $data['purchase_order_line'] : null;
     ...
     *
     * @param float $quantity_ordered quantity_ordered
     *
     * @return $this
     */
     ...
     * Sets deviation
     *
     * @param float $deviation deviation
     *
     * @return $this
     */
