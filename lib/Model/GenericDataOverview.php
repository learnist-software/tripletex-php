 ...
 */
class GenericDataOverview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GenericDataOverview';
    ...
    protected static array $openAPINullables = [
		...
		'generic_data_type_group_id' => false,
		'posts' => false,
		'type_of_goods_posts' => false,
		'cash_register_system_posts' => false,
		'calculated_deduction' => false,
		'expenses' => false,
		'reversed_expenses' => false,
		'show_profit_and_loss_details' => false,
		'annual_income_recognition_or_deduction_basis' => false,
		'annual_income_recognition' => false,
		'annual_deduction' => false,
		'sum_profit_and_loss' => false,
		'opening_balance_profit_and_loss' => false,
		'closing_balance_profit_and_loss' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('generic_data_type_group_id', $data ?? [], null);
        $this->setIfExists('posts', $data ?? [], null);
        $this->setIfExists('type_of_goods_posts', $data ?? [], null);
        $this->setIfExists('cash_register_system_posts', $data ?? [], null);
        $this->setIfExists('calculated_deduction', $data ?? [], null);
        $this->setIfExists('expenses', $data ?? [], null);
        $this->setIfExists('reversed_expenses', $data ?? [], null);
        $this->setIfExists('show_profit_and_loss_details', $data ?? [], null);
        $this->setIfExists('annual_income_recognition_or_deduction_basis', $data ?? [], null);
        ...
        $this->setIfExists('opening_balance_profit_and_loss', $data ?? [], null);
        $this->setIfExists('closing_balance_profit_and_loss', $data ?? [], null);
    ...
    */
     ...
     *
     * @param int|null $generic_data_type_group_id generic_data_type_group_id
     *
     * @return self
     */
    public function setGenericDataTypeGroupId($generic_data_type_group_id)
    {
        ...
        if (is_null($generic_data_type_group_id)) {
            throw new \InvalidArgumentException('non-nullable generic_data_type_group_id cannot be null');
        }
     ...
     *
     * @return \Learnist\Tripletex\Model\TypeOfGoods[]|null
     */
     ...
     *
     * @param \Learnist\Tripletex\Model\TypeOfGoods[]|null $type_of_goods_posts type_of_goods_posts
     *
     * @return self
     */
    public function setTypeOfGoodsPosts($type_of_goods_posts)
    {
        ...
        if (is_null($type_of_goods_posts)) {
            throw new \InvalidArgumentException('non-nullable type_of_goods_posts cannot be null');
        }
     ...
     *
     * @return \Learnist\Tripletex\Model\CashRegisterSystem[]|null
     */
     ...
     *
     * @param \Learnist\Tripletex\Model\CashRegisterSystem[]|null $cash_register_system_posts cash_register_system_posts
     *
     * @return self
     */
    public function setCashRegisterSystemPosts($cash_register_system_posts)
    {
        ...
        if (is_null($cash_register_system_posts)) {
            throw new \InvalidArgumentException('non-nullable cash_register_system_posts cannot be null');
        }
     ...
     *
     * @param float|null $calculated_deduction calculated_deduction
     *
     * @return self
     */
    public function setCalculatedDeduction($calculated_deduction)
    {
        ...
        if (is_null($calculated_deduction)) {
            throw new \InvalidArgumentException('non-nullable calculated_deduction cannot be null');
        }
     ...
     *
     * @param float|null $reversed_expenses reversed_expenses
     *
     * @return self
     */
    public function setReversedExpenses($reversed_expenses)
    {
        ...
        if (is_null($reversed_expenses)) {
            throw new \InvalidArgumentException('non-nullable reversed_expenses cannot be null');
        }
     ...
     *
     * @param bool|null $show_profit_and_loss_details show_profit_and_loss_details
     *
     * @return self
     */
    public function setShowProfitAndLossDetails($show_profit_and_loss_details)
    {
        ...
        if (is_null($show_profit_and_loss_details)) {
            throw new \InvalidArgumentException('non-nullable show_profit_and_loss_details cannot be null');
        }
     ...
     *
     * @param float|null $annual_income_recognition_or_deduction_basis annual_income_recognition_or_deduction_basis
     *
     * @return self
     */
    public function setAnnualIncomeRecognitionOrDeductionBasis($annual_income_recognition_or_deduction_basis)
    {
        ...
        if (is_null($annual_income_recognition_or_deduction_basis)) {
            throw new \InvalidArgumentException('non-nullable annual_income_recognition_or_deduction_basis cannot be null');
        }
     ...
     *
     * @param float|null $opening_balance_profit_and_loss opening_balance_profit_and_loss
     *
     * @return self
     */
    public function setOpeningBalanceProfitAndLoss($opening_balance_profit_and_loss)
    {
        ...
        if (is_null($opening_balance_profit_and_loss)) {
            throw new \InvalidArgumentException('non-nullable opening_balance_profit_and_loss cannot be null');
        }
     ...
     *
     * @param float|null $closing_balance_profit_and_loss closing_balance_profit_and_loss
     *
     * @return self
     */
    public function setClosingBalanceProfitAndLoss($closing_balance_profit_and_loss)
    {
        ...
        if (is_null($closing_balance_profit_and_loss)) {
            throw new \InvalidArgumentException('non-nullable closing_balance_profit_and_loss cannot be null');
        }
