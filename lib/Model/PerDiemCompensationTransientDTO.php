 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PerDiemCompensationTransientDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PerDiemCompensationTransientDTO';
...
self::OVERNIGHT_ACCOMMODATION_BOARDING_HOUSE_WITH_COOKING,        ];
     ...
     *
     * @param int $travel_expense_zone_id travel_expense_zone_id
     *
     * @return $this
     */
     ...
     *
     * @param string $overnight_accommodation overnight_accommodation
     *
     * @return $this
     */
