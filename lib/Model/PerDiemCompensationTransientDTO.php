...
/**
 * PerDiemCompensationTransientDTO Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class PerDiemCompensationTransientDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PerDiemCompensationTransientDTO';
    ...
    */
     ...
     *
     * @param int|null $travel_expense_zone_id travel_expense_zone_id
     *
     * @return self
     */
     ...
     *
     * @param string|null $overnight_accommodation overnight_accommodation
     *
     * @return self
     */
