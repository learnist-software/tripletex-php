 ...
 */
class IncomeStatement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IncomeStatement';
    ...
    protected static array $openAPINullables = [
		...
		'taxable_business_income' => false,
		'total_addition' => false,
		'total_deduction' => false,
		'changes' => false,
		'received_group_contribution' => false,
		'payed_group_contribution' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('taxable_business_income', $data ?? [], null);
        $this->setIfExists('total_addition', $data ?? [], null);
        $this->setIfExists('total_deduction', $data ?? [], null);
        $this->setIfExists('changes', $data ?? [], null);
        $this->setIfExists('received_group_contribution', $data ?? [], null);
        $this->setIfExists('payed_group_contribution', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param float|null $taxable_business_income taxable_business_income
     *
     * @return self
     */
    public function setTaxableBusinessIncome($taxable_business_income)
    {
        if (is_null($taxable_business_income)) {
            throw new \InvalidArgumentException('non-nullable taxable_business_income cannot be null');
        }
     ...
     * Sets total_addition
     *
     * @param float|null $total_addition total_addition
     *
     * @return self
     */
    public function setTotalAddition($total_addition)
    {
        if (is_null($total_addition)) {
            throw new \InvalidArgumentException('non-nullable total_addition cannot be null');
        }
     ...
     *
     * @param float|null $total_deduction total_deduction
     *
     * @return self
     */
    public function setTotalDeduction($total_deduction)
    {
        if (is_null($total_deduction)) {
            throw new \InvalidArgumentException('non-nullable total_deduction cannot be null');
        }
     ...
     *
     * @param float|null $received_group_contribution received_group_contribution
     *
     * @return self
     */
    public function setReceivedGroupContribution($received_group_contribution)
    {
        if (is_null($received_group_contribution)) {
            throw new \InvalidArgumentException('non-nullable received_group_contribution cannot be null');
        }
     ...
     *
     * @param float|null $payed_group_contribution payed_group_contribution
     *
     * @return self
     */
    public function setPayedGroupContribution($payed_group_contribution)
    {
        if (is_null($payed_group_contribution)) {
            throw new \InvalidArgumentException('non-nullable payed_group_contribution cannot be null');
        }
