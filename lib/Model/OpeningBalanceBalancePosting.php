 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OpeningBalanceBalancePosting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OpeningBalanceBalancePosting';
...
'amount_currency' => 'getAmountCurrency'    ];
     ...
     *
     * @param float $amount_currency Only relevant for accounts in a different currency than the company currency, e.g an EUR account in a Norwegian company.  If provided on other accounts, it must always equal 'amount'
     *
     * @return $this
     */
