 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupContributions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GroupContributions';
...
'generic_data_overviews' => 'getGenericDataOverviews'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sum_expenses'] = isset($data['sum_expenses']) ? $data['sum_expenses'] : null;
        $this->container['sum_submitted'] = isset($data['sum_submitted']) ? $data['sum_submitted'] : null;
        $this->container['sum_received'] = isset($data['sum_received']) ? $data['sum_received'] : null;
        $this->container['accounted_value'] = isset($data['accounted_value']) ? $data['accounted_value'] : null;
        $this->container['grouped_accounted_value'] = isset($data['grouped_accounted_value']) ? $data['grouped_accounted_value'] : null;
     ...
     * Sets sum_expenses
     *
     * @param float $sum_expenses sum_expenses
     *
     * @return $this
     */
     ...
     * Sets sum_submitted
     *
     * @param float $sum_submitted sum_submitted
     *
     * @return $this
     */
     ...
     * Sets sum_received
     *
     * @param float $sum_received sum_received
     *
     * @return $this
     */
     ...
     *
     * @param float $grouped_accounted_value grouped_accounted_value
     *
     * @return $this
     */
