...
/**
 * BrregCompanyLookupDTO Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class BrregCompanyLookupDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BrregCompanyLookupDTO';
    ...
    protected static $attributeMap = [
        ...
        'business_postal_area' => 'businessPostalArea'
    ];
    ...
    protected static $setters = [
        ...
        'business_postal_area' => 'setBusinessPostalArea'
    ];
    ...
    protected static $getters = [
        ...
        'business_postal_area' => 'getBusinessPostalArea'
    ];
    ...
    */
     ...
     * Sets postal_area
     *
     * @param string|null $postal_area postal_area
     *
     * @return self
     */
    public function setPostalArea($postal_area)
    {
        ...
        if (is_null($postal_area)) {
            throw new \InvalidArgumentException('non-nullable postal_area cannot be null');
        }
     ...
     *
     * @param string|null $business_address business_address
     *
     * @return self
     */
    ...
    /**
     * Gets business_postal_area
     *
     * @return string|null
     */
    public function getBusinessPostalArea()
    {
        return $this->container['business_postal_area'];
    }

    /**
     * Sets business_postal_area
     *
     * @param string|null $business_postal_area business_postal_area
     *
     * @return self
     */
    public function setBusinessPostalArea($business_postal_area)
    {

        if (is_null($business_postal_area)) {
            throw new \InvalidArgumentException('non-nullable business_postal_area cannot be null');
        }

        $this->container['business_postal_area'] = $business_postal_area;
