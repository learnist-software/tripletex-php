...
class GoodsReceipt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('goods_receipt_lines', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets purchase_order
     *
     * @param \Learnist\Tripletex\Model\PurchaseOrder|null $purchase_order purchase_order
     *
     * @return self
     */
     ...
     * Sets received_by
     *
     * @param \Learnist\Tripletex\Model\Employee|null $received_by received_by
     *
     * @return self
     */
    ...
    {
        if (is_null($goods_receipt_lines)) {
            throw new \InvalidArgumentException('non-nullable goods_receipt_lines cannot be null');
        }
