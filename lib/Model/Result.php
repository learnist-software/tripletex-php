...
class Result implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets return_value
     *
     * @param object|null $return_value return_value
     *
     * @return self
     */
    public function setReturnValue($return_value)
    {
        if (is_null($return_value)) {
            throw new \InvalidArgumentException('non-nullable return_value cannot be null');
        }
    ...
    {
        return $this->container['popups'];
    }

    /**
     * Sets popups
     *
     * @param string[]|null $popups popups
     *
     * @return self
     */
    ...
    {
        if (is_null($popups)) {
            throw new \InvalidArgumentException('non-nullable popups cannot be null');
        }
        $this->container['popups'] = $popups;
