...
/**
 * InvoiceMessage Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceMessage';
    ...
    protected static $setters = [
        ...
        'message_content_type' => 'setMessageContentType',
        'status' => 'setStatus',
    ...
    protected static $getters = [
        ...
        'message_content_type' => 'getMessageContentType',
        'status' => 'getStatus',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('message_content_type', $data ?? [], null);
        $this->setIfExists('status', $data ?? [], null);
        $this->setIfExists('send_time', $data ?? [], null);
        $this->setIfExists('read_time', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets message_content_type
     *
     * @return int|null
     */
    public function getMessageContentType()
    {
        return $this->container['message_content_type'];
    }

    /**
     * Sets message_content_type
     *
     * @param int|null $message_content_type message_content_type
     *
     * @return self
     */
    public function setMessageContentType($message_content_type)
    {
        if (is_null($message_content_type)) {
            throw new \InvalidArgumentException('non-nullable message_content_type cannot be null');
        }
        $this->container['message_content_type'] = $message_content_type;
     ...
     * Sets send_time
     *
     * @param \DateTime|null $send_time send_time
     *
     * @return self
     */
     ...
     * Sets read_time
     *
     * @param \DateTime|null $read_time read_time
     *
     * @return self
     */
    public function setReadTime($read_time)
    {
        if (is_null($read_time)) {
            throw new \InvalidArgumentException('non-nullable read_time cannot be null');
        }
