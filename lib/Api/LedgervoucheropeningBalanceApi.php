<?php
/**
 * LedgervoucheropeningBalanceApi
 * PHP version 5
 *
 * @category Class
...
/**
 * LedgervoucheropeningBalanceApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LedgervoucheropeningBalanceApi
{
    /**
     * @var ClientInterface
     */
     ...
     */
    public function correctionVoucher($fields = null)
    {
        list($response) = $this->correctionVoucherWithHttpInfo($fields);
        return $response;
    }

    /**
     * Operation correctionVoucherWithHttpInfo
     *
     * [BETA] Get the correction voucher for the opening balance.
     *
     * @param  string $fields Fields filter pattern (optional)
     ...
     */
    public function correctionVoucherWithHttpInfo($fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperVoucher';
        $request = $this->correctionVoucherRequest($fields);
    ...
    /**
     * Operation correctionVoucherAsync
     *
     * [BETA] Get the correction voucher for the opening balance.
     *
     * @param  string $fields Fields filter pattern (optional)
     ...
     */
    public function correctionVoucherAsync($fields = null)
    {
        return $this->correctionVoucherAsyncWithHttpInfo($fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation correctionVoucherAsyncWithHttpInfo
     *
     * [BETA] Get the correction voucher for the opening balance.
     *
     * @param  string $fields Fields filter pattern (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function correctionVoucherAsyncWithHttpInfo($fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperVoucher';
        $request = $this->correctionVoucherRequest($fields);
    ...
    /**
     * Create request for operation 'correctionVoucher'
     *
     * @param  string $fields Fields filter pattern (optional)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function correctionVoucherRequest($fields = null)
    {

        $resourcePath = '/ledger/voucher/openingBalance/>correctionVoucher';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteRequest()
    {
        ...
        $resourcePath = '/ledger/voucher/openingBalance';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \Learnist\Tripletex\Model\OpeningBalance $body dto (optional)
