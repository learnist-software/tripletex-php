...
/**
 * TravelExpenseaccommodationAllowanceApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class TravelExpenseaccommodationAllowanceApi
{
    ...
    protected function deleteRequest($id)
    {
        ...
        $resourcePath = '/travelExpense/accommodationAllowance/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperAccommodationAllowance
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperAccommodationAllowance, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperAccommodationAllowance';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperAccommodationAllowance',
     ...
     *
     * @param  \Learnist\Tripletex\Model\AccommodationAllowance $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperAccommodationAllowance
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/travelExpense/accommodationAllowance';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\AccommodationAllowance $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperAccommodationAllowance
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseAccommodationAllowance
     */
    public function search($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($travel_expense_id, $rate_type_id, $rate_category_id, $rate_from, $rate_to, $count_from, $count_to, $amount_from, $amount_to, $location, $address, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseAccommodationAllowance, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseAccommodationAllowance';
        $request = $this->searchRequest($travel_expense_id, $rate_type_id, $rate_category_id, $rate_from, $rate_to, $count_from, $count_to, $amount_from, $amount_to, $location, $address, $from, $count, $sorting, $fields);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseAccommodationAllowance',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($travel_expense_id, $rate_type_id, $rate_category_id, $rate_from, $rate_to, $count_from, $count_to, $amount_from, $amount_to, $location, $address, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseAccommodationAllowance';
        $request = $this->searchRequest($travel_expense_id, $rate_type_id, $rate_category_id, $rate_from, $rate_to, $count_from, $count_to, $amount_from, $amount_to, $location, $address, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
