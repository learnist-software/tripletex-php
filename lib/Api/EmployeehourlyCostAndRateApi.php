...
/**
 * EmployeehourlyCostAndRateApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class EmployeehourlyCostAndRateApi
{
     ...
     * @return \Learnist\Tripletex\Model\ResponseWrapperHourlyCostAndRate
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperHourlyCostAndRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperHourlyCostAndRate';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperHourlyCostAndRate',
    ...
    protected function getRequest($id, $fields = null)
    {
        ...
        $resourcePath = '/employee/hourlyCostAndRate/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \Learnist\Tripletex\Model\HourlyCostAndRate $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperHourlyCostAndRate
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/employee/hourlyCostAndRate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\HourlyCostAndRate $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperHourlyCostAndRate
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseHourlyCostAndRate
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseHourlyCostAndRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($employee_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseHourlyCostAndRate';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseHourlyCostAndRate',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
