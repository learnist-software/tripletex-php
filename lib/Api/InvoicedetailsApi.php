...
/**
 * InvoicedetailsApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class InvoicedetailsApi
{
     ...
     * @return \Learnist\Tripletex\Model\ResponseWrapperProjectInvoiceDetails
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperProjectInvoiceDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperProjectInvoiceDetails';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperProjectInvoiceDetails',
    ...
    protected function getRequest($id, $fields = null)
    {
        ...
        $resourcePath = '/invoice/details/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseProjectInvoiceDetails
     */
    public function search($invoice_date_from, $invoice_date_to, $id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($invoice_date_from, $invoice_date_to, $id, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseProjectInvoiceDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($invoice_date_from, $invoice_date_to, $id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProjectInvoiceDetails';
        $request = $this->searchRequest($invoice_date_from, $invoice_date_to, $id, $from, $count, $sorting, $fields);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseProjectInvoiceDetails',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($invoice_date_from, $invoice_date_to, $id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($invoice_date_from, $invoice_date_to, $id, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($invoice_date_from, $invoice_date_to, $id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProjectInvoiceDetails';
        $request = $this->searchRequest($invoice_date_from, $invoice_date_to, $id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($invoice_date_from, $invoice_date_to, $id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
