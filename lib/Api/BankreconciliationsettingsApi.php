...
/**
 * BankreconciliationsettingsApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankreconciliationsettingsApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @return \Learnist\Tripletex\Model\ResponseWrapperBankReconciliationSettings
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperBankReconciliationSettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperBankReconciliationSettings';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperBankReconciliationSettings',
    ...
    protected function getRequest($fields = null)
    {
        ...
        $resourcePath = '/bank/reconciliation/settings';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \Learnist\Tripletex\Model\BankReconciliationSettings $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperBankReconciliationSettings
     ...
     * @param  \Learnist\Tripletex\Model\BankReconciliationSettings $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperBankReconciliationSettings
    ...
    protected function putRequest($id, $body = null)
    {
        ...
        $resourcePath = '/bank/reconciliation/settings/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
