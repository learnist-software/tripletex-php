...
/**
 * VoucherApprovalListElementApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VoucherApprovalListElementApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @return \Learnist\Tripletex\Model\ResponseWrapperVoucherApprovalListElement
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperVoucherApprovalListElement, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperVoucherApprovalListElement';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperVoucherApprovalListElement',
    ...
    protected function getRequest($id, $fields = null)
    {
        ...
        $resourcePath = '/voucherApprovalListElement/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
