...
class LedgeraccountingPeriodApi
{
     ...
     * @return \Learnist\Tripletex\Model\ResponseWrapperAccountingPeriod
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperAccountingPeriod, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperAccountingPeriod';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperAccountingPeriod',
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseAccountingPeriod
     */
    public function search($id = null, $number_from = null, $number_to = null, $start_from = null, $start_to = null, $end_from = null, $end_to = null, $count = '1400', $from = '0', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $number_from, $number_to, $start_from, $start_to, $end_from, $end_to, $count, $from, $sorting, $fields);
        return $response;
    }
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseAccountingPeriod, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $number_from = null, $number_to = null, $start_from = null, $start_to = null, $end_from = null, $end_to = null, $count = '1400', $from = '0', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseAccountingPeriod';
        $request = $this->searchRequest($id, $number_from, $number_to, $start_from, $start_to, $end_from, $end_to, $count, $from, $sorting, $fields);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseAccountingPeriod',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $number_from = null, $number_to = null, $start_from = null, $start_to = null, $end_from = null, $end_to = null, $count = '1400', $from = '0', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $number_from, $number_to, $start_from, $start_to, $end_from, $end_to, $count, $from, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $number_from = null, $number_to = null, $start_from = null, $start_to = null, $end_from = null, $end_to = null, $count = '1400', $from = '0', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseAccountingPeriod';
        $request = $this->searchRequest($id, $number_from, $number_to, $start_from, $start_to, $end_from, $end_to, $count, $from, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $number_from = null, $number_to = null, $start_from = null, $start_to = null, $end_from = null, $end_to = null, $count = '1400', $from = '0', $sorting = null, $fields = null)
    {
