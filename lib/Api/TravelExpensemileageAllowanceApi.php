...
/**
 * TravelExpensemileageAllowanceApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class TravelExpensemileageAllowanceApi
{
    ...
    protected function deleteRequest($id)
    {
        ...
        $resourcePath = '/travelExpense/mileageAllowance/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperMileageAllowance
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperMileageAllowance, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperMileageAllowance';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperMileageAllowance',
     ...
     *
     * @param  \Learnist\Tripletex\Model\MileageAllowance $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperMileageAllowance
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/travelExpense/mileageAllowance';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\MileageAllowance $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperMileageAllowance
     ...
     * @param  string $km_from From and including (optional)
     * @param  string $km_to To and excluding (optional)
     ...
     * @param  string $departure_location Containing (optional)
     * @param  string $destination Containing (optional)
     * @param  string $date_from From and including (optional)
     * @param  string $date_to To and excluding (optional)
     * @param  bool $is_company_car Equals (optional)
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseMileageAllowance
     */
    public function search($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $km_from = null, $km_to = null, $rate_from = null, $rate_to = null, $amount_from = null, $amount_to = null, $departure_location = null, $destination = null, $date_from = null, $date_to = null, $is_company_car = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($travel_expense_id, $rate_type_id, $rate_category_id, $km_from, $km_to, $rate_from, $rate_to, $amount_from, $amount_to, $departure_location, $destination, $date_from, $date_to, $is_company_car, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseMileageAllowance, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $km_from = null, $km_to = null, $rate_from = null, $rate_to = null, $amount_from = null, $amount_to = null, $departure_location = null, $destination = null, $date_from = null, $date_to = null, $is_company_car = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseMileageAllowance';
        $request = $this->searchRequest($travel_expense_id, $rate_type_id, $rate_category_id, $km_from, $km_to, $rate_from, $rate_to, $amount_from, $amount_to, $departure_location, $destination, $date_from, $date_to, $is_company_car, $from, $count, $sorting, $fields);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseMileageAllowance',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $km_from = null, $km_to = null, $rate_from = null, $rate_to = null, $amount_from = null, $amount_to = null, $departure_location = null, $destination = null, $date_from = null, $date_to = null, $is_company_car = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($travel_expense_id, $rate_type_id, $rate_category_id, $km_from, $km_to, $rate_from, $rate_to, $amount_from, $amount_to, $departure_location, $destination, $date_from, $date_to, $is_company_car, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $km_from = null, $km_to = null, $rate_from = null, $rate_to = null, $amount_from = null, $amount_to = null, $departure_location = null, $destination = null, $date_from = null, $date_to = null, $is_company_car = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseMileageAllowance';
        $request = $this->searchRequest($travel_expense_id, $rate_type_id, $rate_category_id, $km_from, $km_to, $rate_from, $rate_to, $amount_from, $amount_to, $departure_location, $destination, $date_from, $date_to, $is_company_car, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($travel_expense_id = null, $rate_type_id = null, $rate_category_id = null, $km_from = null, $km_to = null, $rate_from = null, $rate_to = null, $amount_from = null, $amount_to = null, $departure_location = null, $destination = null, $date_from = null, $date_to = null, $is_company_car = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        ...
        // query params
        if ($km_from !== null) {
            $queryParams['kmFrom'] = ObjectSerializer::toQueryValue($km_from, null);
        }
        // query params
        if ($km_to !== null) {
            $queryParams['kmTo'] = ObjectSerializer::toQueryValue($km_to, null);
        }
        // query params
        if ($rate_from !== null) {
        ...
        if ($departure_location !== null) {
            $queryParams['departureLocation'] = ObjectSerializer::toQueryValue($departure_location, null);
        }
        // query params
        if ($destination !== null) {
        ...
        // query params
        if ($is_company_car !== null) {
            $queryParams['isCompanyCar'] = ObjectSerializer::toQueryValue($is_company_car, null);
        }
        // query params
        if ($from !== null) {
