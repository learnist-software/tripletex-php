...
/**
 * EmployeeemploymentleaveOfAbsenceApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class EmployeeemploymentleaveOfAbsenceApi
{
     ...
     * @return \Learnist\Tripletex\Model\ResponseWrapperLeaveOfAbsence
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperLeaveOfAbsence, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperLeaveOfAbsence';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperLeaveOfAbsence',
    ...
    protected function getRequest($id, $fields = null)
    {
        ...
        $resourcePath = '/employee/employment/leaveOfAbsence/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \Learnist\Tripletex\Model\LeaveOfAbsence $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperLeaveOfAbsence
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/employee/employment/leaveOfAbsence';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \Learnist\Tripletex\Model\LeaveOfAbsence[] $body JSON representing a list of new objects to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseLeaveOfAbsence
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseLeaveOfAbsence, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseLeaveOfAbsence';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseLeaveOfAbsence',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function postListRequest($body = null)
    {
        ...
        $resourcePath = '/employee/employment/leaveOfAbsence/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\LeaveOfAbsence $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperLeaveOfAbsence
     ...
     *
     * @param  string $employment_ids List of IDs (optional)
     * @param  string $date yyyy-MM-dd. Defaults to today. (optional)
     * @param  int $min_percentage Must be between 0-100. (optional, default to 0)
     * @param  int $max_percentage Must be between 0-100. (optional, default to 100)
     ...
     * @return \Learnist\Tripletex\Model\ListResponseLeaveOfAbsence
     */
    public function search($employment_ids = null, $date = null, $min_percentage = '0', $max_percentage = '100', $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($employment_ids, $date, $min_percentage, $max_percentage, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseLeaveOfAbsence, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($employment_ids = null, $date = null, $min_percentage = '0', $max_percentage = '100', $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseLeaveOfAbsence';
        $request = $this->searchRequest($employment_ids, $date, $min_percentage, $max_percentage, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($employment_ids = null, $date = null, $min_percentage = '0', $max_percentage = '100', $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($employment_ids, $date, $min_percentage, $max_percentage, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($employment_ids = null, $date = null, $min_percentage = '0', $max_percentage = '100', $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseLeaveOfAbsence';
        $request = $this->searchRequest($employment_ids, $date, $min_percentage, $max_percentage, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($employment_ids = null, $date = null, $min_percentage = '0', $max_percentage = '100', $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        ...
        if ($employment_ids !== null) {
            $queryParams['employmentIds'] = ObjectSerializer::toQueryValue($employment_ids, null);
        }
        // query params
        if ($date !== null) {
        ...
        if ($min_percentage !== null) {
            $queryParams['minPercentage'] = ObjectSerializer::toQueryValue($min_percentage, 'int32');
        }
        // query params
        if ($max_percentage !== null) {
            $queryParams['maxPercentage'] = ObjectSerializer::toQueryValue($max_percentage, 'int32');
        }
        // query params
        if ($from !== null) {
