...
class SupplierApi
{
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperSupplier
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperSupplier, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperSupplier';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperSupplier',
     ...
     *
     * @param  \Learnist\Tripletex\Model\Supplier $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperSupplier
     ...
     *
     * @param  \Learnist\Tripletex\Model\Supplier[] $body JSON representing a list of new objects to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseSupplier
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseSupplier, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseSupplier';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseSupplier',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\Supplier $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperSupplier
     ...
     *
     * @param  \Learnist\Tripletex\Model\Supplier[] $body JSON representing updates to objects. Should have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseSupplier
     ...
     * @return \Learnist\Tripletex\Model\ListResponseSupplier
     */
    public function search($id = null, $supplier_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = 'false', $account_manager_id = null, $changed_since = null, $is_wholesaler = null, $show_products = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $supplier_number, $organization_number, $email, $invoice_email, $is_inactive, $account_manager_id, $changed_since, $is_wholesaler, $show_products, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseSupplier, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $supplier_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = 'false', $account_manager_id = null, $changed_since = null, $is_wholesaler = null, $show_products = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseSupplier';
        $request = $this->searchRequest($id, $supplier_number, $organization_number, $email, $invoice_email, $is_inactive, $account_manager_id, $changed_since, $is_wholesaler, $show_products, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $supplier_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = 'false', $account_manager_id = null, $changed_since = null, $is_wholesaler = null, $show_products = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $supplier_number, $organization_number, $email, $invoice_email, $is_inactive, $account_manager_id, $changed_since, $is_wholesaler, $show_products, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $supplier_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = 'false', $account_manager_id = null, $changed_since = null, $is_wholesaler = null, $show_products = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseSupplier';
        $request = $this->searchRequest($id, $supplier_number, $organization_number, $email, $invoice_email, $is_inactive, $account_manager_id, $changed_since, $is_wholesaler, $show_products, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $supplier_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = 'false', $account_manager_id = null, $changed_since = null, $is_wholesaler = null, $show_products = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        ...
        if ($supplier_number !== null) {
            $queryParams['supplierNumber'] = ObjectSerializer::toQueryValue($supplier_number, null);
        }
        // query params
        if ($organization_number !== null) {
            $queryParams['organizationNumber'] = ObjectSerializer::toQueryValue($organization_number, null);
        }
        // query params
        if ($email !== null) {
        ...
        if ($invoice_email !== null) {
            $queryParams['invoiceEmail'] = ObjectSerializer::toQueryValue($invoice_email, null);
        }
        // query params
        if ($is_inactive !== null) {
        ...
        if ($account_manager_id !== null) {
            $queryParams['accountManagerId'] = ObjectSerializer::toQueryValue($account_manager_id, null);
        }
        // query params
        ...
        if ($is_wholesaler !== null) {
            $queryParams['isWholesaler'] = ObjectSerializer::toQueryValue($is_wholesaler, null);
        }
        // query params
        if ($show_products !== null) {
            $queryParams['showProducts'] = ObjectSerializer::toQueryValue($show_products, null);
        }
        // query params
        if ($from !== null) {
