...
class AssetApi
{
    ...
    {
        $this->canDeleteWithHttpInfo($id);
    }

    /**
     * Operation canDeleteWithHttpInfo
     *
     * Validate delete asset
     *
     * @param  int $id Element ID (required)
     ...
     */
    public function canDeleteWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->canDeleteRequest($id);
     ...
     */
    public function canDeleteAsync($id)
    {
        return $this->canDeleteAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation canDeleteAsyncWithHttpInfo
     *
     * Validate delete asset
     *
     * @param  int $id Element ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function canDeleteAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->canDeleteRequest($id);
    ...
    /**
     * Create request for operation 'canDelete'
     *
     * @param  int $id Element ID (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function canDeleteRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling canDelete'
            );
        }

        $resourcePath = '/asset/canDelete/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperAsset
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperAsset, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperAsset';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperAsset',
     ...
     * Create one asset.
     *
     * @param  \Learnist\Tripletex\Model\Asset $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperAsset
    ...
    {
        $this->postDuplicateWithHttpInfo($id);
    }

    /**
     * Operation postDuplicateWithHttpInfo
     *
     * Create copy of one asset
     *
     * @param  int $id Element ID (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postDuplicateWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->postDuplicateRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postDuplicateAsync($id)
    {
        return $this->postDuplicateAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postDuplicateAsyncWithHttpInfo
     *
     * Create copy of one asset
     *
     * @param  int $id Element ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postDuplicateAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->postDuplicateRequest($id);
    ...
    /**
     * Create request for operation 'postDuplicate'
     *
     * @param  int $id Element ID (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postDuplicateRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling postDuplicate'
            );
        }

        $resourcePath = '/asset/duplicate/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \Learnist\Tripletex\Model\Asset[] $body JSON representing a list of new objects to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseAsset
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseAsset, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseAsset';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseAsset',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\Asset $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperAsset
     ...
     * @return \Learnist\Tripletex\Model\ListResponseAsset
     */
    public function search($id = null, $name = null, $description = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $name, $description, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseAsset, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $name = null, $description = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseAsset';
        $request = $this->searchRequest($id, $name, $description, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $name = null, $description = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $name, $description, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $name = null, $description = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseAsset';
        $request = $this->searchRequest($id, $name, $description, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $name = null, $description = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
