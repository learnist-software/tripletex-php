...
class ProductApi
{
     ...
     * [BETA] Delete image.
     *
     * @param  int $id ID of Product containing the image to delete. (required)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProduct
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperProduct, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperProduct';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperProduct',
     ...
     * Create new product.
     *
     * @param  \Learnist\Tripletex\Model\Product $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProduct
     ...
     *
     * @param  \Learnist\Tripletex\Model\Product[] $body JSON representing a list of new objects to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseProduct
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseProduct, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProduct';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseProduct',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\Product $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProduct
     ...
     *
     * @param  \Learnist\Tripletex\Model\Product[] $body JSON representing updates to objects. Should have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseProduct
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseProduct, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($number = null, $ids = null, $product_number = null, $name = null, $ean = null, $is_inactive = null, $is_stock_item = null, $is_supplier_product = null, $supplier_id = null, $currency_id = null, $vat_type_id = null, $product_unit_id = null, $department_id = null, $account_id = null, $cost_excluding_vat_currency_from = null, $cost_excluding_vat_currency_to = null, $price_excluding_vat_currency_from = null, $price_excluding_vat_currency_to = null, $price_including_vat_currency_from = null, $price_including_vat_currency_to = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProduct';
        $request = $this->searchRequest($number, $ids, $product_number, $name, $ean, $is_inactive, $is_stock_item, $is_supplier_product, $supplier_id, $currency_id, $vat_type_id, $product_unit_id, $department_id, $account_id, $cost_excluding_vat_currency_from, $cost_excluding_vat_currency_to, $price_excluding_vat_currency_from, $price_excluding_vat_currency_to, $price_including_vat_currency_from, $price_including_vat_currency_to, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($number = null, $ids = null, $product_number = null, $name = null, $ean = null, $is_inactive = null, $is_stock_item = null, $is_supplier_product = null, $supplier_id = null, $currency_id = null, $vat_type_id = null, $product_unit_id = null, $department_id = null, $account_id = null, $cost_excluding_vat_currency_from = null, $cost_excluding_vat_currency_to = null, $price_excluding_vat_currency_from = null, $price_excluding_vat_currency_to = null, $price_including_vat_currency_from = null, $price_including_vat_currency_to = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($number, $ids, $product_number, $name, $ean, $is_inactive, $is_stock_item, $is_supplier_product, $supplier_id, $currency_id, $vat_type_id, $product_unit_id, $department_id, $account_id, $cost_excluding_vat_currency_from, $cost_excluding_vat_currency_to, $price_excluding_vat_currency_from, $price_excluding_vat_currency_to, $price_including_vat_currency_from, $price_including_vat_currency_to, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($number = null, $ids = null, $product_number = null, $name = null, $ean = null, $is_inactive = null, $is_stock_item = null, $is_supplier_product = null, $supplier_id = null, $currency_id = null, $vat_type_id = null, $product_unit_id = null, $department_id = null, $account_id = null, $cost_excluding_vat_currency_from = null, $cost_excluding_vat_currency_to = null, $price_excluding_vat_currency_from = null, $price_excluding_vat_currency_to = null, $price_including_vat_currency_from = null, $price_including_vat_currency_to = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProduct';
        $request = $this->searchRequest($number, $ids, $product_number, $name, $ean, $is_inactive, $is_stock_item, $is_supplier_product, $supplier_id, $currency_id, $vat_type_id, $product_unit_id, $department_id, $account_id, $cost_excluding_vat_currency_from, $cost_excluding_vat_currency_to, $price_excluding_vat_currency_from, $price_excluding_vat_currency_to, $price_including_vat_currency_from, $price_including_vat_currency_to, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($number = null, $ids = null, $product_number = null, $name = null, $ean = null, $is_inactive = null, $is_stock_item = null, $is_supplier_product = null, $supplier_id = null, $currency_id = null, $vat_type_id = null, $product_unit_id = null, $department_id = null, $account_id = null, $cost_excluding_vat_currency_from = null, $cost_excluding_vat_currency_to = null, $price_excluding_vat_currency_from = null, $price_excluding_vat_currency_to = null, $price_including_vat_currency_from = null, $price_including_vat_currency_to = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
     ...
     * @param  int $id Product ID to upload image to. (required)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProduct
    ...
    {
        list($response) = $this->uploadImageWithHttpInfo($file, $id);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperProduct, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadImageWithHttpInfo($file, $id)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperProduct';
        $request = $this->uploadImageRequest($file, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadImageAsync($file, $id)
    {
        return $this->uploadImageAsyncWithHttpInfo($file, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadImageAsyncWithHttpInfo($file, $id)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperProduct';
        $request = $this->uploadImageRequest($file, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function uploadImageRequest($file, $id)
    {
        ...
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling uploadImage'
            );
        }
