...
/**
 * ProductinventoryLocationApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductinventoryLocationApi
{
    /**
     * @var ClientInterface
     */
    ...
    protected function deleteRequest($id)
    {
        ...
        $resourcePath = '/product/inventoryLocation/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProductInventoryLocation
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperProductInventoryLocation, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperProductInventoryLocation';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperProductInventoryLocation',
     ...
     *
     * @param  \Learnist\Tripletex\Model\ProductInventoryLocation $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProductInventoryLocation
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/product/inventoryLocation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \Learnist\Tripletex\Model\ProductInventoryLocation[] $body JSON representing a list of new objects to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseProductInventoryLocation
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseProductInventoryLocation, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProductInventoryLocation';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseProductInventoryLocation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function postListRequest($body = null)
    {
        ...
        $resourcePath = '/product/inventoryLocation/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\ProductInventoryLocation $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProductInventoryLocation
     ...
     *
     * @param  \Learnist\Tripletex\Model\ProductInventoryLocation[] $body JSON representing updates to objects. Should have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseProductInventoryLocation
     ...
     *
     * @param  string $product_id List of IDs (optional)
     * @param  string $inventory_id List of IDs (optional)
     * @param  bool $is_main_location Equals (optional)
     ...
     * @return \Learnist\Tripletex\Model\ListResponseProductInventoryLocation
     */
    public function search($product_id = null, $inventory_id = null, $is_main_location = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($product_id, $inventory_id, $is_main_location, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseProductInventoryLocation, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($product_id = null, $inventory_id = null, $is_main_location = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProductInventoryLocation';
        $request = $this->searchRequest($product_id, $inventory_id, $is_main_location, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($product_id = null, $inventory_id = null, $is_main_location = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($product_id, $inventory_id, $is_main_location, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($product_id = null, $inventory_id = null, $is_main_location = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProductInventoryLocation';
        $request = $this->searchRequest($product_id, $inventory_id, $is_main_location, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($product_id = null, $inventory_id = null, $is_main_location = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        ...
        if ($inventory_id !== null) {
            $queryParams['inventoryId'] = ObjectSerializer::toQueryValue($inventory_id, null);
        }
        // query params
        if ($is_main_location !== null) {
            $queryParams['isMainLocation'] = ObjectSerializer::toQueryValue($is_main_location, null);
        }
        // query params
        if ($from !== null) {
