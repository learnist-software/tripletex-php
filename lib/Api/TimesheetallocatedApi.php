...
class TimesheetallocatedApi
{
     ...
     * @return \Learnist\Tripletex\Model\ResponseWrapperTimesheetAllocated
     */
    public function approve($id, $manager_comment = null)
    {
        list($response) = $this->approveWithHttpInfo($id, $manager_comment);
        return $response;
    }
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperTimesheetAllocated, HTTP status code, HTTP response headers (array of strings)
     */
    public function approveWithHttpInfo($id, $manager_comment = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperTimesheetAllocated';
        $request = $this->approveRequest($id, $manager_comment);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperTimesheetAllocated',
     ...
     */
    public function approveAsync($id, $manager_comment = null)
    {
        return $this->approveAsyncWithHttpInfo($id, $manager_comment)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function approveAsyncWithHttpInfo($id, $manager_comment = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperTimesheetAllocated';
        $request = $this->approveRequest($id, $manager_comment);
     ...
     */
    protected function approveRequest($id, $manager_comment = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling approve'
            );
        }
        ...
        if ($manager_comment !== null) {
            $queryParams['managerComment'] = ObjectSerializer::toQueryValue($manager_comment, null);
        }
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseTimesheetAllocated
     */
    public function approveList($ids = null, $employee_ids = null, $date_from = null, $date_to = null, $manager_comment = null)
    {
        list($response) = $this->approveListWithHttpInfo($ids, $employee_ids, $date_from, $date_to, $manager_comment);
        return $response;
    }

    /**
     * Operation approveListWithHttpInfo
     *
     * Only for allocated hours on the company's internal holiday/vacation activity. Mark the allocated hour entry/entries as approved. The hours will be copied to the time sheet. Notifications will be sent to the entries' employees if the entries' approval statuses or comments have changed. If IDs are provided, the other args are ignored.
     *
     * @param  string $ids List of allocated hour entry IDs. (optional)
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseTimesheetAllocated, HTTP status code, HTTP response headers (array of strings)
     */
    public function approveListWithHttpInfo($ids = null, $employee_ids = null, $date_from = null, $date_to = null, $manager_comment = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseTimesheetAllocated';
        $request = $this->approveListRequest($ids, $employee_ids, $date_from, $date_to, $manager_comment);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseTimesheetAllocated',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function approveListAsync($ids = null, $employee_ids = null, $date_from = null, $date_to = null, $manager_comment = null)
    {
        return $this->approveListAsyncWithHttpInfo($ids, $employee_ids, $date_from, $date_to, $manager_comment)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation approveListAsyncWithHttpInfo
     *
     * Only for allocated hours on the company's internal holiday/vacation activity. Mark the allocated hour entry/entries as approved. The hours will be copied to the time sheet. Notifications will be sent to the entries' employees if the entries' approval statuses or comments have changed. If IDs are provided, the other args are ignored.
     *
     * @param  string $ids List of allocated hour entry IDs. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function approveListAsyncWithHttpInfo($ids = null, $employee_ids = null, $date_from = null, $date_to = null, $manager_comment = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseTimesheetAllocated';
        $request = $this->approveListRequest($ids, $employee_ids, $date_from, $date_to, $manager_comment);
    ...
    /**
     * Create request for operation 'approveList'
     *
     * @param  string $ids List of allocated hour entry IDs. (optional)
     * @param  string $employee_ids List of IDs. Defaults to ID of token owner. (optional)
     * @param  string $date_from From and including (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function approveListRequest($ids = null, $employee_ids = null, $date_from = null, $date_to = null, $manager_comment = null)
    {
        ...
        if ($employee_ids !== null) {
            $queryParams['employeeIds'] = ObjectSerializer::toQueryValue($employee_ids, null);
        }
        // query params
        if ($date_from !== null) {
     ...
     *
     * @param  \Learnist\Tripletex\Model\TimesheetAllocated $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperTimesheetAllocated
     ...
     *
     * @param  \Learnist\Tripletex\Model\TimesheetAllocated[] $body JSON representing a list of new objects to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseTimesheetAllocated
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\TimesheetAllocated $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperTimesheetAllocated
     ...
     *
     * @param  \Learnist\Tripletex\Model\TimesheetAllocated[] $body List of allocated hour entry objects to update. Should have ID set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseTimesheetAllocated
     ...
     * @return \Learnist\Tripletex\Model\ListResponseTimesheetAllocated
     */
    public function search($ids = null, $employee_ids = null, $project_ids = null, $activity_ids = null, $date_from = null, $date_to = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($ids, $employee_ids, $project_ids, $activity_ids, $date_from, $date_to, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseTimesheetAllocated, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($ids = null, $employee_ids = null, $project_ids = null, $activity_ids = null, $date_from = null, $date_to = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseTimesheetAllocated';
        $request = $this->searchRequest($ids, $employee_ids, $project_ids, $activity_ids, $date_from, $date_to, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($ids = null, $employee_ids = null, $project_ids = null, $activity_ids = null, $date_from = null, $date_to = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($ids, $employee_ids, $project_ids, $activity_ids, $date_from, $date_to, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($ids = null, $employee_ids = null, $project_ids = null, $activity_ids = null, $date_from = null, $date_to = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseTimesheetAllocated';
        $request = $this->searchRequest($ids, $employee_ids, $project_ids, $activity_ids, $date_from, $date_to, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($ids = null, $employee_ids = null, $project_ids = null, $activity_ids = null, $date_from = null, $date_to = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        ...
        // query params
        if ($project_ids !== null) {
            $queryParams['projectIds'] = ObjectSerializer::toQueryValue($project_ids, null);
        }
        // query params
        if ($activity_ids !== null) {
            $queryParams['activityIds'] = ObjectSerializer::toQueryValue($activity_ids, null);
        }
        // query params
        if ($date_from !== null) {
            $queryParams['dateFrom'] = ObjectSerializer::toQueryValue($date_from, null);
     ...
     * @return \Learnist\Tripletex\Model\ResponseWrapperTimesheetAllocated
     */
    public function unapprove($id, $manager_comment = null)
    {
        list($response) = $this->unapproveWithHttpInfo($id, $manager_comment);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperTimesheetAllocated, HTTP status code, HTTP response headers (array of strings)
     */
    public function unapproveWithHttpInfo($id, $manager_comment = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperTimesheetAllocated';
        $request = $this->unapproveRequest($id, $manager_comment);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unapproveAsync($id, $manager_comment = null)
    {
        return $this->unapproveAsyncWithHttpInfo($id, $manager_comment)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unapproveAsyncWithHttpInfo($id, $manager_comment = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperTimesheetAllocated';
        $request = $this->unapproveRequest($id, $manager_comment);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function unapproveRequest($id, $manager_comment = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling unapprove'
            );
        }
     ...
     * @return \Learnist\Tripletex\Model\ListResponseTimesheetAllocated
     */
    public function unapproveList($ids = null, $employee_ids = null, $date_from = null, $date_to = null, $manager_comment = null)
    {
        list($response) = $this->unapproveListWithHttpInfo($ids, $employee_ids, $date_from, $date_to, $manager_comment);
        return $response;
    }

    /**
     * Operation unapproveListWithHttpInfo
     *
     * Only for allocated hours on the company's internal holiday/vacation activity. Mark the allocated hour entry/entries as unapproved. Notifications will be sent to the entries' employees if the entries' approval statuses or comments have changed. If IDs are provided, the other args are ignored.
     *
     * @param  string $ids List of allocated hour entry IDs. (optional)
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseTimesheetAllocated, HTTP status code, HTTP response headers (array of strings)
     */
    public function unapproveListWithHttpInfo($ids = null, $employee_ids = null, $date_from = null, $date_to = null, $manager_comment = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseTimesheetAllocated';
        $request = $this->unapproveListRequest($ids, $employee_ids, $date_from, $date_to, $manager_comment);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unapproveListAsync($ids = null, $employee_ids = null, $date_from = null, $date_to = null, $manager_comment = null)
    {
        return $this->unapproveListAsyncWithHttpInfo($ids, $employee_ids, $date_from, $date_to, $manager_comment)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation unapproveListAsyncWithHttpInfo
     *
     * Only for allocated hours on the company's internal holiday/vacation activity. Mark the allocated hour entry/entries as unapproved. Notifications will be sent to the entries' employees if the entries' approval statuses or comments have changed. If IDs are provided, the other args are ignored.
     *
     * @param  string $ids List of allocated hour entry IDs. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unapproveListAsyncWithHttpInfo($ids = null, $employee_ids = null, $date_from = null, $date_to = null, $manager_comment = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseTimesheetAllocated';
        $request = $this->unapproveListRequest($ids, $employee_ids, $date_from, $date_to, $manager_comment);
    ...
    /**
     * Create request for operation 'unapproveList'
     *
     * @param  string $ids List of allocated hour entry IDs. (optional)
     * @param  string $employee_ids List of IDs. Defaults to ID of token owner. (optional)
     * @param  string $date_from From and including (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function unapproveListRequest($ids = null, $employee_ids = null, $date_from = null, $date_to = null, $manager_comment = null)
    {
