...
/**
 * ProjectprojectActivityApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class ProjectprojectActivityApi
{
    ...
    protected function deleteRequest($id)
    {
        ...
        $resourcePath = '/project/projectActivity/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteByIdsRequest($ids)
    {
        ...
        $resourcePath = '/project/projectActivity/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProjectActivity
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperProjectActivity, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperProjectActivity';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperProjectActivity',
     ...
     *
     * @param  \Learnist\Tripletex\Model\ProjectActivity $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProjectActivity
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/project/projectActivity';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
