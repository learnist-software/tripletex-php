...
/**
 * EmployeelogininfoApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class EmployeelogininfoApi
{
     ...
     * @return \Learnist\Tripletex\Model\ResponseWrapperEmployeeLoginInfo
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperEmployeeLoginInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperEmployeeLoginInfo';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperEmployeeLoginInfo',
    ...
    protected function getRequest($id, $fields = null)
    {
        ...
        $resourcePath = '/employee/logininfo/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
