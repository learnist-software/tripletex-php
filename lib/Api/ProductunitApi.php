...
class ProductunitApi
{
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProductUnit
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperProductUnit, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperProductUnit';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperProductUnit',
     ...
     *
     * @param  \Learnist\Tripletex\Model\ProductUnit $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProductUnit
     ...
     *
     * @param  \Learnist\Tripletex\Model\ProductUnit[] $body JSON representing a list of new objects to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseProductUnit
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseProductUnit, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProductUnit';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseProductUnit',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\ProductUnit $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProductUnit
     ...
     *
     * @param  \Learnist\Tripletex\Model\ProductUnit[] $body JSON representing updates to objects. Should have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseProductUnit
     ...
     * @return \Learnist\Tripletex\Model\ListResponseProductUnit
     */
    public function query($query = null, $count = '25', $fields = 'id, name', $from = '0', $sorting = null)
    {
        list($response) = $this->queryWithHttpInfo($query, $count, $fields, $from, $sorting);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseProductUnit, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($query = null, $count = '25', $fields = 'id, name', $from = '0', $sorting = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProductUnit';
        $request = $this->queryRequest($query, $count, $fields, $from, $sorting);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function queryAsync($query = null, $count = '25', $fields = 'id, name', $from = '0', $sorting = null)
    {
        return $this->queryAsyncWithHttpInfo($query, $count, $fields, $from, $sorting)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function queryAsyncWithHttpInfo($query = null, $count = '25', $fields = 'id, name', $from = '0', $sorting = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProductUnit';
        $request = $this->queryRequest($query, $count, $fields, $from, $sorting);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function queryRequest($query = null, $count = '25', $fields = 'id, name', $from = '0', $sorting = null)
    {
     ...
     * @return \Learnist\Tripletex\Model\ListResponseProductUnit
     */
    public function search($id = null, $name = null, $name_short = null, $common_code = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $name, $name_short, $common_code, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseProductUnit, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $name = null, $name_short = null, $common_code = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProductUnit';
        $request = $this->searchRequest($id, $name, $name_short, $common_code, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $name = null, $name_short = null, $common_code = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $name, $name_short, $common_code, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $name = null, $name_short = null, $common_code = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProductUnit';
        $request = $this->searchRequest($id, $name, $name_short, $common_code, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $name = null, $name_short = null, $common_code = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        ...
        // query params
        if ($name_short !== null) {
            $queryParams['nameShort'] = ObjectSerializer::toQueryValue($name_short, null);
        }
        // query params
        if ($common_code !== null) {
            $queryParams['commonCode'] = ObjectSerializer::toQueryValue($common_code, null);
        }
        // query params
        if ($from !== null) {
            $queryParams['from'] = ObjectSerializer::toQueryValue($from, null);
