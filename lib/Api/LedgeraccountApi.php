...
/**
 * LedgeraccountApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class LedgeraccountApi
{
    ...
    protected function deleteRequest($id)
    {
        ...
        $resourcePath = '/ledger/account/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteByIdsRequest($ids)
    {
        ...
        $resourcePath = '/ledger/account/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperAccount
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperAccount';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperAccount',
     ...
     *
     * @param  \Learnist\Tripletex\Model\Account $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperAccount
     ...
     *
     * @param  \Learnist\Tripletex\Model\Account[] $body JSON representing a list of new objects to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseAccount
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseAccount';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseAccount',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\Account $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperAccount
     ...
     *
     * @param  \Learnist\Tripletex\Model\Account[] $body JSON representing updates to objects. Should have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseAccount
     ...
     * @param  bool $is_bank_account Equals (optional)
     * @param  bool $is_inactive Equals (optional)
     * @param  bool $is_applicable_for_supplier_invoice Equals (optional)
     * @param  string $ledger_type Ledger type (optional)
     * @param  bool $is_balance_account Balance account (optional)
     * @param  string $saft_code SAF-T code (optional)
     ...
     * @return \Learnist\Tripletex\Model\ListResponseAccount
     */
    public function search($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $is_applicable_for_supplier_invoice = null, $ledger_type = null, $is_balance_account = null, $saft_code = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $number, $is_bank_account, $is_inactive, $is_applicable_for_supplier_invoice, $ledger_type, $is_balance_account, $saft_code, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $is_applicable_for_supplier_invoice = null, $ledger_type = null, $is_balance_account = null, $saft_code = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseAccount';
        $request = $this->searchRequest($id, $number, $is_bank_account, $is_inactive, $is_applicable_for_supplier_invoice, $ledger_type, $is_balance_account, $saft_code, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $is_applicable_for_supplier_invoice = null, $ledger_type = null, $is_balance_account = null, $saft_code = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $number, $is_bank_account, $is_inactive, $is_applicable_for_supplier_invoice, $ledger_type, $is_balance_account, $saft_code, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $is_applicable_for_supplier_invoice = null, $ledger_type = null, $is_balance_account = null, $saft_code = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseAccount';
        $request = $this->searchRequest($id, $number, $is_bank_account, $is_inactive, $is_applicable_for_supplier_invoice, $ledger_type, $is_balance_account, $saft_code, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $is_applicable_for_supplier_invoice = null, $ledger_type = null, $is_balance_account = null, $saft_code = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        ...
        // query params
        if ($is_bank_account !== null) {
            $queryParams['isBankAccount'] = ObjectSerializer::toQueryValue($is_bank_account, null);
        }
        // query params
        if ($is_inactive !== null) {
        ...
        // query params
        if ($is_applicable_for_supplier_invoice !== null) {
            $queryParams['isApplicableForSupplierInvoice'] = ObjectSerializer::toQueryValue($is_applicable_for_supplier_invoice, null);
        }
        // query params
        if ($ledger_type !== null) {
            $queryParams['ledgerType'] = ObjectSerializer::toQueryValue($ledger_type, null);
        }
        // query params
        if ($is_balance_account !== null) {
            $queryParams['isBalanceAccount'] = ObjectSerializer::toQueryValue($is_balance_account, null);
        }
        // query params
        if ($saft_code !== null) {
            $queryParams['saftCode'] = ObjectSerializer::toQueryValue($saft_code, null);
        }
        // query params
        if ($from !== null) {
