...
class ProductgroupApi
{
    ...
    protected function deleteByIdsRequest($ids)
    {
        ...
        $resourcePath = '/product/group/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProductGroup
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperProductGroup, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperProductGroup';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperProductGroup',
     ...
     *
     * @param  \Learnist\Tripletex\Model\ProductGroup $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProductGroup
     ...
     *
     * @param  \Learnist\Tripletex\Model\ProductGroup[] $body JSON representing a list of new objects to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseProductGroup
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseProductGroup, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProductGroup';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseProductGroup',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\ProductGroup $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProductGroup
     ...
     *
     * @param  \Learnist\Tripletex\Model\ProductGroup[] $body JSON representing updates to objects. Should have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseProductGroup
     ...
     * @return \Learnist\Tripletex\Model\ListResponseProductGroup
     */
    public function query($query = null, $name = null, $fields = 'id, name', $from = '0', $count = '1000', $sorting = null)
    {
        list($response) = $this->queryWithHttpInfo($query, $name, $fields, $from, $count, $sorting);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseProductGroup, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($query = null, $name = null, $fields = 'id, name', $from = '0', $count = '1000', $sorting = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProductGroup';
        $request = $this->queryRequest($query, $name, $fields, $from, $count, $sorting);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function queryAsync($query = null, $name = null, $fields = 'id, name', $from = '0', $count = '1000', $sorting = null)
    {
        return $this->queryAsyncWithHttpInfo($query, $name, $fields, $from, $count, $sorting)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function queryAsyncWithHttpInfo($query = null, $name = null, $fields = 'id, name', $from = '0', $count = '1000', $sorting = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProductGroup';
        $request = $this->queryRequest($query, $name, $fields, $from, $count, $sorting);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function queryRequest($query = null, $name = null, $fields = 'id, name', $from = '0', $count = '1000', $sorting = null)
    {

        $resourcePath = '/product/group/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \Learnist\Tripletex\Model\ListResponseProductGroup
     */
    public function search($id = null, $name = null, $query = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $name, $query, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseProductGroup, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $name = null, $query = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProductGroup';
        $request = $this->searchRequest($id, $name, $query, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $name = null, $query = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $name, $query, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $name = null, $query = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProductGroup';
        $request = $this->searchRequest($id, $name, $query, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $name = null, $query = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
