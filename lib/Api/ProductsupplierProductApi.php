...
/**
 * ProductsupplierProductApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class ProductsupplierProductApi
{
    ...
    protected function deleteRequest($id)
    {
        ...
        $resourcePath = '/product/supplierProduct/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperSupplierProduct
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperSupplierProduct, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperSupplierProduct';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperSupplierProduct',
     ...
     *
     * @param  \Learnist\Tripletex\Model\SupplierProduct $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperSupplierProduct
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/product/supplierProduct';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseSupplierProduct
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseSupplierProduct, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseSupplierProduct';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseSupplierProduct',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function postListRequest($body = null)
    {
        ...
        $resourcePath = '/product/supplierProduct/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\SupplierProduct $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperSupplierProduct
     ...
     *
     * @param  \Learnist\Tripletex\Model\SupplierProduct[] $body JSON representing updates to objects. Should have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseSupplierProduct
     ...
     *
     * @param  int $product_id Id of product to find supplier products for. (optional)
     * @param  int $vendor_id Id of vendor to find supplier products for. (optional)
     * @param  string $query Containing (optional)
     * @param  bool $is_inactive Equals (optional)
     * @param  string $product_group_id Equals (optional)
     * @param  int $count Number of elements to return (optional)
     * @param  string $fields Fields filter pattern (optional, default to id, name, number)
     ...
     * @return \Learnist\Tripletex\Model\ListResponseSupplierProduct
     */
    public function search($product_id = null, $vendor_id = null, $query = null, $is_inactive = null, $product_group_id = null, $count = null, $fields = 'id, name, number', $from = '0', $sorting = null)
    {
        list($response) = $this->searchWithHttpInfo($product_id, $vendor_id, $query, $is_inactive, $product_group_id, $count, $fields, $from, $sorting);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseSupplierProduct, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($product_id = null, $vendor_id = null, $query = null, $is_inactive = null, $product_group_id = null, $count = null, $fields = 'id, name, number', $from = '0', $sorting = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseSupplierProduct';
        $request = $this->searchRequest($product_id, $vendor_id, $query, $is_inactive, $product_group_id, $count, $fields, $from, $sorting);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($product_id = null, $vendor_id = null, $query = null, $is_inactive = null, $product_group_id = null, $count = null, $fields = 'id, name, number', $from = '0', $sorting = null)
    {
        return $this->searchAsyncWithHttpInfo($product_id, $vendor_id, $query, $is_inactive, $product_group_id, $count, $fields, $from, $sorting)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($product_id = null, $vendor_id = null, $query = null, $is_inactive = null, $product_group_id = null, $count = null, $fields = 'id, name, number', $from = '0', $sorting = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseSupplierProduct';
        $request = $this->searchRequest($product_id, $vendor_id, $query, $is_inactive, $product_group_id, $count, $fields, $from, $sorting);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($product_id = null, $vendor_id = null, $query = null, $is_inactive = null, $product_group_id = null, $count = null, $fields = 'id, name, number', $from = '0', $sorting = null)
    {
        ...
        // query params
        if ($vendor_id !== null) {
            $queryParams['vendorId'] = ObjectSerializer::toQueryValue($vendor_id, 'int32');
        }
        // query params
        if ($query !== null) {
        ...
        if ($product_group_id !== null) {
            $queryParams['productGroupId'] = ObjectSerializer::toQueryValue($product_group_id, null);
        }
        // query params
        if ($count !== null) {
