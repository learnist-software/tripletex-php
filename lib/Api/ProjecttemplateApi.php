...
class ProjecttemplateApi
{
     ...
     * @return \Learnist\Tripletex\Model\ResponseWrapperProjectTemplate
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperProjectTemplate, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = '*')
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperProjectTemplate';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperProjectTemplate',
     ...
     */
    public function getAsync($id, $fields = '*')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAsyncWithHttpInfo($id, $fields = '*')
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperProjectTemplate';
        $request = $this->getRequest($id, $fields);
     ...
     */
    protected function getRequest($id, $fields = '*')
    {
        ...
        $resourcePath = '/project/template/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
