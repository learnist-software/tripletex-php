...
/**
 * ProjecthourlyRatesApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class ProjecthourlyRatesApi
{
    ...
    protected function deleteRequest($id)
    {
        ...
        $resourcePath = '/project/hourlyRates/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteByIdsRequest($ids)
    {
        ...
        $resourcePath = '/project/hourlyRates/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function deleteByProjectIds($ids, $date)
    {
        list($response) = $this->deleteByProjectIdsWithHttpInfo($ids, $date);
        return $response;
    }

    /**
     * Operation deleteByProjectIdsWithHttpInfo
     *
     * Delete project hourly rates by project id.
     *
     * @param  string $ids ID of the elements (required)
     ...
     */
    public function deleteByProjectIdsWithHttpInfo($ids, $date)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProject';
        $request = $this->deleteByProjectIdsRequest($ids, $date);
    ...
    /**
     * Operation deleteByProjectIdsAsync
     *
     * Delete project hourly rates by project id.
     *
     * @param  string $ids ID of the elements (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteByProjectIdsAsync($ids, $date)
    {
        return $this->deleteByProjectIdsAsyncWithHttpInfo($ids, $date)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteByProjectIdsAsyncWithHttpInfo
     *
     * Delete project hourly rates by project id.
     *
     * @param  string $ids ID of the elements (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteByProjectIdsAsyncWithHttpInfo($ids, $date)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProject';
        $request = $this->deleteByProjectIdsRequest($ids, $date);
    ...
    /**
     * Create request for operation 'deleteByProjectIds'
     *
     * @param  string $ids ID of the elements (required)
     * @param  string $date yyyy-MM-dd. Defaults to today. (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteByProjectIdsRequest($ids, $date)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null || (is_array($ids) && count($ids) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ids when calling deleteByProjectIds'
            );
        }
        // verify the required parameter 'date' is set
        if ($date === null || (is_array($date) && count($date) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $date when calling deleteByProjectIds'
            );
        }

        $resourcePath = '/project/hourlyRates/deleteByProjectIds';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProjectHourlyRate
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperProjectHourlyRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperProjectHourlyRate';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperProjectHourlyRate',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Learnist\Tripletex\Model\ProjectHourlyRate $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProjectHourlyRate
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/project/hourlyRates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \Learnist\Tripletex\Model\ProjectHourlyRate[] $body JSON representing a list of new objects to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseProjectHourlyRate
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseProjectHourlyRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProjectHourlyRate';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseProjectHourlyRate',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\ProjectHourlyRate $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperProjectHourlyRate
     ...
     *
     * @param  \Learnist\Tripletex\Model\ProjectHourlyRate[] $body JSON representing updates to objects. Should have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseProjectHourlyRate
     ...
     * @return \Learnist\Tripletex\Model\ListResponseProjectHourlyRate
     */
    public function search($id = null, $project_id = null, $type = null, $start_date_from = null, $start_date_to = null, $show_in_project_order = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $project_id, $type, $start_date_from, $start_date_to, $show_in_project_order, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseProjectHourlyRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $project_id = null, $type = null, $start_date_from = null, $start_date_to = null, $show_in_project_order = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProjectHourlyRate';
        $request = $this->searchRequest($id, $project_id, $type, $start_date_from, $start_date_to, $show_in_project_order, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $project_id = null, $type = null, $start_date_from = null, $start_date_to = null, $show_in_project_order = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $project_id, $type, $start_date_from, $start_date_to, $show_in_project_order, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $project_id = null, $type = null, $start_date_from = null, $start_date_to = null, $show_in_project_order = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProjectHourlyRate';
        $request = $this->searchRequest($id, $project_id, $type, $start_date_from, $start_date_to, $show_in_project_order, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $project_id = null, $type = null, $start_date_from = null, $start_date_to = null, $show_in_project_order = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        ...
        // query params
        if ($show_in_project_order !== null) {
            $queryParams['showInProjectOrder'] = ObjectSerializer::toQueryValue($show_in_project_order, null);
        }
        // query params
        if ($from !== null) {
    ...
    /**
     * Operation updateOrAddHourRates
     *
     * Update or add the same project hourly rate from project overview.
     *
     * @param  string $ids ID of the elements (required)
     * @param  \Learnist\Tripletex\Model\HourlyRate $body JSON representing updates to objects. Should have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseProjectHourlyRate
     */
    public function updateOrAddHourRates($ids, $body = null)
    {
        list($response) = $this->updateOrAddHourRatesWithHttpInfo($ids, $body);
        return $response;
    }

    /**
     * Operation updateOrAddHourRatesWithHttpInfo
     *
     * Update or add the same project hourly rate from project overview.
     *
     * @param  string $ids ID of the elements (required)
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseProjectHourlyRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateOrAddHourRatesWithHttpInfo($ids, $body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProjectHourlyRate';
        $request = $this->updateOrAddHourRatesRequest($ids, $body);
    ...
    /**
     * Operation updateOrAddHourRatesAsync
     *
     * Update or add the same project hourly rate from project overview.
     *
     * @param  string $ids ID of the elements (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateOrAddHourRatesAsync($ids, $body = null)
    {
        return $this->updateOrAddHourRatesAsyncWithHttpInfo($ids, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateOrAddHourRatesAsyncWithHttpInfo
     *
     * Update or add the same project hourly rate from project overview.
     *
     * @param  string $ids ID of the elements (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateOrAddHourRatesAsyncWithHttpInfo($ids, $body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseProjectHourlyRate';
        $request = $this->updateOrAddHourRatesRequest($ids, $body);
    ...
    /**
     * Create request for operation 'updateOrAddHourRates'
     *
     * @param  string $ids ID of the elements (required)
     * @param  \Learnist\Tripletex\Model\HourlyRate $body JSON representing updates to objects. Should have ID and version set. (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateOrAddHourRatesRequest($ids, $body = null)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null || (is_array($ids) && count($ids) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ids when calling updateOrAddHourRates'
            );
        }

        $resourcePath = '/project/hourlyRates/updateOrAddHourRates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
