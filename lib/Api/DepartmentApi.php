...
class DepartmentApi
{
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperDepartment
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperDepartment, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperDepartment';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperDepartment',
     ...
     * Add new department.
     *
     * @param  \Learnist\Tripletex\Model\Department $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperDepartment
     ...
     *
     * @param  \Learnist\Tripletex\Model\Department[] $body JSON representing a list of new objects to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseDepartment
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseDepartment, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseDepartment';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseDepartment',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\Department $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperDepartment
     ...
     *
     * @param  \Learnist\Tripletex\Model\Department[] $body JSON representing updates to objects. Should have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseDepartment
     ...
     * @param  bool $is_inactive true - return only inactive departments; false - return only active departments; unspecified - return both types (optional)
     ...
     * @return \Learnist\Tripletex\Model\ListResponseDepartment
     */
    public function query($id = null, $query = null, $count = '25', $fields = 'id, name', $is_inactive = null, $from = '0', $sorting = null)
    {
        list($response) = $this->queryWithHttpInfo($id, $query, $count, $fields, $is_inactive, $from, $sorting);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseDepartment, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($id = null, $query = null, $count = '25', $fields = 'id, name', $is_inactive = null, $from = '0', $sorting = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseDepartment';
        $request = $this->queryRequest($id, $query, $count, $fields, $is_inactive, $from, $sorting);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function queryAsync($id = null, $query = null, $count = '25', $fields = 'id, name', $is_inactive = null, $from = '0', $sorting = null)
    {
        return $this->queryAsyncWithHttpInfo($id, $query, $count, $fields, $is_inactive, $from, $sorting)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function queryAsyncWithHttpInfo($id = null, $query = null, $count = '25', $fields = 'id, name', $is_inactive = null, $from = '0', $sorting = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseDepartment';
        $request = $this->queryRequest($id, $query, $count, $fields, $is_inactive, $from, $sorting);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function queryRequest($id = null, $query = null, $count = '25', $fields = 'id, name', $is_inactive = null, $from = '0', $sorting = null)
    {

        $resourcePath = '/department/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $department_number Containing (optional)
     * @param  string $department_manager_id List of IDs (optional)
     * @param  bool $is_inactive true - return only inactive departments; false - return only active departments; unspecified - return both types (optional)
     * @param  int $from From index (optional, default to 0)
     ...
     * @return \Learnist\Tripletex\Model\ListResponseDepartment
     */
    public function search($id = null, $name = null, $department_number = null, $department_manager_id = null, $is_inactive = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $name, $department_number, $department_manager_id, $is_inactive, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseDepartment, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $name = null, $department_number = null, $department_manager_id = null, $is_inactive = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseDepartment';
        $request = $this->searchRequest($id, $name, $department_number, $department_manager_id, $is_inactive, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $name = null, $department_number = null, $department_manager_id = null, $is_inactive = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $name, $department_number, $department_manager_id, $is_inactive, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $name = null, $department_number = null, $department_manager_id = null, $is_inactive = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseDepartment';
        $request = $this->searchRequest($id, $name, $department_number, $department_manager_id, $is_inactive, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $name = null, $department_number = null, $department_manager_id = null, $is_inactive = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        ...
        if ($department_number !== null) {
            $queryParams['departmentNumber'] = ObjectSerializer::toQueryValue($department_number, null);
        }
        // query params
        if ($department_manager_id !== null) {
            $queryParams['departmentManagerId'] = ObjectSerializer::toQueryValue($department_manager_id, null);
        }
        // query params
        if ($is_inactive !== null) {
            $queryParams['isInactive'] = ObjectSerializer::toQueryValue($is_inactive, null);
