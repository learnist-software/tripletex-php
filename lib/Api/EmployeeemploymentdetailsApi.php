...
/**
 * EmployeeemploymentdetailsApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class EmployeeemploymentdetailsApi
{
     ...
     * @return \Learnist\Tripletex\Model\ResponseWrapperEmploymentDetails
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperEmploymentDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperEmploymentDetails';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperEmploymentDetails',
    ...
    protected function getRequest($id, $fields = null)
    {
        ...
        $resourcePath = '/employee/employment/details/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \Learnist\Tripletex\Model\EmploymentDetails $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperEmploymentDetails
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/employee/employment/details';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\EmploymentDetails $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperEmploymentDetails
     ...
     *
     * @param  string $employment_id List of IDs (optional)
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseEmploymentDetails
     */
    public function search($employment_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($employment_id, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseEmploymentDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($employment_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseEmploymentDetails';
        $request = $this->searchRequest($employment_id, $from, $count, $sorting, $fields);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseEmploymentDetails',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($employment_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($employment_id, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($employment_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseEmploymentDetails';
        $request = $this->searchRequest($employment_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($employment_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        ...
        if ($employment_id !== null) {
            $queryParams['employmentId'] = ObjectSerializer::toQueryValue($employment_id, null);
        }
        // query params
        if ($from !== null) {
