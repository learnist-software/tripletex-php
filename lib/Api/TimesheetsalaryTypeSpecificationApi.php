<?php
/**
 * TimesheetsalaryTypeSpecificationApi
 * PHP version 5
 *
 * @category Class
...
/**
 * TimesheetsalaryTypeSpecificationApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class TimesheetsalaryTypeSpecificationApi
{
    ...
    protected function deleteRequest($id)
    {
        ...
        $resourcePath = '/timesheet/salaryTypeSpecification/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperTimesheetSalaryTypeSpecification
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperTimesheetSalaryTypeSpecification, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperTimesheetSalaryTypeSpecification';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperTimesheetSalaryTypeSpecification',
     ...
     *
     * @param  \Learnist\Tripletex\Model\TimesheetSalaryTypeSpecification $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperTimesheetSalaryTypeSpecification
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/timesheet/salaryTypeSpecification';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseTimesheetSalaryTypeSpecification
     */
    public function search($date_from = null, $date_to = null, $employee_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($date_from, $date_to, $employee_id, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseTimesheetSalaryTypeSpecification, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($date_from = null, $date_to = null, $employee_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseTimesheetSalaryTypeSpecification';
        $request = $this->searchRequest($date_from, $date_to, $employee_id, $from, $count, $sorting, $fields);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseTimesheetSalaryTypeSpecification',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($date_from = null, $date_to = null, $employee_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($date_from, $date_to, $employee_id, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($date_from = null, $date_to = null, $employee_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseTimesheetSalaryTypeSpecification';
        $request = $this->searchRequest($date_from, $date_to, $employee_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($date_from = null, $date_to = null, $employee_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
