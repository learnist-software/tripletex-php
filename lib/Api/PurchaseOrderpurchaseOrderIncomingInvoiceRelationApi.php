<?php
/**
 * PurchaseOrderpurchaseOrderIncomingInvoiceRelationApi
 * PHP version 5
 *
 * @category Class
...
/**
 * PurchaseOrderpurchaseOrderIncomingInvoiceRelationApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class PurchaseOrderpurchaseOrderIncomingInvoiceRelationApi
{
    ...
    protected function deleteRequest($id)
    {
        ...
        $resourcePath = '/purchaseOrder/purchaseOrderIncomingInvoiceRelation/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteByIdsRequest($ids)
    {
        ...
        $resourcePath = '/purchaseOrder/purchaseOrderIncomingInvoiceRelation/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperPurchaseOrderIncomingInvoiceRelation
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperPurchaseOrderIncomingInvoiceRelation, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperPurchaseOrderIncomingInvoiceRelation';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperPurchaseOrderIncomingInvoiceRelation',
     ...
     *
     * @param  \Learnist\Tripletex\Model\PurchaseOrderIncomingInvoiceRelation $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperPurchaseOrderIncomingInvoiceRelation
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/purchaseOrder/purchaseOrderIncomingInvoiceRelation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponsePurchaseOrderIncomingInvoiceRelation
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponsePurchaseOrderIncomingInvoiceRelation, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponsePurchaseOrderIncomingInvoiceRelation';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponsePurchaseOrderIncomingInvoiceRelation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $order_out_id List of IDs (optional)
     ...
     * @return \Learnist\Tripletex\Model\ListResponsePurchaseOrderIncomingInvoiceRelation
     */
    public function search($id = null, $order_out_id = null, $voucher_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $order_out_id, $voucher_id, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponsePurchaseOrderIncomingInvoiceRelation, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $order_out_id = null, $voucher_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponsePurchaseOrderIncomingInvoiceRelation';
        $request = $this->searchRequest($id, $order_out_id, $voucher_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $order_out_id = null, $voucher_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $order_out_id, $voucher_id, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $order_out_id = null, $voucher_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponsePurchaseOrderIncomingInvoiceRelation';
        $request = $this->searchRequest($id, $order_out_id, $voucher_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $order_out_id = null, $voucher_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        ...
        // query params
        if ($order_out_id !== null) {
            $queryParams['orderOutId'] = ObjectSerializer::toQueryValue($order_out_id, null);
        }
        // query params
        if ($voucher_id !== null) {
