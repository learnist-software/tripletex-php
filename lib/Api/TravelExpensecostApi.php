...
/**
 * TravelExpensecostApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class TravelExpensecostApi
{
    ...
    protected function deleteRequest($id)
    {
        ...
        $resourcePath = '/travelExpense/cost/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperCost
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperCost, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperCost';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperCost',
     ...
     * Create cost.
     *
     * @param  \Learnist\Tripletex\Model\Cost $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperCost
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/travelExpense/cost';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\Cost $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperCost
     ...
     * Update costs.
     *
     * @param  \Learnist\Tripletex\Model\Cost[] $body JSON representing updates to objects. Should have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseCost
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseCost, HTTP status code, HTTP response headers (array of strings)
     */
    public function putListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseCost';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseCost',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function putListRequest($body = null)
    {
        ...
        $resourcePath = '/travelExpense/cost/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \Learnist\Tripletex\Model\ListResponseCost
     */
    public function search($travel_expense_id = null, $vat_type_id = null, $currency_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($travel_expense_id, $vat_type_id, $currency_id, $rate_from, $rate_to, $count_from, $count_to, $amount_from, $amount_to, $location, $address, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseCost, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($travel_expense_id = null, $vat_type_id = null, $currency_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseCost';
        $request = $this->searchRequest($travel_expense_id, $vat_type_id, $currency_id, $rate_from, $rate_to, $count_from, $count_to, $amount_from, $amount_to, $location, $address, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($travel_expense_id = null, $vat_type_id = null, $currency_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($travel_expense_id, $vat_type_id, $currency_id, $rate_from, $rate_to, $count_from, $count_to, $amount_from, $amount_to, $location, $address, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($travel_expense_id = null, $vat_type_id = null, $currency_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseCost';
        $request = $this->searchRequest($travel_expense_id, $vat_type_id, $currency_id, $rate_from, $rate_to, $count_from, $count_to, $amount_from, $amount_to, $location, $address, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($travel_expense_id = null, $vat_type_id = null, $currency_id = null, $rate_from = null, $rate_to = null, $count_from = null, $count_to = null, $amount_from = null, $amount_to = null, $location = null, $address = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
