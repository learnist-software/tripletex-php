...
class CustomerApi
{
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperCustomer
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperCustomer, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperCustomer';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperCustomer',
     ...
     *
     * @param  \Learnist\Tripletex\Model\Customer $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperCustomer
     ...
     *
     * @param  \Learnist\Tripletex\Model\Customer[] $body JSON representing a list of new objects to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseCustomer
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseCustomer, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseCustomer';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseCustomer',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\Customer $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperCustomer
     ...
     *
     * @param  \Learnist\Tripletex\Model\Customer[] $body JSON representing updates to objects. Should have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseCustomer
     ...
     * @param  string $customer_account_number List of IDs (optional)
     ...
     * @return \Learnist\Tripletex\Model\ListResponseCustomer
     */
    public function search($id = null, $customer_account_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = 'false', $account_manager_id = null, $changed_since = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $customer_account_number, $organization_number, $email, $invoice_email, $is_inactive, $account_manager_id, $changed_since, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseCustomer, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $customer_account_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = 'false', $account_manager_id = null, $changed_since = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseCustomer';
        $request = $this->searchRequest($id, $customer_account_number, $organization_number, $email, $invoice_email, $is_inactive, $account_manager_id, $changed_since, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $customer_account_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = 'false', $account_manager_id = null, $changed_since = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $customer_account_number, $organization_number, $email, $invoice_email, $is_inactive, $account_manager_id, $changed_since, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $customer_account_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = 'false', $account_manager_id = null, $changed_since = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseCustomer';
        $request = $this->searchRequest($id, $customer_account_number, $organization_number, $email, $invoice_email, $is_inactive, $account_manager_id, $changed_since, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $customer_account_number = null, $organization_number = null, $email = null, $invoice_email = null, $is_inactive = 'false', $account_manager_id = null, $changed_since = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        ...
        if ($customer_account_number !== null) {
            $queryParams['customerAccountNumber'] = ObjectSerializer::toQueryValue($customer_account_number, null);
        }
        // query params
