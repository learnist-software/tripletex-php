...
/**
 * PurchaseOrderdeviationApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
...
class PurchaseOrderdeviationApi
{
     ...
     */
    public function approveWithHttpInfo($id)
    {
     ...
     */
    public function approveAsync($id)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function approveAsyncWithHttpInfo($id)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperPurchaseOrder';
        $request = $this->approveRequest($id);
     ...
     */
    protected function approveRequest($id)
    {
        ...
        $resourcePath = '/purchaseOrder/deviation/{id}/:approve';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteRequest($id)
    {
        ...
        $resourcePath = '/purchaseOrder/deviation/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperPurchaseOrder, HTTP status code, HTTP response headers (array of strings)
     */
    public function deliverWithHttpInfo($id)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperPurchaseOrder';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deliverAsync($id)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deliverAsyncWithHttpInfo($id)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperPurchaseOrder';
        $request = $this->deliverRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deliverRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deliver'
            );
        }

        $resourcePath = '/purchaseOrder/deviation/{id}/:deliver';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperDeviation
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperDeviation, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperDeviation';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperDeviation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Learnist\Tripletex\Model\Deviation $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperDeviation
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/purchaseOrder/deviation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \Learnist\Tripletex\Model\Deviation[] $body JSON representing a list of new objects to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseDeviation
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseDeviation, HTTP status code, HTTP response headers (array of strings)
     */
    public function postListWithHttpInfo($body = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseDeviation';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseDeviation',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function postListRequest($body = null)
    {
        ...
        $resourcePath = '/purchaseOrder/deviation/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $id Element ID (required)
     * @param  \Learnist\Tripletex\Model\Deviation $body Partial object describing what should be updated (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperDeviation
     ...
     *
     * @param  \Learnist\Tripletex\Model\Deviation[] $body JSON representing updates to objects. Should have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseDeviation
     ...
     *
     * @param  int $purchase_order_id Equals (required)
     ...
     * @return \Learnist\Tripletex\Model\ListResponseDeviation
     */
    public function search($purchase_order_id, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($purchase_order_id, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Learnist\Tripletex\Model\ListResponseDeviation, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($purchase_order_id, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseDeviation';
        $request = $this->searchRequest($purchase_order_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($purchase_order_id, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($purchase_order_id, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($purchase_order_id, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseDeviation';
        $request = $this->searchRequest($purchase_order_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($purchase_order_id, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        ...
        if ($purchase_order_id === null || (is_array($purchase_order_id) && count($purchase_order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $purchase_order_id when calling search'
            );
        }
        ...
        if ($purchase_order_id !== null) {
            $queryParams['purchaseOrderId'] = ObjectSerializer::toQueryValue($purchase_order_id, 'int32');
        }
        // query params
        if ($from !== null) {
     ...
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperPurchaseOrder, HTTP status code, HTTP response headers (array of strings)
     */
    public function undeliverWithHttpInfo($id)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperPurchaseOrder';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function undeliverAsync($id)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function undeliverAsyncWithHttpInfo($id)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperPurchaseOrder';
        $request = $this->undeliverRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function undeliverRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling undeliver'
            );
        }

        $resourcePath = '/purchaseOrder/deviation/{id}/:undeliver';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
