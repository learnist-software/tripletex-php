<?php
/**
 * TimesheetsalaryProjectTypeSpecificationApi
 * PHP version 5
 *
 * @category Class
...
/**
 * TimesheetsalaryProjectTypeSpecificationApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TimesheetsalaryProjectTypeSpecificationApi
{
    /**
     * @var ClientInterface
     */
    ...
    protected function deleteRequest($id)
    {
        ...
        $resourcePath = '/timesheet/salaryProjectTypeSpecification/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperTimesheetProjectSalaryTypeSpecification
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperTimesheetProjectSalaryTypeSpecification, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperTimesheetProjectSalaryTypeSpecification';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperTimesheetProjectSalaryTypeSpecification',
     ...
     *
     * @param  \Learnist\Tripletex\Model\TimesheetProjectSalaryTypeSpecification $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperTimesheetProjectSalaryTypeSpecification
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/timesheet/salaryProjectTypeSpecification';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  int $project_id Equals (optional)
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ListResponseTimesheetProjectSalaryTypeSpecification
     */
    public function search($date_from = null, $date_to = null, $employee_id = null, $project_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($date_from, $date_to, $employee_id, $project_id, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ListResponseTimesheetProjectSalaryTypeSpecification, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($date_from = null, $date_to = null, $employee_id = null, $project_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseTimesheetProjectSalaryTypeSpecification';
        $request = $this->searchRequest($date_from, $date_to, $employee_id, $project_id, $from, $count, $sorting, $fields);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ListResponseTimesheetProjectSalaryTypeSpecification',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($date_from = null, $date_to = null, $employee_id = null, $project_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($date_from, $date_to, $employee_id, $project_id, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($date_from = null, $date_to = null, $employee_id = null, $project_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ListResponseTimesheetProjectSalaryTypeSpecification';
        $request = $this->searchRequest($date_from, $date_to, $employee_id, $project_id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($date_from = null, $date_to = null, $employee_id = null, $project_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
