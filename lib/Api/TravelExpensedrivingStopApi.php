...
/**
 * TravelExpensedrivingStopApi Class Doc Comment
 *
 * @category Class
 * @package  Learnist\Tripletex
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TravelExpensedrivingStopApi
{
    /**
     * @var ClientInterface
     */
    ...
    protected function deleteRequest($id)
    {
        ...
        $resourcePath = '/travelExpense/drivingStop/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperDrivingStop
     */
     ...
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Learnist\Tripletex\Model\ResponseWrapperDrivingStop, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($id, $fields = null)
    {
        $returnType = '\Learnist\Tripletex\Model\ResponseWrapperDrivingStop';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Learnist\Tripletex\Model\ResponseWrapperDrivingStop',
     ...
     *
     * @param  \Learnist\Tripletex\Model\DrivingStop $body JSON representing the new object to be created. Should not have ID and version set. (optional)
     *
     * @throws \Learnist\Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Learnist\Tripletex\Model\ResponseWrapperDrivingStop
    ...
    protected function postRequest($body = null)
    {
        ...
        $resourcePath = '/travelExpense/drivingStop';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
